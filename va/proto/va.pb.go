...
var file_va_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x32, 0x93, 0x01, 0x0a, 0x02, 0x56, 0x41, 0x12, 0x49, 0x0a, 0x11, 0x50, 0x65, 0x72,
	...
	0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0x00, 0x32, 0x44, 0x0a, 0x03, 0x43, 0x41, 0x41, 0x12,
	...
	0x61, 0x6c, 0x69, 0x64, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x29,
	...
	0x2f, 0x76, 0x61, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
...
var file_va_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_va_proto_goTypes = []interface{}{
	...
	(*proto.Identifier)(nil),         // 9: core.Identifier
}
var file_va_proto_depIdxs = []int32{
	6,  // 0: va.IsCAAValidResponse.problem:type_name -> core.ProblemDetails
	7,  // 1: va.PerformValidationRequest.challenge:type_name -> core.Challenge
	3,  // 2: va.PerformValidationRequest.authz:type_name -> va.AuthzMeta
	8,  // 3: va.ValidationResult.records:type_name -> core.ValidationRecord
	6,  // 4: va.ValidationResult.problems:type_name -> core.ProblemDetails
	9,  // 5: va.ValidationRequest.identifier:type_name -> core.Identifier
	7,  // 6: va.ValidationRequest.challenge:type_name -> core.Challenge
	2,  // 7: va.VA.PerformValidation:input_type -> va.PerformValidationRequest
	5,  // 8: va.VA.ValidateChallenge:input_type -> va.ValidationRequest
	0,  // 9: va.CAA.IsCAAValid:input_type -> va.IsCAAValidRequest
	4,  // 10: va.VA.PerformValidation:output_type -> va.ValidationResult
	4,  // 11: va.VA.ValidateChallenge:output_type -> va.ValidationResult
	1,  // 12: va.CAA.IsCAAValid:output_type -> va.IsCAAValidResponse
