...
type DCVRequest struct {
	...
	ExpectedKeyAuthorization string            `protobuf:"bytes,5,opt,name=expectedKeyAuthorization,proto3" json:"expectedKeyAuthorization,omitempty"`
}

func (x *DCVRequest) Reset() {
	*x = DCVRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *DCVRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DCVRequest) ProtoMessage() {}

func (x *DCVRequest) ProtoReflect() protoreflect.Message {
	mi := &file_va_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DCVRequest.ProtoReflect.Descriptor instead.
func (*DCVRequest) Descriptor() ([]byte, []int) {
	return file_va_proto_rawDescGZIP(), []int{5}
}

func (x *DCVRequest) GetIdentifier() *proto.Identifier {
	if x != nil {
		return x.Identifier
	}
	return nil
...
func (x *DCVRequest) GetChallenge() *proto.Challenge {
	if x != nil {
		return x.Challenge
	}
	return nil
...
func (x *DCVRequest) GetRegID() int64 {
	if x != nil {
		return x.RegID
	}
	return 0
...
func (x *DCVRequest) GetAuthzID() string {
	if x != nil {
		return x.AuthzID
	}
	return ""
...
func (x *DCVRequest) GetExpectedKeyAuthorization() string {
	if x != nil {
		return x.ExpectedKeyAuthorization
	}
	return ""
...
var file_va_proto_rawDesc = []byte{
	...
	0xd9, 0x01, 0x0a, 0x0a, 0x44, 0x43, 0x56, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x30,
	...
	0x72, 0x65, 0x67, 0x49, 0x44, 0x12, 0x18, 0x0a, 0x07, 0x61, 0x75, 0x74, 0x68, 0x7a, 0x49, 0x44,
	0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x61, 0x75, 0x74, 0x68, 0x7a, 0x49, 0x44, 0x12,
	0x3a, 0x0a, 0x18, 0x65, 0x78, 0x70, 0x65, 0x63, 0x74, 0x65, 0x64, 0x4b, 0x65, 0x79, 0x41, 0x75,
	0x74, 0x68, 0x6f, 0x72, 0x69, 0x7a, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x05, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x18, 0x65, 0x78, 0x70, 0x65, 0x63, 0x74, 0x65, 0x64, 0x4b, 0x65, 0x79, 0x41, 0x75,
	0x74, 0x68, 0x6f, 0x72, 0x69, 0x7a, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x32, 0x80, 0x01, 0x0a, 0x02,
	...
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0x00, 0x12, 0x2f, 0x0a,
	0x05, 0x44, 0x6f, 0x44, 0x43, 0x56, 0x12, 0x0e, 0x2e, 0x76, 0x61, 0x2e, 0x44, 0x43, 0x56, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x14, 0x2e, 0x76, 0x61, 0x2e, 0x56, 0x61, 0x6c, 0x69,
	0x64, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0x00, 0x32, 0x44,
	0x0a, 0x03, 0x43, 0x41, 0x41, 0x12, 0x3d, 0x0a, 0x0a, 0x49, 0x73, 0x43, 0x41, 0x41, 0x56, 0x61,
	0x6c, 0x69, 0x64, 0x12, 0x15, 0x2e, 0x76, 0x61, 0x2e, 0x49, 0x73, 0x43, 0x41, 0x41, 0x56, 0x61,
...
var file_va_proto_goTypes = []interface{}{
	...
	(*DCVRequest)(nil),               // 5: va.DCVRequest
...
var file_va_proto_depIdxs = []int32{
	...
	9,  // 5: va.DCVRequest.identifier:type_name -> core.Identifier
	7,  // 6: va.DCVRequest.challenge:type_name -> core.Challenge
	2,  // 7: va.VA.PerformValidation:input_type -> va.PerformValidationRequest
	5,  // 8: va.VA.DoDCV:input_type -> va.DCVRequest
	0,  // 9: va.CAA.IsCAAValid:input_type -> va.IsCAAValidRequest
	4,  // 10: va.VA.PerformValidation:output_type -> va.ValidationResult
	4,  // 11: va.VA.DoDCV:output_type -> va.ValidationResult
