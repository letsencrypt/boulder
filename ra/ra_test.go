...
func TestNewOrder(t *testing.T) {
	...
	test.AssertEquals(t, err.Error(), "Policy forbids issuing for \"a\": DNS name does not have enough labels")
}
...
func TestFinalizeOrder(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			ExpectedErrMsg: "Policy forbids issuing for \"example.org\": Policy forbids issuing for name",
		},
		{
