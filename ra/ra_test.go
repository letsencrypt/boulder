...
func TestDeactivateAuthorization(t *testing.T) {
	...
	pbAuthz, err := bgrpc.AuthzToPB(authz)
	test.AssertNotError(t, err, "Could not marshal core.Authorization to corepb.Authorization")
	_, err = ra.DeactivateAuthorization(ctx, pbAuthz)
