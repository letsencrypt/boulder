...
var file_ra_proto_rawDesc = []byte{
	...
	0x63, 0x6f, 0x75, 0x6e, 0x74, 0x32, 0xc0, 0x07, 0x0a, 0x15, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74,
...
var file_ra_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_ra_proto_goTypes = []interface{}{
	...
	(*GetAuthorizationRequest)(nil),                  // 8: ra.GetAuthorizationRequest
	(*FinalizeOrderRequest)(nil),                     // 9: ra.FinalizeOrderRequest
	(*UnpauseAccountRequest)(nil),                    // 10: ra.UnpauseAccountRequest
	(*UnpauseAccountResponse)(nil),                   // 11: ra.UnpauseAccountResponse
	(*proto.Registration)(nil),                       // 12: core.Registration
	(*proto.Authorization)(nil),                      // 13: core.Authorization
	(*proto.Challenge)(nil),                          // 14: core.Challenge
	(*proto.Order)(nil),                              // 15: core.Order
	(*emptypb.Empty)(nil),                            // 16: google.protobuf.Empty
	(*proto1.OCSPResponse)(nil),                      // 17: ca.OCSPResponse
}
var file_ra_proto_depIdxs = []int32{
	12, // 0: ra.UpdateRegistrationRequest.base:type_name -> core.Registration
	12, // 1: ra.UpdateRegistrationRequest.update:type_name -> core.Registration
	13, // 2: ra.UpdateAuthorizationRequest.authz:type_name -> core.Authorization
	14, // 3: ra.UpdateAuthorizationRequest.response:type_name -> core.Challenge
	13, // 4: ra.PerformValidationRequest.authz:type_name -> core.Authorization
	15, // 5: ra.FinalizeOrderRequest.order:type_name -> core.Order
	12, // 6: ra.RegistrationAuthority.NewRegistration:input_type -> core.Registration
	...
	12, // 9: ra.RegistrationAuthority.DeactivateRegistration:input_type -> core.Registration
	...
	8,  // 15: ra.RegistrationAuthority.GetAuthorization:input_type -> ra.GetAuthorizationRequest
	9,  // 16: ra.RegistrationAuthority.FinalizeOrder:input_type -> ra.FinalizeOrderRequest
	0,  // 17: ra.RegistrationAuthority.GenerateOCSP:input_type -> ra.GenerateOCSPRequest
	10, // 18: ra.RegistrationAuthority.UnpauseAccount:input_type -> ra.UnpauseAccountRequest
	12, // 19: ra.RegistrationAuthority.NewRegistration:output_type -> core.Registration
	12, // 20: ra.RegistrationAuthority.UpdateRegistration:output_type -> core.Registration
	13, // 21: ra.RegistrationAuthority.PerformValidation:output_type -> core.Authorization
	16, // 22: ra.RegistrationAuthority.DeactivateRegistration:output_type -> google.protobuf.Empty
	...
	16, // 26: ra.RegistrationAuthority.AdministrativelyRevokeCertificate:output_type -> google.protobuf.Empty
	...
	17, // 30: ra.RegistrationAuthority.GenerateOCSP:output_type -> ca.OCSPResponse
	11, // 31: ra.RegistrationAuthority.UnpauseAccount:output_type -> ra.UnpauseAccountResponse
