...
func (sa *mockInvalidAuthorizationsAuthority) GetValidOrderAuthorizations(ctx context.Context, in *sapb.GetValidOrderAuthorizationsRequest, opts ...grpc.CallOption) (*sapb.Authorizations, error) {
	return nil, nil
}
