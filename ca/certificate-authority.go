...
func NewCertificateAuthorityImpl(cadb core.CertificateAuthorityDatabase, config Config, issuerCert string, policyDB policy.Config) (*CertificateAuthorityImpl, error) {
