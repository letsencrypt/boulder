...
func TestIssueCertificate(t *testing.T) {
	...
	csr, _ := x509csr.ParseCertificateRequest(CNandSANCSR)
...
func TestNoHostnames(t *testing.T) {
	...
	csr, _ := x509csr.ParseCertificateRequest(NoNamesCSR)
...
func TestRejectTooManyNames(t *testing.T) {
	...
	csr, _ := x509csr.ParseCertificateRequest(TooManyNameCSR)
	_, err = ca.IssueCertificate(ctx, *csr, 1001)
...
func TestRejectValidityTooLong(t *testing.T) {
	...
	csr, _ := x509csr.ParseCertificateRequest(NoCNCSR)
...
func TestShortKey(t *testing.T) {
	...
	// Test that the CA rejects CSRs that would expire after the intermediate cert
	csr, _ := x509csr.ParseCertificateRequest(ShortKeyCSR)
	_, err = ca.IssueCertificate(ctx, *csr, 1001)
...
func TestAllowNoCN(t *testing.T) {
	...
	csr, err := x509csr.ParseCertificateRequest(NoCNCSR)
...
func TestLongCommonName(t *testing.T) {
	...
	csr, _ := x509csr.ParseCertificateRequest(LongCNCSR)
	_, err = ca.IssueCertificate(ctx, *csr, 1001)
...
func TestWrongSignature(t *testing.T) {
	...
	// x509csr.ParseCertificateRequest() does not check for invalid signatures...
	csr, _ := x509csr.ParseCertificateRequest(WrongSignatureCSR)
...
func TestProfileSelection(t *testing.T) {
	...
	for _, testCase := range testCases {
		csr, err := x509csr.ParseCertificateRequest(testCase.CSR)
...
func TestExtensions(t *testing.T) {
	...
	mustStapleCSR, err := x509csr.ParseCertificateRequest(MustStapleCSR)
	test.AssertNotError(t, err, "Error parsing MustStapleCSR")

	duplicateMustStapleCSR, err := x509csr.ParseCertificateRequest(DuplicateMustStapleCSR)
	test.AssertNotError(t, err, "Error parsing DuplicateMustStapleCSR")

	tlsFeatureUnknownCSR, err := x509csr.ParseCertificateRequest(TLSFeatureUnknownCSR)
