...
func _() {
	...
	_ = x[AccountCreation-22]
}

const _FeatureFlag_name = ""

var _FeatureFlag_index = [...]uint16{0, 6, 26, 43, 59, 77, 96, 120, 135, 146, 156, 176, 189, 206, 228, 247, 266, 280, 298, 317, 334, 352, 374, 389}
