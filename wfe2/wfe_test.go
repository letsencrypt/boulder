...
func TestKeyRollover(t *testing.T) {
	...
	// fmt.Println("publ", string(existingJWKJSON))
	// fmt.Printf("priv %x\n", x509.MarshalPKCS1PrivateKey(existingKey))

	newJWKJSON := `{"kty":"RSA","alg":"RSA","n":"9Ij6NgQ47wiQIb_KHr_yzE2ksSIbPIo0cw1lVMDPfhmcypp6tGz_3n0QLs4RxNiXJFfksgZR6IvGVg2Xn_ymTLynAF1sa5zA1zkvzMtu0bgEnPAd_IbYcCkrx7ZnRuBu3CKEAy0lGF1KhF1HPvhMS_jB4LEv6jlSg0z-u3BUktfwSVlP_2l4bYE_laYqdGO5hFT61PeaVEtMIhDX8TP7Rz2StOJb4uqPj2jEasNzUZRk1_tPPMSVej368dO1str1GWme8YinyiuNAn0p1RRcveyJcKV_rjeW94T8ohmpWl7bVUu9wYoc56V5kyS6U43DpdUMP9JVssuDnkkN43LHUQ","e":"AQAB"}`
	newKeyBytes, err := hex.DecodeString("")
	test.AssertNotError(t, err, "Error parsing private key hex")
	newKeyPriv, err := x509.ParsePKCS1PrivateKey(newKeyBytes)
	test.AssertNotError(t, err, "Error parsing private key")
	...
	for _, tc := range testCases {
		t.Run(tc.Name, func(t *testing.T) {
			...
			// fmt.Println("woop", responseWriter.Body.String())
