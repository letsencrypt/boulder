...
var (
	// FundraisingOptionsToFieldID is the map of Web UI fundraising options to
	// corresponding field IDs used in Zendesk tickets.
	FundraisingOptionsToFieldID = map[string]string{
		"Yes, I'd like to receive an invoice.": "fundraising-yes",
		"No, thank you.":                       "fundraising-no",
	}
)
