...
func TestUnwrapExtensions(t *testing.T) {
	// These come from manually processing tesdata/good/precert.pem
	validPrecertBytes := []byte{163, 130, 1, 38, 48, 130, 1, 34, 48, 14, 6, 3, 85, 29, 15, 1, 1, 255, 4, 4, 3, 2, 5, 160, 48, 29, 6, 3, 85, 29, 37, 4, 22, 48, 20, 6, 8, 43, 6, 1, 5, 5, 7, 3, 1, 6, 8, 43, 6, 1, 5, 5, 7, 3, 2, 48, 12, 6, 3, 85, 29, 19, 1, 1, 255, 4, 2, 48, 0, 48, 29, 6, 3, 85, 29, 14, 4, 22, 4, 20, 38, 19, 204, 205, 94, 7, 254, 116, 233, 144, 222, 65, 91, 222, 158, 49, 127, 57, 203, 141, 48, 31, 6, 3, 85, 29, 35, 4, 24, 48, 22, 128, 20, 20, 46, 179, 23, 183, 88, 86, 203, 174, 80, 9, 64, 230, 31, 175, 157, 139, 20, 194, 198, 48, 85, 6, 8, 43, 6, 1, 5, 5, 7, 1, 1, 4, 73, 48, 71, 48, 33, 6, 8, 43, 6, 1, 5, 5, 7, 48, 1, 134, 21, 104, 116, 116, 112, 58, 47, 47, 114, 51, 46, 111, 46, 108, 101, 110, 99, 114, 46, 111, 114, 103, 48, 34, 6, 8, 43, 6, 1, 5, 5, 7, 48, 2, 134, 22, 104, 116, 116, 112, 58, 47, 47, 114, 51, 46, 105, 46, 108, 101, 110, 99, 114, 46, 111, 114, 103, 47, 48, 34, 6, 3, 85, 29, 17, 4, 27, 48, 25, 130, 23, 104, 111, 117, 115, 101, 116, 114, 97, 105, 110, 105, 110, 103, 112, 117, 112, 112, 121, 46, 105, 110, 102, 111, 48, 19, 6, 3, 85, 29, 32, 4, 12, 48, 10, 48, 8, 6, 6, 103, 129, 12, 1, 2, 1, 48, 19, 6, 10, 43, 6, 1, 4, 1, 214, 121, 2, 4, 3, 1, 1, 255, 4, 2, 5, 0}
	_, err := unwrapExtensions(validPrecertBytes)
	if err != nil {
		t.Error("should not have errored")
	}

	invalidPrecertBytes := []byte{6, 6, 6}
	_, err = unwrapExtensions(invalidPrecertBytes)
	if err == nil {
