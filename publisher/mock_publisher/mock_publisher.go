...
func (_m *MockPublisher) SubmitToSingleCTWithResult(_param0 context.Context, _param1 *proto.Request) (*proto.Result, error) {
	ret := _m.ctrl.Call(_m, "SubmitToSingleCTWithResult", _param0, _param1)
	ret0, _ := ret[0].(*proto.Result)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

func (_mr *_MockPublisherRecorder) SubmitToSingleCTWithResult(arg0, arg1 interface{}) *gomock.Call {
	return _mr.mock.ctrl.RecordCall(_mr.mock, "SubmitToSingleCTWithResult", arg0, arg1)
}
