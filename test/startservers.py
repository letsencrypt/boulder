...
SERVICES = (
    ...
    Service('boulder-remoteva-a',
        ...
        ('./bin/boulder', 'boulder-remoteva', '--config', os.path.join(config_dir, 'remoteva-a.json'), '--addr', ':9897', '--debug-addr', ':8211'),
        None),
    Service('boulder-remoteva-b',
        8212, 9998, 'rva.boulder',
        ('./bin/boulder', 'boulder-remoteva', '--config', os.path.join(config_dir, 'remoteva-b.json'), '--addr', ':9998', '--debug-addr', ':8212'),
        None),
    ...
    Service('boulder-va-1',
        ...
        ('boulder-remoteva-old-a', 'boulder-remoteva-old-b', 'boulder-remoteva-a', 'boulder-remoteva-b')),
