...
def start(race_detection, fakeclock=None):
    ...
    progs.extend([
        ...
        [8103, 'boulder-sa --config %s --addr sa2.boulder:9195 --debug-addr :8103' % os.path.join(default_config_dir, "sa.json")],
        ...
        [8109, 'boulder-publisher --config %s --addr publisher2.boulder:9191 --debug-addr :8109' % os.path.join(default_config_dir, "publisher.json")],
        ...
        [8104, 'boulder-va --config %s --addr va2.boulder:9192 --debug-addr :8104' % os.path.join(default_config_dir, "va.json")],
        [8001, 'boulder-ca --config %s --ca-addr ca1.boulder:9093 --ocsp-addr :9096 --debug-addr :8001' % os.path.join(default_config_dir, "ca.json")],
        [8101, 'boulder-ca --config %s --ca-addr ca2.boulder:9193 --ocsp-addr :9196 --debug-addr :8101' % os.path.join(default_config_dir, "ca.json")],
        ...
        [8102, 'boulder-ra --config %s --addr ra2.boulder:9194 --debug-addr :8102' % os.path.join(default_config_dir, "ra.json")],
