...
SERVICES = (
    ...
    Service('boulder-va-2',
        ...
        ('boulder-remoteva-a', 'boulder-remoteva-b')),
    Service('boulder-ca',
        8001, 'ca.service.consul:9093',
        ('./bin/boulder', 'boulder-ca', '--config', os.path.join(config_dir, 'ca.json'), '--addr', 'ca.service.consul:9093', '--debug-addr', ':8001'),
    ...
    Service('crl-updater',
        ...
        ('boulder-ca', 'boulder-sa-1', 'boulder-sa-2', 'crl-storer')),
    Service('boulder-ra-1',
        ...
        ('boulder-sa-1', 'boulder-sa-2', 'boulder-ca', 'boulder-va-1', 'boulder-va-2', 'akamai-purger', 'boulder-publisher-1', 'boulder-publisher-2')),
