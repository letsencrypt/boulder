...
SERVICES = (
    ...
    Service('boulder-remoteva-b',
        ...
        None),
    Service('boulder-rva-a',
        8211, 9897, 'rva.boulder',
        ('./bin/boulder', 'boulder-rva', '--config', os.path.join(config_dir, 'rva-a.json'), '--addr', ':9897', '--debug-addr', ':8211'),
        None),
    Service('boulder-rva-b',
        8212, 9998, 'rva.boulder',
        ('./bin/boulder', 'boulder-rva', '--config', os.path.join(config_dir, 'rva-b.json'), '--addr', ':9998', '--debug-addr', ':8212'),
        None),
    ...
    Service('boulder-va-1',
        ...
        ('boulder-remoteva-a', 'boulder-remoteva-b', 'boulder-rva-a', 'boulder-rva-b')),
