...
SERVICES = (
    ...
    Service('boulder-sa-1',
        8003, '10.77.77.77:9095',
        ('./bin/boulder-sa', '--config', os.path.join(config_dir, 'sa.json'), '--addr', '10.77.77.77:9095', '--debug-addr', ':8003'),
        ('sd-test-srv',)),
    Service('boulder-sa-2',
        8103, '10.88.88.88:9095',
        ('./bin/boulder-sa', '--config', os.path.join(config_dir, 'sa.json'), '--addr', '10.88.88.88:9095', '--debug-addr', ':8103'),
        ('sd-test-srv',)),
    Service('ct-test-srv',
        4500, None,
