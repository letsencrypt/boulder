...
class ChallTestServer:
    ...
    def add_aaaa_record(self, host, addresses):
        ...
        """
        return self._postURL(self._URL("add-aaaa"), {"host": host, "addresses": addresses})
    ...
    def add_http_redirect(self, path, targetURL):
        ...
        """
        return self._postURL(self._URL("add-redirect"), {"path": path, "targetURL": targetURL})
    ...
    def add_http01_response(self, token, keyauth):
        ...
        """
        return self._postURL(self._URL("add-http"), {"token": token, "content": keyauth})
