...
def test_http_multiva_threshold_pass():
    ...
    guestlist = {"boulder": 1, "boulder-remoteva-a": 1, "boulder-remoteva-b": 1, "boulder-rva-a": 1}
...
def test_http_multiva_primary_fail_remote_pass():
    ...
    # remote VAs
    guestlist = {"boulder": 0, "boulder-remoteva-a": 1, "boulder-remoteva-b": 1, "boulder-rva-a": 1, "boulder-rva-b": 1}
