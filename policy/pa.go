...
//
// TODO(#7311): Dev environments should have a way to bypass this check for
// their own Private-Use IP addresses. Maybe plumb the DNSAllowLoopbackAddresses
// feature flag through to here.
//
// TODO(#8040): Consider changing this to return an error and/or the description
// of the reserved network.
