...
type UpsertEmailsRequest struct {
...
func (x *UpsertEmailsRequest) Reset() {
	*x = UpsertEmailsRequest{}
...
func (x *UpsertEmailsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UpsertEmailsRequest) ProtoMessage() {}

func (x *UpsertEmailsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_exporter_proto_msgTypes[0]
...
// Deprecated: Use UpsertEmailsRequest.ProtoReflect.Descriptor instead.
func (*UpsertEmailsRequest) Descriptor() ([]byte, []int) {
	return file_exporter_proto_rawDescGZIP(), []int{0}
}

func (x *UpsertEmailsRequest) GetEmails() []string {
	if x != nil {
		return x.Emails
	}
	return nil
...
var file_exporter_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0x2d, 0x0a, 0x13, 0x55, 0x70, 0x73, 0x65, 0x72, 0x74, 0x45, 0x6d,
	0x61, 0x69, 0x6c, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x65,
	...
	0x42, 0x0a, 0x0c, 0x55, 0x70, 0x73, 0x65, 0x72, 0x74, 0x45, 0x6d, 0x61, 0x69, 0x6c, 0x73, 0x12,
	0x1a, 0x2e, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x2e, 0x55, 0x70, 0x73, 0x65, 0x72, 0x74, 0x45, 0x6d,
	0x61, 0x69, 0x6c, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x16, 0x2e, 0x67, 0x6f,
...
var file_exporter_proto_goTypes = []interface{}{
	(*UpsertEmailsRequest)(nil), // 0: email.UpsertEmailsRequest
	(*emptypb.Empty)(nil),       // 1: google.protobuf.Empty
}
var file_exporter_proto_depIdxs = []int32{
	0, // 0: email.Exporter.UpsertEmails:input_type -> email.UpsertEmailsRequest
	1, // 1: email.Exporter.UpsertEmails:output_type -> google.protobuf.Empty
...
func file_exporter_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_exporter_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UpsertEmailsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
