...
type CreateProspectsRequest struct {
...
func (x *CreateProspectsRequest) Reset() {
	*x = CreateProspectsRequest{}
...
func (x *CreateProspectsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CreateProspectsRequest) ProtoMessage() {}

func (x *CreateProspectsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_exporter_proto_msgTypes[0]
...
// Deprecated: Use CreateProspectsRequest.ProtoReflect.Descriptor instead.
func (*CreateProspectsRequest) Descriptor() ([]byte, []int) {
	return file_exporter_proto_rawDescGZIP(), []int{0}
}

func (x *CreateProspectsRequest) GetEmails() []string {
	if x != nil {
		return x.Emails
	}
	return nil
...
var file_exporter_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0x30, 0x0a, 0x16, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x50, 0x72,
	0x6f, 0x73, 0x70, 0x65, 0x63, 0x74, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x16,
	0x0a, 0x06, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x09, 0x52, 0x06,
	0x65, 0x6d, 0x61, 0x69, 0x6c, 0x73, 0x32, 0x54, 0x0a, 0x08, 0x45, 0x78, 0x70, 0x6f, 0x72, 0x74,
	0x65, 0x72, 0x12, 0x48, 0x0a, 0x0f, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x50, 0x72, 0x6f, 0x73,
	0x70, 0x65, 0x63, 0x74, 0x73, 0x12, 0x1d, 0x2e, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x2e, 0x43, 0x72,
	0x65, 0x61, 0x74, 0x65, 0x50, 0x72, 0x6f, 0x73, 0x70, 0x65, 0x63, 0x74, 0x73, 0x52, 0x65, 0x71,
	...
	0x6e, 0x63, 0x72, 0x79, 0x70, 0x74, 0x2f, 0x62, 0x6f, 0x75, 0x6c, 0x64, 0x65, 0x72, 0x2f, 0x65,
	0x6d, 0x61, 0x69, 0x6c, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
var file_exporter_proto_goTypes = []interface{}{
	(*CreateProspectsRequest)(nil), // 0: email.CreateProspectsRequest
	(*emptypb.Empty)(nil),          // 1: google.protobuf.Empty
}
var file_exporter_proto_depIdxs = []int32{
	0, // 0: email.Exporter.CreateProspects:input_type -> email.CreateProspectsRequest
	1, // 1: email.Exporter.CreateProspects:output_type -> google.protobuf.Empty
...
func file_exporter_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_exporter_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CreateProspectsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
