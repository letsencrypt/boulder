...
type sc081FirstDate199ServerCertValidityTooLong struct{}
...
func init() {
	lint.RegisterCertificateLint(&lint.CertificateLint{
		LintMetadata: lint.LintMetadata{
			Name:            "w_server_cert_valid_time_longer_than_199_days",
			Description:     "TLS server certificates issued on or after on or after March 15, 2026 00:00 GMT/UTC should not have a validity period greater than 199 days",
		...
		Lint: NewSC081FirstDate199ServerCertValidityTooLong,
	})
}

func NewSC081FirstDate199ServerCertValidityTooLong() lint.LintInterface {
	return &sc081FirstDate199ServerCertValidityTooLong{}
}

func (l *sc081FirstDate199ServerCertValidityTooLong) CheckApplies(c *x509.Certificate) bool {
