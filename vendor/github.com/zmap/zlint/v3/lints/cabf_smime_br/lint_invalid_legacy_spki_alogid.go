...
func init() {
	lint.RegisterCertificateLint(&lint.CertificateLint{
		LintMetadata: lint.LintMetadata{
			Name:            "e_invalid_legacy_spki_algoid",
			...
			IneffectiveDate: util.CABF_SMIME_BRs_1_0_11_Date,
		},
		Lint: NewInvalidSPKIAlgoId,
	})
}

type InvalidLegacySPKIAlgoId struct{}

func NewInvalidLegacySPKIAlgoId() lint.LintInterface {
	return &InvalidLegacySPKIAlgoId{}
}

func (l *InvalidLegacySPKIAlgoId) CheckApplies(c *x509.Certificate) bool {
	return true
}

func (l *InvalidLegacySPKIAlgoId) Execute(c *x509.Certificate) *lint.LintResult {
