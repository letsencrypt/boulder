...
`, os.Args[0])
	...
	scope.MustRegister(responseTypesCounter)

	m := mux(scope, c.OCSPResponder.Path, source, responseTypesCounter)
	srv := &http.Server{
...
func mux(scope metrics.Scope, responderPath string, source bocsp.Source, responseTypesCounter *prometheus.CounterVec) http.Handler {
