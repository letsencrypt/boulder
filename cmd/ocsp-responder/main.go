...
// the path cleaning it's Handler method does. Notably http.ServeMux will collapse repeated
// slashes into a single slash which breaks the base64 standard encoding that is used in OCSP
// GET requests. CFSSL explicitly recommends against using http.ServeMux for this reason:
