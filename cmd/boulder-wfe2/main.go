...
type Config struct {
	WFE struct {
		...
		UnpauseHMACKey cmd.HMACKeyConfig `validate:"required_with=UnpauseJWTLifetime SFEUrl,structonly"`

		// UnpauseJWTLifetime is the lifetime of the unpause JWTs generated by the
		...
		UnpauseJWTLifetime config.Duration `validate:"omitempty,required_with=UnpauseHMACKey SFEUrl,min=336h"`
