...
func main() {
	...
	salesforceClient, err := email.NewSalesforceClientImpl(
		clk,
	...
	exporterServer := email.NewExporterImpl(salesforceClient, cache, c.EmailExporter.PerDayLimit, c.EmailExporter.MaxConcurrentRequests, scope, logger)
