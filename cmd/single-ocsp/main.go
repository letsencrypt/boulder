...
func main() {
	...
	app.Flags = []cli.Flag{
		...
		// A partial ocsp.Response.  The remainder will be filled
		// in from the certificates.
		//
		// {
		//   "Status": 0, // Good
		...
		cli.StringFlag{
			Name:  "template",
			Usage: "OCSP template file (JSON)",
		},

		// PKCS#11 config, as defined above
		//
		// {
		...
		cli.StringFlag{
			Name:  "pkcs11",
			Usage: "PKCS#11 configuration (JSON)",
		},
	}
