...
func (c *nonceServiceClient) Valid(ctx context.Context, in *NonceMessage, opts ...grpc.CallOption) (*ValidMessage, error) {
	...
	err := c.cc.Invoke(ctx, "/nonce.NonceService/Valid", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedNonceServiceServer) Valid(ctx context.Context, req *NonceMessage) (*ValidMessage, error) {
