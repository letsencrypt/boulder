...
func (pa *mockPA) ChallengesFor(identifier AcmeIdentifier, key *jose.JsonWebKey) (challenges []Challenge, combinations [][]int) {
	return
}

func (pa *mockPA) WillingToIssue(id AcmeIdentifier, regID int64) error {
