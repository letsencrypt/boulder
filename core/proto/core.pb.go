...
type Order struct {
	...
	MtcSubtreeID  int64 `protobuf:"varint,19,opt,name=mtcSubtreeID,proto3" json:"mtcSubtreeID,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Order) GetMtcSubtreeID() int64 {
	if x != nil {
...
var file_core_proto_rawDesc = string([]byte{
	...
	0x28, 0x03, 0x52, 0x0c, 0x6d, 0x74, 0x63, 0x53, 0x75, 0x62, 0x74, 0x72, 0x65, 0x65, 0x49, 0x44,
