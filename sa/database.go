...
// checkMariaDBSystemVariableQuoting ensures that a MariaDB config passed in via the
// CLI or set by the SA itself has the correct quoting for string variables,
// enumerations as strings, and enumerations as integers to prevent future
// problems such as PR #6683 from occurring. This is a manually curated list of
// server variables generated by a tool in issue #6687.
