...
var file_sa_proto_rawDesc = string([]byte{
	...
	0x74, 0x32, 0xf8, 0x0d, 0x0a, 0x18, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x41, 0x75, 0x74,
	...
	0x61, 0x74, 0x65, 0x4c, 0x69, 0x6d, 0x69, 0x74, 0x4f, 0x76, 0x65, 0x72, 0x72, 0x69, 0x64, 0x65,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x30, 0x01, 0x32, 0xbf, 0x1a, 0x0a,
...
var file_sa_proto_depIdxs = []int32{
	...
	20,  // 66: sa.StorageAuthorityReadOnly.GetValidOrderAuthorizations2:input_type -> sa.GetValidOrderAuthorizationsRequest
	...
	21,  // 84: sa.StorageAuthority.GetOrderForNames:input_type -> sa.GetOrderForNamesRequest
	...
	35,  // 88: sa.StorageAuthority.GetRevokedCertsByShard:input_type -> sa.GetRevokedCertsByShardRequest
	...
	30,  // 91: sa.StorageAuthority.GetSerialsByKey:input_type -> sa.SPKIHash
	...
	55,  // 128: sa.StorageAuthorityReadOnly.GetAuthorization2:output_type -> core.Authorization
	59,  // 129: sa.StorageAuthorityReadOnly.GetCertificate:output_type -> core.Certificate
	59,  // 130: sa.StorageAuthorityReadOnly.GetLintPrecertificate:output_type -> core.Certificate
	60,  // 131: sa.StorageAuthorityReadOnly.GetCertificateStatus:output_type -> core.CertificateStatus
	61,  // 132: sa.StorageAuthorityReadOnly.GetOrder:output_type -> core.Order
	61,  // 133: sa.StorageAuthorityReadOnly.GetOrderForNames:output_type -> core.Order
	58,  // 134: sa.StorageAuthorityReadOnly.GetRegistration:output_type -> core.Registration
	58,  // 135: sa.StorageAuthorityReadOnly.GetRegistrationByKey:output_type -> core.Registration
	36,  // 136: sa.StorageAuthorityReadOnly.GetRevocationStatus:output_type -> sa.RevocationStatus
	62,  // 137: sa.StorageAuthorityReadOnly.GetRevokedCertsByShard:output_type -> core.CRLEntry
	...
	24,  // 141: sa.StorageAuthorityReadOnly.GetValidAuthorizations2:output_type -> sa.Authorizations
	24,  // 142: sa.StorageAuthorityReadOnly.GetValidOrderAuthorizations2:output_type -> sa.Authorizations
	32,  // 143: sa.StorageAuthorityReadOnly.IncidentsForSerial:output_type -> sa.Incidents
	...
	34,  // 146: sa.StorageAuthorityReadOnly.SerialsForIncident:output_type -> sa.IncidentSerial
	40,  // 147: sa.StorageAuthorityReadOnly.CheckIdentifiersPaused:output_type -> sa.Identifiers
	40,  // 148: sa.StorageAuthorityReadOnly.GetPausedIdentifiers:output_type -> sa.Identifiers
	50,  // 149: sa.StorageAuthorityReadOnly.GetRateLimitOverride:output_type -> sa.RateLimitOverrideResponse
	50,  // 150: sa.StorageAuthorityReadOnly.GetEnabledRateLimitOverrides:output_type -> sa.RateLimitOverrideResponse
	...
	55,  // 155: sa.StorageAuthority.GetAuthorization2:output_type -> core.Authorization
	59,  // 156: sa.StorageAuthority.GetCertificate:output_type -> core.Certificate
	59,  // 157: sa.StorageAuthority.GetLintPrecertificate:output_type -> core.Certificate
	60,  // 158: sa.StorageAuthority.GetCertificateStatus:output_type -> core.CertificateStatus
	61,  // 159: sa.StorageAuthority.GetOrder:output_type -> core.Order
	61,  // 160: sa.StorageAuthority.GetOrderForNames:output_type -> core.Order
	58,  // 161: sa.StorageAuthority.GetRegistration:output_type -> core.Registration
	58,  // 162: sa.StorageAuthority.GetRegistrationByKey:output_type -> core.Registration
	36,  // 163: sa.StorageAuthority.GetRevocationStatus:output_type -> sa.RevocationStatus
	62,  // 164: sa.StorageAuthority.GetRevokedCertsByShard:output_type -> core.CRLEntry
	...
	24,  // 168: sa.StorageAuthority.GetValidAuthorizations2:output_type -> sa.Authorizations
	24,  // 169: sa.StorageAuthority.GetValidOrderAuthorizations2:output_type -> sa.Authorizations
	32,  // 170: sa.StorageAuthority.IncidentsForSerial:output_type -> sa.Incidents
	...
	34,  // 173: sa.StorageAuthority.SerialsForIncident:output_type -> sa.IncidentSerial
	40,  // 174: sa.StorageAuthority.CheckIdentifiersPaused:output_type -> sa.Identifiers
	40,  // 175: sa.StorageAuthority.GetPausedIdentifiers:output_type -> sa.Identifiers
	50,  // 176: sa.StorageAuthority.GetRateLimitOverride:output_type -> sa.RateLimitOverrideResponse
	50,  // 177: sa.StorageAuthority.GetEnabledRateLimitOverrides:output_type -> sa.RateLimitOverrideResponse
	57,  // 178: sa.StorageAuthority.AddBlockedKey:output_type -> google.protobuf.Empty
	57,  // 179: sa.StorageAuthority.AddCertificate:output_type -> google.protobuf.Empty
	57,  // 180: sa.StorageAuthority.AddPrecertificate:output_type -> google.protobuf.Empty
	57,  // 181: sa.StorageAuthority.AddSerial:output_type -> google.protobuf.Empty
	57,  // 182: sa.StorageAuthority.DeactivateAuthorization2:output_type -> google.protobuf.Empty
	58,  // 183: sa.StorageAuthority.DeactivateRegistration:output_type -> core.Registration
	57,  // 184: sa.StorageAuthority.FinalizeAuthorization2:output_type -> google.protobuf.Empty
	57,  // 185: sa.StorageAuthority.FinalizeOrder:output_type -> google.protobuf.Empty
	61,  // 186: sa.StorageAuthority.NewOrderAndAuthzs:output_type -> core.Order
	58,  // 187: sa.StorageAuthority.NewRegistration:output_type -> core.Registration
	57,  // 188: sa.StorageAuthority.RevokeCertificate:output_type -> google.protobuf.Empty
	57,  // 189: sa.StorageAuthority.SetOrderError:output_type -> google.protobuf.Empty
	57,  // 190: sa.StorageAuthority.SetOrderProcessing:output_type -> google.protobuf.Empty
	58,  // 191: sa.StorageAuthority.UpdateRegistrationKey:output_type -> core.Registration
	57,  // 192: sa.StorageAuthority.UpdateRevokedCertificate:output_type -> google.protobuf.Empty
	...
	42,  // 195: sa.StorageAuthority.PauseIdentifiers:output_type -> sa.PauseIdentifiersResponse
	7,   // 196: sa.StorageAuthority.UnpauseAccount:output_type -> sa.Count
	46,  // 197: sa.StorageAuthority.AddRateLimitOverride:output_type -> sa.AddRateLimitOverrideResponse
	57,  // 198: sa.StorageAuthority.DisableRateLimitOverride:output_type -> google.protobuf.Empty
	57,  // 199: sa.StorageAuthority.EnableRateLimitOverride:output_type -> google.protobuf.Empty
