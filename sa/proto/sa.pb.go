...
var file_sa_proto_rawDesc = []byte{
	...
	0x61, 0x6c, 0x22, 0x00, 0x30, 0x01, 0x12, 0x39, 0x0a, 0x13, 0x47, 0x65, 0x74, 0x53, 0x65, 0x72,
	...
	0x65, 0x6e, 0x74, 0x53, 0x65, 0x72, 0x69, 0x61, 0x6c, 0x22, 0x00, 0x30, 0x01, 0x12, 0x2f, 0x0a,
	...
	0x2e, 0x73, 0x61, 0x2e, 0x53, 0x65, 0x72, 0x69, 0x61, 0x6c, 0x22, 0x00, 0x30, 0x01, 0x12, 0x39,
...
var file_sa_proto_depIdxs = []int32{
	...
	36,  // 69: sa.StorageAuthorityReadOnly.KeyBlocked:input_type -> sa.SPKIHash
	...
	36,  // 73: sa.StorageAuthorityReadOnly.GetSerialsByKey:input_type -> sa.SPKIHash
	0,   // 74: sa.StorageAuthorityReadOnly.GetSerialsByAccount:input_type -> sa.RegistrationID
	...
	4,   // 98: sa.StorageAuthority.GetValidAuthorizations2:input_type -> sa.GetValidAuthorizationsRequest
	26,  // 99: sa.StorageAuthority.GetValidOrderAuthorizations2:input_type -> sa.GetValidOrderAuthorizationsRequest
	6,   // 100: sa.StorageAuthority.IncidentsForSerial:input_type -> sa.Serial
	36,  // 101: sa.StorageAuthority.KeyBlocked:input_type -> sa.SPKIHash
	18,  // 102: sa.StorageAuthority.PreviousCertificateExists:input_type -> sa.PreviousCertificateExistsRequest
	6,   // 103: sa.StorageAuthority.ReplacementOrderExists:input_type -> sa.Serial
	39,  // 104: sa.StorageAuthority.SerialsForIncident:input_type -> sa.SerialsForIncidentRequest
	36,  // 105: sa.StorageAuthority.GetSerialsByKey:input_type -> sa.SPKIHash
	0,   // 106: sa.StorageAuthority.GetSerialsByAccount:input_type -> sa.RegistrationID
	...
	30,  // 148: sa.StorageAuthorityReadOnly.GetValidAuthorizations2:output_type -> sa.Authorizations
	30,  // 149: sa.StorageAuthorityReadOnly.GetValidOrderAuthorizations2:output_type -> sa.Authorizations
	38,  // 150: sa.StorageAuthorityReadOnly.IncidentsForSerial:output_type -> sa.Incidents
	19,  // 151: sa.StorageAuthorityReadOnly.KeyBlocked:output_type -> sa.Exists
	19,  // 152: sa.StorageAuthorityReadOnly.PreviousCertificateExists:output_type -> sa.Exists
	19,  // 153: sa.StorageAuthorityReadOnly.ReplacementOrderExists:output_type -> sa.Exists
	40,  // 154: sa.StorageAuthorityReadOnly.SerialsForIncident:output_type -> sa.IncidentSerial
	...
	30,  // 180: sa.StorageAuthority.GetValidAuthorizations2:output_type -> sa.Authorizations
	30,  // 181: sa.StorageAuthority.GetValidOrderAuthorizations2:output_type -> sa.Authorizations
	38,  // 182: sa.StorageAuthority.IncidentsForSerial:output_type -> sa.Incidents
	19,  // 183: sa.StorageAuthority.KeyBlocked:output_type -> sa.Exists
	19,  // 184: sa.StorageAuthority.PreviousCertificateExists:output_type -> sa.Exists
	19,  // 185: sa.StorageAuthority.ReplacementOrderExists:output_type -> sa.Exists
	40,  // 186: sa.StorageAuthority.SerialsForIncident:output_type -> sa.IncidentSerial
	6,   // 187: sa.StorageAuthority.GetSerialsByKey:output_type -> sa.Serial
