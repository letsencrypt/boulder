...
func (*GetOrderForNamesRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{26} }
...
func (*GetAuthorizationsRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{27} }
...
func (*Authorizations) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{28} }
...
func (*Authorizations_MapElement) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{28, 0} }
...
func (*AuthorizationIDs) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{30} }
...
func (m *AuthorizationID2) String() string            { return proto1.CompactTextString(m) }
func (*AuthorizationID2) ProtoMessage()               {}
func (*AuthorizationID2) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{31} }
...
func (m *RevokeCertificateRequest) String() string            { return proto1.CompactTextString(m) }
func (*RevokeCertificateRequest) ProtoMessage()               {}
func (*RevokeCertificateRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{32} }
...
type FinalizeAuthorizationRequest struct {
	...
	ValidationRecords []*core.ValidationRecord `protobuf:"bytes,5,rep,name=validationRecords" json:"validationRecords,omitempty"`
	ValidationError   *core.ProblemDetails     `protobuf:"bytes,6,opt,name=validationError" json:"validationError,omitempty"`
	XXX_unrecognized  []byte                   `json:"-"`
}

func (m *FinalizeAuthorizationRequest) Reset()                    { *m = FinalizeAuthorizationRequest{} }
func (m *FinalizeAuthorizationRequest) String() string            { return proto1.CompactTextString(m) }
func (*FinalizeAuthorizationRequest) ProtoMessage()               {}
func (*FinalizeAuthorizationRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{33} }
...
func (m *FinalizeAuthorizationRequest) GetValidationRecords() []*core.ValidationRecord {
	if m != nil {
...
func (m *FinalizeAuthorizationRequest) GetValidationError() *core.ProblemDetails {
	if m != nil {
...
func init() {
	...
	proto1.RegisterType((*FinalizeAuthorizationRequest)(nil), "sa.FinalizeAuthorizationRequest")
}
...
type StorageAuthorityClient interface {
	...
	GetAuthorization2(ctx context.Context, in *AuthorizationID2, opts ...grpc.CallOption) (*core.Authorization, error)
	GetAuthorizations2(ctx context.Context, in *GetAuthorizationsRequest, opts ...grpc.CallOption) (*Authorizations, error)
	GetPendingAuthorization2(ctx context.Context, in *GetPendingAuthorizationRequest, opts ...grpc.CallOption) (*core.Authorization, error)
	...
	NewAuthorization(ctx context.Context, in *core.Authorization, opts ...grpc.CallOption) (*AuthorizationID2, error)
	NewAuthorizations(ctx context.Context, in *AddPendingAuthorizationsRequest, opts ...grpc.CallOption) (*AuthorizationIDs, error)
	FinalizeAuthorization2(ctx context.Context, in *FinalizeAuthorizationRequest, opts ...grpc.CallOption) (*core.Empty, error)
	DeactivateAuthorization2(ctx context.Context, in *AuthorizationID2, opts ...grpc.CallOption) (*core.Empty, error)
	RevokeAuthorizationsByDomain2(ctx context.Context, in *RevokeAuthorizationsByDomainRequest, opts ...grpc.CallOption) (*RevokeAuthorizationsByDomainResponse, error)
}
...
func (c *storageAuthorityClient) GetAuthorization2(ctx context.Context, in *AuthorizationID2, opts ...grpc.CallOption) (*core.Authorization, error) {
	out := new(core.Authorization)
	err := grpc.Invoke(ctx, "/sa.StorageAuthority/GetAuthorization2", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *storageAuthorityClient) GetAuthorizations2(ctx context.Context, in *GetAuthorizationsRequest, opts ...grpc.CallOption) (*Authorizations, error) {
	...
	err := grpc.Invoke(ctx, "/sa.StorageAuthority/GetAuthorizations2", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *storageAuthorityClient) GetPendingAuthorization2(ctx context.Context, in *GetPendingAuthorizationRequest, opts ...grpc.CallOption) (*core.Authorization, error) {
	out := new(core.Authorization)
	err := grpc.Invoke(ctx, "/sa.StorageAuthority/GetPendingAuthorization2", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *storageAuthorityClient) CountPendingAuthorizations2(ctx context.Context, in *RegistrationID, opts ...grpc.CallOption) (*Count, error) {
	out := new(Count)
	err := grpc.Invoke(ctx, "/sa.StorageAuthority/CountPendingAuthorizations2", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *storageAuthorityClient) GetValidOrderAuthorizations2(ctx context.Context, in *GetValidOrderAuthorizationsRequest, opts ...grpc.CallOption) (*Authorizations, error) {
	out := new(Authorizations)
	err := grpc.Invoke(ctx, "/sa.StorageAuthority/GetValidOrderAuthorizations2", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *storageAuthorityClient) CountInvalidAuthorizations2(ctx context.Context, in *CountInvalidAuthorizationsRequest, opts ...grpc.CallOption) (*Count, error) {
	out := new(Count)
	err := grpc.Invoke(ctx, "/sa.StorageAuthority/CountInvalidAuthorizations2", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *storageAuthorityClient) GetValidAuthorizations2(ctx context.Context, in *GetValidAuthorizationsRequest, opts ...grpc.CallOption) (*Authorizations, error) {
	out := new(Authorizations)
	err := grpc.Invoke(ctx, "/sa.StorageAuthority/GetValidAuthorizations2", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *storageAuthorityClient) RevokeCertificate(ctx context.Context, in *RevokeCertificateRequest, opts ...grpc.CallOption) (*core.Empty, error) {
	out := new(core.Empty)
	err := grpc.Invoke(ctx, "/sa.StorageAuthority/RevokeCertificate", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *storageAuthorityClient) NewAuthorization(ctx context.Context, in *core.Authorization, opts ...grpc.CallOption) (*AuthorizationID2, error) {
	out := new(AuthorizationID2)
	err := grpc.Invoke(ctx, "/sa.StorageAuthority/NewAuthorization", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *storageAuthorityClient) NewAuthorizations(ctx context.Context, in *AddPendingAuthorizationsRequest, opts ...grpc.CallOption) (*AuthorizationIDs, error) {
	out := new(AuthorizationIDs)
	err := grpc.Invoke(ctx, "/sa.StorageAuthority/NewAuthorizations", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *storageAuthorityClient) FinalizeAuthorization2(ctx context.Context, in *FinalizeAuthorizationRequest, opts ...grpc.CallOption) (*core.Empty, error) {
	out := new(core.Empty)
	err := grpc.Invoke(ctx, "/sa.StorageAuthority/FinalizeAuthorization2", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *storageAuthorityClient) DeactivateAuthorization2(ctx context.Context, in *AuthorizationID2, opts ...grpc.CallOption) (*core.Empty, error) {
	out := new(core.Empty)
	err := grpc.Invoke(ctx, "/sa.StorageAuthority/DeactivateAuthorization2", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *storageAuthorityClient) RevokeAuthorizationsByDomain2(ctx context.Context, in *RevokeAuthorizationsByDomainRequest, opts ...grpc.CallOption) (*RevokeAuthorizationsByDomainResponse, error) {
	out := new(RevokeAuthorizationsByDomainResponse)
	err := grpc.Invoke(ctx, "/sa.StorageAuthority/RevokeAuthorizationsByDomain2", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type StorageAuthorityServer interface {
	...
	GetAuthorization2(context.Context, *AuthorizationID2) (*core.Authorization, error)
	GetAuthorizations2(context.Context, *GetAuthorizationsRequest) (*Authorizations, error)
	GetPendingAuthorization2(context.Context, *GetPendingAuthorizationRequest) (*core.Authorization, error)
	...
	NewAuthorization(context.Context, *core.Authorization) (*AuthorizationID2, error)
	NewAuthorizations(context.Context, *AddPendingAuthorizationsRequest) (*AuthorizationIDs, error)
	FinalizeAuthorization2(context.Context, *FinalizeAuthorizationRequest) (*core.Empty, error)
	DeactivateAuthorization2(context.Context, *AuthorizationID2) (*core.Empty, error)
	RevokeAuthorizationsByDomain2(context.Context, *RevokeAuthorizationsByDomainRequest) (*RevokeAuthorizationsByDomainResponse, error)
}
...
func _StorageAuthority_NewAuthorization_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(core.Authorization)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StorageAuthorityServer).NewAuthorization(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sa.StorageAuthority/NewAuthorization",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StorageAuthorityServer).NewAuthorization(ctx, req.(*core.Authorization))
	}
	return interceptor(ctx, in, info, handler)
}

func _StorageAuthority_NewAuthorizations_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AddPendingAuthorizationsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StorageAuthorityServer).NewAuthorizations(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sa.StorageAuthority/NewAuthorizations",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StorageAuthorityServer).NewAuthorizations(ctx, req.(*AddPendingAuthorizationsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _StorageAuthority_RevokeAuthorizationsByDomain2_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RevokeAuthorizationsByDomainRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StorageAuthorityServer).RevokeAuthorizationsByDomain2(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sa.StorageAuthority/RevokeAuthorizationsByDomain2",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StorageAuthorityServer).RevokeAuthorizationsByDomain2(ctx, req.(*RevokeAuthorizationsByDomainRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _StorageAuthority_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _StorageAuthority_NewAuthorization_Handler,
		},
		{
			MethodName: "NewAuthorizations",
			Handler:    _StorageAuthority_NewAuthorizations_Handler,
		},
		{
		...
		{
			MethodName: "RevokeAuthorizationsByDomain2",
			Handler:    _StorageAuthority_RevokeAuthorizationsByDomain2_Handler,
		},
	},
...
var fileDescriptor0 = []byte{
	...
	,
}
