...
var file_sa_proto_rawDesc = string([]byte{
	...
	0x74, 0x22, 0x24, 0x0a, 0x06, 0x41, 0x75, 0x74, 0x68, 0x7a, 0x73, 0x12, 0x1a, 0x0a, 0x08, 0x61,
	0x75, 0x74, 0x68, 0x7a, 0x49, 0x44, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x03, 0x52, 0x08, 0x61,
	0x75, 0x74, 0x68, 0x7a, 0x49, 0x44, 0x73, 0x32, 0xc2, 0x0e, 0x0a, 0x18, 0x53, 0x74, 0x6f, 0x72,
	...
	0x61, 0x74, 0x65, 0x4c, 0x69, 0x6d, 0x69, 0x74, 0x4f, 0x76, 0x65, 0x72, 0x72, 0x69, 0x64, 0x65,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x30, 0x01, 0x32, 0x89, 0x1b, 0x0a,
...
var file_sa_proto_depIdxs = []int32{
	...
	58,  // 103: sa.StorageAuthority.GetEnabledRateLimitOverrides:input_type -> google.protobuf.Empty
	...
	59,  // 113: sa.StorageAuthority.NewRegistration:input_type -> core.Registration
	...
	56,  // 130: sa.StorageAuthorityReadOnly.GetAuthorization2:output_type -> core.Authorization
	24,  // 131: sa.StorageAuthorityReadOnly.GetAuthorizations2:output_type -> sa.Authorizations
	60,  // 132: sa.StorageAuthorityReadOnly.GetCertificate:output_type -> core.Certificate
	60,  // 133: sa.StorageAuthorityReadOnly.GetLintPrecertificate:output_type -> core.Certificate
	61,  // 134: sa.StorageAuthorityReadOnly.GetCertificateStatus:output_type -> core.CertificateStatus
	62,  // 135: sa.StorageAuthorityReadOnly.GetOrder:output_type -> core.Order
	62,  // 136: sa.StorageAuthorityReadOnly.GetOrderForNames:output_type -> core.Order
	59,  // 137: sa.StorageAuthorityReadOnly.GetRegistration:output_type -> core.Registration
	59,  // 138: sa.StorageAuthorityReadOnly.GetRegistrationByKey:output_type -> core.Registration
	36,  // 139: sa.StorageAuthorityReadOnly.GetRevocationStatus:output_type -> sa.RevocationStatus
	63,  // 140: sa.StorageAuthorityReadOnly.GetRevokedCertsByShard:output_type -> core.CRLEntry
	...
	56,  // 158: sa.StorageAuthority.GetAuthorization2:output_type -> core.Authorization
	24,  // 159: sa.StorageAuthority.GetAuthorizations2:output_type -> sa.Authorizations
	60,  // 160: sa.StorageAuthority.GetCertificate:output_type -> core.Certificate
	60,  // 161: sa.StorageAuthority.GetLintPrecertificate:output_type -> core.Certificate
	61,  // 162: sa.StorageAuthority.GetCertificateStatus:output_type -> core.CertificateStatus
	62,  // 163: sa.StorageAuthority.GetOrder:output_type -> core.Order
	62,  // 164: sa.StorageAuthority.GetOrderForNames:output_type -> core.Order
	59,  // 165: sa.StorageAuthority.GetRegistration:output_type -> core.Registration
	59,  // 166: sa.StorageAuthority.GetRegistrationByKey:output_type -> core.Registration
	36,  // 167: sa.StorageAuthority.GetRevocationStatus:output_type -> sa.RevocationStatus
	63,  // 168: sa.StorageAuthority.GetRevokedCertsByShard:output_type -> core.CRLEntry
	...
	58,  // 182: sa.StorageAuthority.AddBlockedKey:output_type -> google.protobuf.Empty
	58,  // 183: sa.StorageAuthority.AddCertificate:output_type -> google.protobuf.Empty
	58,  // 184: sa.StorageAuthority.AddPrecertificate:output_type -> google.protobuf.Empty
	58,  // 185: sa.StorageAuthority.AddSerial:output_type -> google.protobuf.Empty
	58,  // 186: sa.StorageAuthority.DeactivateAuthorization2:output_type -> google.protobuf.Empty
	59,  // 187: sa.StorageAuthority.DeactivateRegistration:output_type -> core.Registration
	58,  // 188: sa.StorageAuthority.FinalizeAuthorization2:output_type -> google.protobuf.Empty
	58,  // 189: sa.StorageAuthority.FinalizeOrder:output_type -> google.protobuf.Empty
	62,  // 190: sa.StorageAuthority.NewOrderAndAuthzs:output_type -> core.Order
	59,  // 191: sa.StorageAuthority.NewRegistration:output_type -> core.Registration
	58,  // 192: sa.StorageAuthority.RevokeCertificate:output_type -> google.protobuf.Empty
	58,  // 193: sa.StorageAuthority.SetOrderError:output_type -> google.protobuf.Empty
	58,  // 194: sa.StorageAuthority.SetOrderProcessing:output_type -> google.protobuf.Empty
	59,  // 195: sa.StorageAuthority.UpdateRegistrationKey:output_type -> core.Registration
	58,  // 196: sa.StorageAuthority.UpdateRevokedCertificate:output_type -> google.protobuf.Empty
	38,  // 197: sa.StorageAuthority.LeaseCRLShard:output_type -> sa.LeaseCRLShardResponse
	58,  // 198: sa.StorageAuthority.UpdateCRLShard:output_type -> google.protobuf.Empty
	...
	58,  // 202: sa.StorageAuthority.DisableRateLimitOverride:output_type -> google.protobuf.Empty
	58,  // 203: sa.StorageAuthority.EnableRateLimitOverride:output_type -> google.protobuf.Empty
