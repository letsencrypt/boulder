...
func (m *RevokeAuthorizationsByDomainRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_RevokeAuthorizationsByDomainRequest.Unmarshal(m, b)
}
func (m *RevokeAuthorizationsByDomainRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_RevokeAuthorizationsByDomainRequest.Marshal(b, m, deterministic)
}
func (m *RevokeAuthorizationsByDomainRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RevokeAuthorizationsByDomainRequest.Merge(m, src)
}
func (m *RevokeAuthorizationsByDomainRequest) XXX_Size() int {
	return xxx_messageInfo_RevokeAuthorizationsByDomainRequest.Size(m)
}
func (m *RevokeAuthorizationsByDomainRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_RevokeAuthorizationsByDomainRequest.DiscardUnknown(m)
}

var xxx_messageInfo_RevokeAuthorizationsByDomainRequest proto.InternalMessageInfo
...
func (m *RevokeAuthorizationsByDomainResponse) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_RevokeAuthorizationsByDomainResponse.Unmarshal(m, b)
}
func (m *RevokeAuthorizationsByDomainResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_RevokeAuthorizationsByDomainResponse.Marshal(b, m, deterministic)
}
func (m *RevokeAuthorizationsByDomainResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RevokeAuthorizationsByDomainResponse.Merge(m, src)
}
func (m *RevokeAuthorizationsByDomainResponse) XXX_Size() int {
	return xxx_messageInfo_RevokeAuthorizationsByDomainResponse.Size(m)
}
func (m *RevokeAuthorizationsByDomainResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_RevokeAuthorizationsByDomainResponse.DiscardUnknown(m)
}

var xxx_messageInfo_RevokeAuthorizationsByDomainResponse proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*RevokeAuthorizationsByDomainResponse)(nil), "sa.RevokeAuthorizationsByDomainResponse")
...
type StorageAuthorityClient interface {
	...
	NewAuthorization(ctx context.Context, in *proto1.Authorization, opts ...grpc.CallOption) (*AuthorizationID2, error)
...
func (c *storageAuthorityClient) CountCertificatesByExactNames(ctx context.Context, in *CountCertificatesByNamesRequest, opts ...grpc.CallOption) (*CountByNames, error) {
	out := new(CountByNames)
	err := c.cc.Invoke(ctx, "/sa.StorageAuthority/CountCertificatesByExactNames", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *storageAuthorityClient) RevokeAuthorizationsByDomain(ctx context.Context, in *RevokeAuthorizationsByDomainRequest, opts ...grpc.CallOption) (*RevokeAuthorizationsByDomainResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/sa.StorageAuthority/RevokeAuthorizationsByDomain", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *storageAuthorityClient) NewAuthorization(ctx context.Context, in *proto1.Authorization, opts ...grpc.CallOption) (*AuthorizationID2, error) {
	out := new(AuthorizationID2)
	err := c.cc.Invoke(ctx, "/sa.StorageAuthority/NewAuthorization", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *storageAuthorityClient) NewAuthorizations(ctx context.Context, in *AddPendingAuthorizationsRequest, opts ...grpc.CallOption) (*AuthorizationIDs, error) {
	out := new(AuthorizationIDs)
	err := c.cc.Invoke(ctx, "/sa.StorageAuthority/NewAuthorizations", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *storageAuthorityClient) RevokeAuthorizationsByDomain2(ctx context.Context, in *RevokeAuthorizationsByDomainRequest, opts ...grpc.CallOption) (*RevokeAuthorizationsByDomainResponse, error) {
	out := new(RevokeAuthorizationsByDomainResponse)
	err := c.cc.Invoke(ctx, "/sa.StorageAuthority/RevokeAuthorizationsByDomain2", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type StorageAuthorityServer interface {
	...
	NewAuthorization(context.Context, *proto1.Authorization) (*AuthorizationID2, error)
...
func (*UnimplementedStorageAuthorityServer) CountCertificatesByExactNames(ctx context.Context, req *CountCertificatesByNamesRequest) (*CountByNames, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CountCertificatesByExactNames not implemented")
}
...
func (*UnimplementedStorageAuthorityServer) RevokeAuthorizationsByDomain(ctx context.Context, req *RevokeAuthorizationsByDomainRequest) (*RevokeAuthorizationsByDomainResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RevokeAuthorizationsByDomain not implemented")
}
...
func (*UnimplementedStorageAuthorityServer) NewAuthorization(ctx context.Context, req *proto1.Authorization) (*AuthorizationID2, error) {
	return nil, status.Errorf(codes.Unimplemented, "method NewAuthorization not implemented")
}
func (*UnimplementedStorageAuthorityServer) NewAuthorizations(ctx context.Context, req *AddPendingAuthorizationsRequest) (*AuthorizationIDs, error) {
	return nil, status.Errorf(codes.Unimplemented, "method NewAuthorizations not implemented")
}
...
func (*UnimplementedStorageAuthorityServer) RevokeAuthorizationsByDomain2(ctx context.Context, req *RevokeAuthorizationsByDomainRequest) (*RevokeAuthorizationsByDomainResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RevokeAuthorizationsByDomain2 not implemented")
}
...
func _StorageAuthority_NewAuthorization_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StorageAuthorityServer).NewAuthorization(ctx, req.(*proto1.Authorization))
	}
	return interceptor(ctx, in, info, handler)
}
