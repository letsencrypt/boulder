...
var file_sa_proto_rawDesc = []byte{
	...
	0x64, 0x44, 0x61, 0x74, 0x65, 0x32, 0xdf, 0x18, 0x0a, 0x10, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67,
	0x65, 0x41, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x69, 0x74, 0x79, 0x12, 0x3b, 0x0a, 0x0f, 0x47, 0x65,
	...
	0x69, 0x6f, 0x6e, 0x22, 0x00, 0x12, 0x35, 0x0a, 0x11, 0x47, 0x65, 0x74, 0x53, 0x65, 0x72, 0x69,
	...
	0x61, 0x6c, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x22, 0x00, 0x12, 0x31, 0x0a, 0x0e,
	...
	0x75, 0x73, 0x22, 0x00, 0x12, 0x39, 0x0a, 0x13, 0x47, 0x65, 0x74, 0x52, 0x65, 0x76, 0x6f, 0x63,
	...
	0x61, 0x2e, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x00, 0x12, 0x48, 0x0a, 0x1a, 0x46, 0x51, 0x44,
	...
	0x73, 0x22, 0x00, 0x12, 0x37, 0x0a, 0x0d, 0x46, 0x51, 0x44, 0x4e, 0x53, 0x65, 0x74, 0x45, 0x78,
	...
	0x6c, 0x22, 0x00, 0x30, 0x01, 0x12, 0x41, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x52, 0x65, 0x76, 0x6f,
	...
	0x6e, 0x74, 0x72, 0x79, 0x22, 0x00, 0x30, 0x01, 0x12, 0x48, 0x0a, 0x10, 0x47, 0x65, 0x74, 0x4d,
	...
	0x6e, 0x74, 0x73, 0x22, 0x00, 0x12, 0x3b, 0x0a, 0x0f, 0x4e, 0x65, 0x77, 0x52, 0x65, 0x67, 0x69,
	...
	0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x45,
	0x6d, 0x70, 0x74, 0x79, 0x22, 0x00, 0x12, 0x49, 0x0a, 0x0e, 0x41, 0x64, 0x64, 0x43, 0x65, 0x72,
	...
	0x65, 0x73, 0x74, 0x1a, 0x1a, 0x2e, 0x73, 0x61, 0x2e, 0x41, 0x64, 0x64, 0x43, 0x65, 0x72, 0x74,
	...
	0x12, 0x2e, 0x0a, 0x08, 0x4e, 0x65, 0x77, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x12, 0x13, 0x2e, 0x73,
	...
	0x6f, 0x72, 0x65, 0x2e, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x22, 0x00, 0x12, 0x4b, 0x0a, 0x11, 0x52,
	...
	0x73, 0x32, 0x12, 0x23, 0x2e, 0x73, 0x61, 0x2e, 0x41, 0x64, 0x64, 0x50, 0x65, 0x6e, 0x64, 0x69,
	0x6e, 0x67, 0x41, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x69, 0x7a, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x15, 0x2e, 0x73, 0x61, 0x2e, 0x41, 0x75, 0x74,
	0x68, 0x6f, 0x72, 0x69, 0x7a, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x32, 0x49, 0x44, 0x73, 0x22, 0x00,
...
var file_sa_proto_depIdxs = []int32{
	...
	0,  // 18: sa.StorageAuthority.GetRegistration:input_type -> sa.RegistrationID
	1,  // 19: sa.StorageAuthority.GetRegistrationByKey:input_type -> sa.JSONWebKey
	6,  // 20: sa.StorageAuthority.GetSerialMetadata:input_type -> sa.Serial
	6,  // 21: sa.StorageAuthority.GetCertificate:input_type -> sa.Serial
	6,  // 22: sa.StorageAuthority.GetPrecertificate:input_type -> sa.Serial
	6,  // 23: sa.StorageAuthority.GetCertificateStatus:input_type -> sa.Serial
	6,  // 24: sa.StorageAuthority.GetRevocationStatus:input_type -> sa.Serial
	11, // 25: sa.StorageAuthority.CountCertificatesByNames:input_type -> sa.CountCertificatesByNamesRequest
	13, // 26: sa.StorageAuthority.CountRegistrationsByIP:input_type -> sa.CountRegistrationsByIPRequest
	13, // 27: sa.StorageAuthority.CountRegistrationsByIPRange:input_type -> sa.CountRegistrationsByIPRequest
	15, // 28: sa.StorageAuthority.CountOrders:input_type -> sa.CountOrdersRequest
	16, // 29: sa.StorageAuthority.CountFQDNSets:input_type -> sa.CountFQDNSetsRequest
	16, // 30: sa.StorageAuthority.FQDNSetTimestampsForWindow:input_type -> sa.CountFQDNSetsRequest
	17, // 31: sa.StorageAuthority.FQDNSetExists:input_type -> sa.FQDNSetExistsRequest
	18, // 32: sa.StorageAuthority.PreviousCertificateExists:input_type -> sa.PreviousCertificateExistsRequest
	34, // 33: sa.StorageAuthority.GetAuthorization2:input_type -> sa.AuthorizationID2
	30, // 34: sa.StorageAuthority.GetAuthorizations2:input_type -> sa.GetAuthorizationsRequest
	3,  // 35: sa.StorageAuthority.GetPendingAuthorization2:input_type -> sa.GetPendingAuthorizationRequest
	0,  // 36: sa.StorageAuthority.CountPendingAuthorizations2:input_type -> sa.RegistrationID
	27, // 37: sa.StorageAuthority.GetValidOrderAuthorizations2:input_type -> sa.GetValidOrderAuthorizationsRequest
	14, // 38: sa.StorageAuthority.CountInvalidAuthorizations2:input_type -> sa.CountInvalidAuthorizationsRequest
	4,  // 39: sa.StorageAuthority.GetValidAuthorizations2:input_type -> sa.GetValidAuthorizationsRequest
	39, // 40: sa.StorageAuthority.KeyBlocked:input_type -> sa.KeyBlockedRequest
	42, // 41: sa.StorageAuthority.SerialsForIncident:input_type -> sa.SerialsForIncidentRequest
	44, // 42: sa.StorageAuthority.GetRevokedCerts:input_type -> sa.GetRevokedCertsRequest
	53, // 43: sa.StorageAuthority.GetMaxExpiration:input_type -> google.protobuf.Empty
	6,  // 44: sa.StorageAuthority.IncidentsForSerial:input_type -> sa.Serial
	54, // 45: sa.StorageAuthority.NewRegistration:input_type -> core.Registration
	54, // 46: sa.StorageAuthority.UpdateRegistration:input_type -> core.Registration
	21, // 47: sa.StorageAuthority.AddCertificate:input_type -> sa.AddCertificateRequest
	21, // 48: sa.StorageAuthority.AddPrecertificate:input_type -> sa.AddCertificateRequest
	20, // 49: sa.StorageAuthority.AddSerial:input_type -> sa.AddSerialRequest
	0,  // 50: sa.StorageAuthority.DeactivateRegistration:input_type -> sa.RegistrationID
	24, // 51: sa.StorageAuthority.NewOrder:input_type -> sa.NewOrderRequest
	25, // 52: sa.StorageAuthority.NewOrderAndAuthzs:input_type -> sa.NewOrderAndAuthzsRequest
	23, // 53: sa.StorageAuthority.SetOrderProcessing:input_type -> sa.OrderRequest
	26, // 54: sa.StorageAuthority.SetOrderError:input_type -> sa.SetOrderErrorRequest
	29, // 55: sa.StorageAuthority.FinalizeOrder:input_type -> sa.FinalizeOrderRequest
	23, // 56: sa.StorageAuthority.GetOrder:input_type -> sa.OrderRequest
	28, // 57: sa.StorageAuthority.GetOrderForNames:input_type -> sa.GetOrderForNamesRequest
	36, // 58: sa.StorageAuthority.RevokeCertificate:input_type -> sa.RevokeCertificateRequest
	36, // 59: sa.StorageAuthority.UpdateRevokedCertificate:input_type -> sa.RevokeCertificateRequest
	32, // 60: sa.StorageAuthority.NewAuthorizations2:input_type -> sa.AddPendingAuthorizationsRequest
	37, // 61: sa.StorageAuthority.FinalizeAuthorization2:input_type -> sa.FinalizeAuthorizationRequest
	34, // 62: sa.StorageAuthority.DeactivateAuthorization2:input_type -> sa.AuthorizationID2
	38, // 63: sa.StorageAuthority.AddBlockedKey:input_type -> sa.AddBlockedKeyRequest
	54, // 64: sa.StorageAuthority.GetRegistration:output_type -> core.Registration
	54, // 65: sa.StorageAuthority.GetRegistrationByKey:output_type -> core.Registration
	7,  // 66: sa.StorageAuthority.GetSerialMetadata:output_type -> sa.SerialMetadata
	55, // 67: sa.StorageAuthority.GetCertificate:output_type -> core.Certificate
	55, // 68: sa.StorageAuthority.GetPrecertificate:output_type -> core.Certificate
	56, // 69: sa.StorageAuthority.GetCertificateStatus:output_type -> core.CertificateStatus
	45, // 70: sa.StorageAuthority.GetRevocationStatus:output_type -> sa.RevocationStatus
	12, // 71: sa.StorageAuthority.CountCertificatesByNames:output_type -> sa.CountByNames
	9,  // 72: sa.StorageAuthority.CountRegistrationsByIP:output_type -> sa.Count
	9,  // 73: sa.StorageAuthority.CountRegistrationsByIPRange:output_type -> sa.Count
	9,  // 74: sa.StorageAuthority.CountOrders:output_type -> sa.Count
	9,  // 75: sa.StorageAuthority.CountFQDNSets:output_type -> sa.Count
	10, // 76: sa.StorageAuthority.FQDNSetTimestampsForWindow:output_type -> sa.Timestamps
	19, // 77: sa.StorageAuthority.FQDNSetExists:output_type -> sa.Exists
	19, // 78: sa.StorageAuthority.PreviousCertificateExists:output_type -> sa.Exists
	50, // 79: sa.StorageAuthority.GetAuthorization2:output_type -> core.Authorization
	31, // 80: sa.StorageAuthority.GetAuthorizations2:output_type -> sa.Authorizations
	50, // 81: sa.StorageAuthority.GetPendingAuthorization2:output_type -> core.Authorization
	9,  // 82: sa.StorageAuthority.CountPendingAuthorizations2:output_type -> sa.Count
	31, // 83: sa.StorageAuthority.GetValidOrderAuthorizations2:output_type -> sa.Authorizations
	9,  // 84: sa.StorageAuthority.CountInvalidAuthorizations2:output_type -> sa.Count
	31, // 85: sa.StorageAuthority.GetValidAuthorizations2:output_type -> sa.Authorizations
	19, // 86: sa.StorageAuthority.KeyBlocked:output_type -> sa.Exists
	43, // 87: sa.StorageAuthority.SerialsForIncident:output_type -> sa.IncidentSerial
	57, // 88: sa.StorageAuthority.GetRevokedCerts:output_type -> core.CRLEntry
	49, // 89: sa.StorageAuthority.GetMaxExpiration:output_type -> google.protobuf.Timestamp
	41, // 90: sa.StorageAuthority.IncidentsForSerial:output_type -> sa.Incidents
	54, // 91: sa.StorageAuthority.NewRegistration:output_type -> core.Registration
	53, // 92: sa.StorageAuthority.UpdateRegistration:output_type -> google.protobuf.Empty
	22, // 93: sa.StorageAuthority.AddCertificate:output_type -> sa.AddCertificateResponse
	53, // 94: sa.StorageAuthority.AddPrecertificate:output_type -> google.protobuf.Empty
	53, // 95: sa.StorageAuthority.AddSerial:output_type -> google.protobuf.Empty
	53, // 96: sa.StorageAuthority.DeactivateRegistration:output_type -> google.protobuf.Empty
	58, // 97: sa.StorageAuthority.NewOrder:output_type -> core.Order
	58, // 98: sa.StorageAuthority.NewOrderAndAuthzs:output_type -> core.Order
	53, // 99: sa.StorageAuthority.SetOrderProcessing:output_type -> google.protobuf.Empty
	53, // 100: sa.StorageAuthority.SetOrderError:output_type -> google.protobuf.Empty
	53, // 101: sa.StorageAuthority.FinalizeOrder:output_type -> google.protobuf.Empty
	58, // 102: sa.StorageAuthority.GetOrder:output_type -> core.Order
	58, // 103: sa.StorageAuthority.GetOrderForNames:output_type -> core.Order
	53, // 104: sa.StorageAuthority.RevokeCertificate:output_type -> google.protobuf.Empty
	53, // 105: sa.StorageAuthority.UpdateRevokedCertificate:output_type -> google.protobuf.Empty
	35, // 106: sa.StorageAuthority.NewAuthorizations2:output_type -> sa.Authorization2IDs
	53, // 107: sa.StorageAuthority.FinalizeAuthorization2:output_type -> google.protobuf.Empty
	53, // 108: sa.StorageAuthority.DeactivateAuthorization2:output_type -> google.protobuf.Empty
	53, // 109: sa.StorageAuthority.AddBlockedKey:output_type -> google.protobuf.Empty
