...
var file_sa_proto_rawDesc = []byte{
	...
	0x03, 0x22, 0x87, 0x02, 0x0a, 0x0f, 0x4e, 0x65, 0x77, 0x41, 0x75, 0x74, 0x68, 0x7a, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x2e, 0x0a, 0x0a, 0x69, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x66,
	0x69, 0x65, 0x72, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x73, 0x61, 0x2e, 0x49,
	...
	0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x61, 0x63, 0x63, 0x74, 0x49, 0x44, 0x22, 0x47, 0x0a,
	...
	0x05, 0x6e, 0x61, 0x6d, 0x65, 0x73, 0x22, 0x54, 0x0a, 0x14, 0x46, 0x69, 0x6e, 0x61, 0x6c, 0x69,
	...
	0x66, 0x69, 0x63, 0x61, 0x74, 0x65, 0x53, 0x65, 0x72, 0x69, 0x61, 0x6c, 0x22, 0x9e, 0x01, 0x0a,
	...
	,
...
var file_sa_proto_depIdxs = []int32{
	...
	22,  // 21: sa.NewOrderAndAuthzsRequest.newOrder:type_name -> sa.NewOrderRequest
	23,  // 22: sa.NewOrderAndAuthzsRequest.newAuthzs:type_name -> sa.NewAuthzRequest
	55,  // 23: sa.SetOrderErrorRequest.error:type_name -> core.ProblemDetails
	53,  // 24: sa.GetAuthorizationsRequest.validUntil:type_name -> google.protobuf.Timestamp
	52,  // 25: sa.Authorizations.authz:type_name -> sa.Authorizations.MapElement
	...
	37,  // 34: sa.Incidents.incidents:type_name -> sa.Incident
	53,  // 35: sa.IncidentSerial.lastNoticeSent:type_name -> google.protobuf.Timestamp
	53,  // 36: sa.GetRevokedCertsRequest.expiresAfter:type_name -> google.protobuf.Timestamp
	53,  // 37: sa.GetRevokedCertsRequest.expiresBefore:type_name -> google.protobuf.Timestamp
	53,  // 38: sa.GetRevokedCertsRequest.revokedBefore:type_name -> google.protobuf.Timestamp
	53,  // 39: sa.RevocationStatus.revokedDate:type_name -> google.protobuf.Timestamp
	53,  // 40: sa.LeaseCRLShardRequest.until:type_name -> google.protobuf.Timestamp
	53,  // 41: sa.UpdateCRLShardRequest.thisUpdate:type_name -> google.protobuf.Timestamp
	53,  // 42: sa.UpdateCRLShardRequest.nextUpdate:type_name -> google.protobuf.Timestamp
	46,  // 43: sa.Identifiers.identifiers:type_name -> sa.Identifier
	46,  // 44: sa.PauseRequest.identifiers:type_name -> sa.Identifier
	57,  // 45: sa.ValidAuthorizations.MapElement.authz:type_name -> core.Authorization
	57,  // 46: sa.Authorizations.MapElement.authz:type_name -> core.Authorization
	11,  // 47: sa.StorageAuthorityReadOnly.CountCertificatesByNames:input_type -> sa.CountCertificatesByNamesRequest
	16,  // 48: sa.StorageAuthorityReadOnly.CountFQDNSets:input_type -> sa.CountFQDNSetsRequest
	14,  // 49: sa.StorageAuthorityReadOnly.CountInvalidAuthorizations2:input_type -> sa.CountInvalidAuthorizationsRequest
	15,  // 50: sa.StorageAuthorityReadOnly.CountOrders:input_type -> sa.CountOrdersRequest
	0,   // 51: sa.StorageAuthorityReadOnly.CountPendingAuthorizations2:input_type -> sa.RegistrationID
	13,  // 52: sa.StorageAuthorityReadOnly.CountRegistrationsByIP:input_type -> sa.CountRegistrationsByIPRequest
	13,  // 53: sa.StorageAuthorityReadOnly.CountRegistrationsByIPRange:input_type -> sa.CountRegistrationsByIPRequest
	17,  // 54: sa.StorageAuthorityReadOnly.FQDNSetExists:input_type -> sa.FQDNSetExistsRequest
	16,  // 55: sa.StorageAuthorityReadOnly.FQDNSetTimestampsForWindow:input_type -> sa.CountFQDNSetsRequest
	32,  // 56: sa.StorageAuthorityReadOnly.GetAuthorization2:input_type -> sa.AuthorizationID2
	29,  // 57: sa.StorageAuthorityReadOnly.GetAuthorizations2:input_type -> sa.GetAuthorizationsRequest
	6,   // 58: sa.StorageAuthorityReadOnly.GetCertificate:input_type -> sa.Serial
	6,   // 59: sa.StorageAuthorityReadOnly.GetLintPrecertificate:input_type -> sa.Serial
	6,   // 60: sa.StorageAuthorityReadOnly.GetCertificateStatus:input_type -> sa.Serial
	58,  // 61: sa.StorageAuthorityReadOnly.GetMaxExpiration:input_type -> google.protobuf.Empty
	21,  // 62: sa.StorageAuthorityReadOnly.GetOrder:input_type -> sa.OrderRequest
	27,  // 63: sa.StorageAuthorityReadOnly.GetOrderForNames:input_type -> sa.GetOrderForNamesRequest
	3,   // 64: sa.StorageAuthorityReadOnly.GetPendingAuthorization2:input_type -> sa.GetPendingAuthorizationRequest
	0,   // 65: sa.StorageAuthorityReadOnly.GetRegistration:input_type -> sa.RegistrationID
	1,   // 66: sa.StorageAuthorityReadOnly.GetRegistrationByKey:input_type -> sa.JSONWebKey
	6,   // 67: sa.StorageAuthorityReadOnly.GetRevocationStatus:input_type -> sa.Serial
	41,  // 68: sa.StorageAuthorityReadOnly.GetRevokedCerts:input_type -> sa.GetRevokedCertsRequest
	6,   // 69: sa.StorageAuthorityReadOnly.GetSerialMetadata:input_type -> sa.Serial
	0,   // 70: sa.StorageAuthorityReadOnly.GetSerialsByAccount:input_type -> sa.RegistrationID
	36,  // 71: sa.StorageAuthorityReadOnly.GetSerialsByKey:input_type -> sa.SPKIHash
	4,   // 72: sa.StorageAuthorityReadOnly.GetValidAuthorizations2:input_type -> sa.GetValidAuthorizationsRequest
	26,  // 73: sa.StorageAuthorityReadOnly.GetValidOrderAuthorizations2:input_type -> sa.GetValidOrderAuthorizationsRequest
	6,   // 74: sa.StorageAuthorityReadOnly.IncidentsForSerial:input_type -> sa.Serial
	36,  // 75: sa.StorageAuthorityReadOnly.KeyBlocked:input_type -> sa.SPKIHash
	6,   // 76: sa.StorageAuthorityReadOnly.ReplacementOrderExists:input_type -> sa.Serial
	39,  // 77: sa.StorageAuthorityReadOnly.SerialsForIncident:input_type -> sa.SerialsForIncidentRequest
	48,  // 78: sa.StorageAuthorityReadOnly.CheckIdentifiersPaused:input_type -> sa.PauseRequest
	0,   // 79: sa.StorageAuthorityReadOnly.GetPausedIdentifiers:input_type -> sa.RegistrationID
	11,  // 80: sa.StorageAuthority.CountCertificatesByNames:input_type -> sa.CountCertificatesByNamesRequest
	16,  // 81: sa.StorageAuthority.CountFQDNSets:input_type -> sa.CountFQDNSetsRequest
	14,  // 82: sa.StorageAuthority.CountInvalidAuthorizations2:input_type -> sa.CountInvalidAuthorizationsRequest
	15,  // 83: sa.StorageAuthority.CountOrders:input_type -> sa.CountOrdersRequest
	0,   // 84: sa.StorageAuthority.CountPendingAuthorizations2:input_type -> sa.RegistrationID
	13,  // 85: sa.StorageAuthority.CountRegistrationsByIP:input_type -> sa.CountRegistrationsByIPRequest
	13,  // 86: sa.StorageAuthority.CountRegistrationsByIPRange:input_type -> sa.CountRegistrationsByIPRequest
	17,  // 87: sa.StorageAuthority.FQDNSetExists:input_type -> sa.FQDNSetExistsRequest
	16,  // 88: sa.StorageAuthority.FQDNSetTimestampsForWindow:input_type -> sa.CountFQDNSetsRequest
	32,  // 89: sa.StorageAuthority.GetAuthorization2:input_type -> sa.AuthorizationID2
	29,  // 90: sa.StorageAuthority.GetAuthorizations2:input_type -> sa.GetAuthorizationsRequest
	6,   // 91: sa.StorageAuthority.GetCertificate:input_type -> sa.Serial
	6,   // 92: sa.StorageAuthority.GetLintPrecertificate:input_type -> sa.Serial
	6,   // 93: sa.StorageAuthority.GetCertificateStatus:input_type -> sa.Serial
	58,  // 94: sa.StorageAuthority.GetMaxExpiration:input_type -> google.protobuf.Empty
	21,  // 95: sa.StorageAuthority.GetOrder:input_type -> sa.OrderRequest
	27,  // 96: sa.StorageAuthority.GetOrderForNames:input_type -> sa.GetOrderForNamesRequest
	3,   // 97: sa.StorageAuthority.GetPendingAuthorization2:input_type -> sa.GetPendingAuthorizationRequest
	0,   // 98: sa.StorageAuthority.GetRegistration:input_type -> sa.RegistrationID
	1,   // 99: sa.StorageAuthority.GetRegistrationByKey:input_type -> sa.JSONWebKey
	6,   // 100: sa.StorageAuthority.GetRevocationStatus:input_type -> sa.Serial
	41,  // 101: sa.StorageAuthority.GetRevokedCerts:input_type -> sa.GetRevokedCertsRequest
	6,   // 102: sa.StorageAuthority.GetSerialMetadata:input_type -> sa.Serial
	0,   // 103: sa.StorageAuthority.GetSerialsByAccount:input_type -> sa.RegistrationID
	36,  // 104: sa.StorageAuthority.GetSerialsByKey:input_type -> sa.SPKIHash
	4,   // 105: sa.StorageAuthority.GetValidAuthorizations2:input_type -> sa.GetValidAuthorizationsRequest
	26,  // 106: sa.StorageAuthority.GetValidOrderAuthorizations2:input_type -> sa.GetValidOrderAuthorizationsRequest
	6,   // 107: sa.StorageAuthority.IncidentsForSerial:input_type -> sa.Serial
	36,  // 108: sa.StorageAuthority.KeyBlocked:input_type -> sa.SPKIHash
	6,   // 109: sa.StorageAuthority.ReplacementOrderExists:input_type -> sa.Serial
	39,  // 110: sa.StorageAuthority.SerialsForIncident:input_type -> sa.SerialsForIncidentRequest
	48,  // 111: sa.StorageAuthority.CheckIdentifiersPaused:input_type -> sa.PauseRequest
	0,   // 112: sa.StorageAuthority.GetPausedIdentifiers:input_type -> sa.RegistrationID
	35,  // 113: sa.StorageAuthority.AddBlockedKey:input_type -> sa.AddBlockedKeyRequest
	20,  // 114: sa.StorageAuthority.AddCertificate:input_type -> sa.AddCertificateRequest
	20,  // 115: sa.StorageAuthority.AddPrecertificate:input_type -> sa.AddCertificateRequest
	6,   // 116: sa.StorageAuthority.SetCertificateStatusReady:input_type -> sa.Serial
	19,  // 117: sa.StorageAuthority.AddSerial:input_type -> sa.AddSerialRequest
	32,  // 118: sa.StorageAuthority.DeactivateAuthorization2:input_type -> sa.AuthorizationID2
	0,   // 119: sa.StorageAuthority.DeactivateRegistration:input_type -> sa.RegistrationID
	34,  // 120: sa.StorageAuthority.FinalizeAuthorization2:input_type -> sa.FinalizeAuthorizationRequest
	28,  // 121: sa.StorageAuthority.FinalizeOrder:input_type -> sa.FinalizeOrderRequest
	24,  // 122: sa.StorageAuthority.NewOrderAndAuthzs:input_type -> sa.NewOrderAndAuthzsRequest
	59,  // 123: sa.StorageAuthority.NewRegistration:input_type -> core.Registration
	33,  // 124: sa.StorageAuthority.RevokeCertificate:input_type -> sa.RevokeCertificateRequest
	25,  // 125: sa.StorageAuthority.SetOrderError:input_type -> sa.SetOrderErrorRequest
	21,  // 126: sa.StorageAuthority.SetOrderProcessing:input_type -> sa.OrderRequest
	59,  // 127: sa.StorageAuthority.UpdateRegistration:input_type -> core.Registration
	33,  // 128: sa.StorageAuthority.UpdateRevokedCertificate:input_type -> sa.RevokeCertificateRequest
	43,  // 129: sa.StorageAuthority.LeaseCRLShard:input_type -> sa.LeaseCRLShardRequest
	45,  // 130: sa.StorageAuthority.UpdateCRLShard:input_type -> sa.UpdateCRLShardRequest
	48,  // 131: sa.StorageAuthority.PauseIdentifiers:input_type -> sa.PauseRequest
	0,   // 132: sa.StorageAuthority.UnpauseAccount:input_type -> sa.RegistrationID
	12,  // 133: sa.StorageAuthorityReadOnly.CountCertificatesByNames:output_type -> sa.CountByNames
	9,   // 134: sa.StorageAuthorityReadOnly.CountFQDNSets:output_type -> sa.Count
	9,   // 135: sa.StorageAuthorityReadOnly.CountInvalidAuthorizations2:output_type -> sa.Count
	9,   // 136: sa.StorageAuthorityReadOnly.CountOrders:output_type -> sa.Count
	9,   // 137: sa.StorageAuthorityReadOnly.CountPendingAuthorizations2:output_type -> sa.Count
	9,   // 138: sa.StorageAuthorityReadOnly.CountRegistrationsByIP:output_type -> sa.Count
	9,   // 139: sa.StorageAuthorityReadOnly.CountRegistrationsByIPRange:output_type -> sa.Count
	18,  // 140: sa.StorageAuthorityReadOnly.FQDNSetExists:output_type -> sa.Exists
	10,  // 141: sa.StorageAuthorityReadOnly.FQDNSetTimestampsForWindow:output_type -> sa.Timestamps
	57,  // 142: sa.StorageAuthorityReadOnly.GetAuthorization2:output_type -> core.Authorization
	30,  // 143: sa.StorageAuthorityReadOnly.GetAuthorizations2:output_type -> sa.Authorizations
	60,  // 144: sa.StorageAuthorityReadOnly.GetCertificate:output_type -> core.Certificate
	60,  // 145: sa.StorageAuthorityReadOnly.GetLintPrecertificate:output_type -> core.Certificate
	61,  // 146: sa.StorageAuthorityReadOnly.GetCertificateStatus:output_type -> core.CertificateStatus
	53,  // 147: sa.StorageAuthorityReadOnly.GetMaxExpiration:output_type -> google.protobuf.Timestamp
	62,  // 148: sa.StorageAuthorityReadOnly.GetOrder:output_type -> core.Order
	62,  // 149: sa.StorageAuthorityReadOnly.GetOrderForNames:output_type -> core.Order
	57,  // 150: sa.StorageAuthorityReadOnly.GetPendingAuthorization2:output_type -> core.Authorization
	59,  // 151: sa.StorageAuthorityReadOnly.GetRegistration:output_type -> core.Registration
	59,  // 152: sa.StorageAuthorityReadOnly.GetRegistrationByKey:output_type -> core.Registration
	42,  // 153: sa.StorageAuthorityReadOnly.GetRevocationStatus:output_type -> sa.RevocationStatus
	63,  // 154: sa.StorageAuthorityReadOnly.GetRevokedCerts:output_type -> core.CRLEntry
	7,   // 155: sa.StorageAuthorityReadOnly.GetSerialMetadata:output_type -> sa.SerialMetadata
	6,   // 156: sa.StorageAuthorityReadOnly.GetSerialsByAccount:output_type -> sa.Serial
	6,   // 157: sa.StorageAuthorityReadOnly.GetSerialsByKey:output_type -> sa.Serial
	30,  // 158: sa.StorageAuthorityReadOnly.GetValidAuthorizations2:output_type -> sa.Authorizations
	30,  // 159: sa.StorageAuthorityReadOnly.GetValidOrderAuthorizations2:output_type -> sa.Authorizations
	38,  // 160: sa.StorageAuthorityReadOnly.IncidentsForSerial:output_type -> sa.Incidents
	18,  // 161: sa.StorageAuthorityReadOnly.KeyBlocked:output_type -> sa.Exists
	18,  // 162: sa.StorageAuthorityReadOnly.ReplacementOrderExists:output_type -> sa.Exists
	40,  // 163: sa.StorageAuthorityReadOnly.SerialsForIncident:output_type -> sa.IncidentSerial
	47,  // 164: sa.StorageAuthorityReadOnly.CheckIdentifiersPaused:output_type -> sa.Identifiers
	47,  // 165: sa.StorageAuthorityReadOnly.GetPausedIdentifiers:output_type -> sa.Identifiers
	12,  // 166: sa.StorageAuthority.CountCertificatesByNames:output_type -> sa.CountByNames
	9,   // 167: sa.StorageAuthority.CountFQDNSets:output_type -> sa.Count
	9,   // 168: sa.StorageAuthority.CountInvalidAuthorizations2:output_type -> sa.Count
	9,   // 169: sa.StorageAuthority.CountOrders:output_type -> sa.Count
	9,   // 170: sa.StorageAuthority.CountPendingAuthorizations2:output_type -> sa.Count
	9,   // 171: sa.StorageAuthority.CountRegistrationsByIP:output_type -> sa.Count
	9,   // 172: sa.StorageAuthority.CountRegistrationsByIPRange:output_type -> sa.Count
	18,  // 173: sa.StorageAuthority.FQDNSetExists:output_type -> sa.Exists
	10,  // 174: sa.StorageAuthority.FQDNSetTimestampsForWindow:output_type -> sa.Timestamps
	57,  // 175: sa.StorageAuthority.GetAuthorization2:output_type -> core.Authorization
	30,  // 176: sa.StorageAuthority.GetAuthorizations2:output_type -> sa.Authorizations
	60,  // 177: sa.StorageAuthority.GetCertificate:output_type -> core.Certificate
	60,  // 178: sa.StorageAuthority.GetLintPrecertificate:output_type -> core.Certificate
	61,  // 179: sa.StorageAuthority.GetCertificateStatus:output_type -> core.CertificateStatus
	53,  // 180: sa.StorageAuthority.GetMaxExpiration:output_type -> google.protobuf.Timestamp
	62,  // 181: sa.StorageAuthority.GetOrder:output_type -> core.Order
	62,  // 182: sa.StorageAuthority.GetOrderForNames:output_type -> core.Order
	57,  // 183: sa.StorageAuthority.GetPendingAuthorization2:output_type -> core.Authorization
	59,  // 184: sa.StorageAuthority.GetRegistration:output_type -> core.Registration
	59,  // 185: sa.StorageAuthority.GetRegistrationByKey:output_type -> core.Registration
	42,  // 186: sa.StorageAuthority.GetRevocationStatus:output_type -> sa.RevocationStatus
	63,  // 187: sa.StorageAuthority.GetRevokedCerts:output_type -> core.CRLEntry
	7,   // 188: sa.StorageAuthority.GetSerialMetadata:output_type -> sa.SerialMetadata
	6,   // 189: sa.StorageAuthority.GetSerialsByAccount:output_type -> sa.Serial
	6,   // 190: sa.StorageAuthority.GetSerialsByKey:output_type -> sa.Serial
	30,  // 191: sa.StorageAuthority.GetValidAuthorizations2:output_type -> sa.Authorizations
	30,  // 192: sa.StorageAuthority.GetValidOrderAuthorizations2:output_type -> sa.Authorizations
	38,  // 193: sa.StorageAuthority.IncidentsForSerial:output_type -> sa.Incidents
	18,  // 194: sa.StorageAuthority.KeyBlocked:output_type -> sa.Exists
	18,  // 195: sa.StorageAuthority.ReplacementOrderExists:output_type -> sa.Exists
	40,  // 196: sa.StorageAuthority.SerialsForIncident:output_type -> sa.IncidentSerial
	47,  // 197: sa.StorageAuthority.CheckIdentifiersPaused:output_type -> sa.Identifiers
	47,  // 198: sa.StorageAuthority.GetPausedIdentifiers:output_type -> sa.Identifiers
	58,  // 199: sa.StorageAuthority.AddBlockedKey:output_type -> google.protobuf.Empty
	58,  // 200: sa.StorageAuthority.AddCertificate:output_type -> google.protobuf.Empty
	58,  // 201: sa.StorageAuthority.AddPrecertificate:output_type -> google.protobuf.Empty
	58,  // 202: sa.StorageAuthority.SetCertificateStatusReady:output_type -> google.protobuf.Empty
	58,  // 203: sa.StorageAuthority.AddSerial:output_type -> google.protobuf.Empty
	58,  // 204: sa.StorageAuthority.DeactivateAuthorization2:output_type -> google.protobuf.Empty
	58,  // 205: sa.StorageAuthority.DeactivateRegistration:output_type -> google.protobuf.Empty
	58,  // 206: sa.StorageAuthority.FinalizeAuthorization2:output_type -> google.protobuf.Empty
	58,  // 207: sa.StorageAuthority.FinalizeOrder:output_type -> google.protobuf.Empty
	62,  // 208: sa.StorageAuthority.NewOrderAndAuthzs:output_type -> core.Order
	59,  // 209: sa.StorageAuthority.NewRegistration:output_type -> core.Registration
	58,  // 210: sa.StorageAuthority.RevokeCertificate:output_type -> google.protobuf.Empty
	58,  // 211: sa.StorageAuthority.SetOrderError:output_type -> google.protobuf.Empty
	58,  // 212: sa.StorageAuthority.SetOrderProcessing:output_type -> google.protobuf.Empty
	58,  // 213: sa.StorageAuthority.UpdateRegistration:output_type -> google.protobuf.Empty
	58,  // 214: sa.StorageAuthority.UpdateRevokedCertificate:output_type -> google.protobuf.Empty
	44,  // 215: sa.StorageAuthority.LeaseCRLShard:output_type -> sa.LeaseCRLShardResponse
	58,  // 216: sa.StorageAuthority.UpdateCRLShard:output_type -> google.protobuf.Empty
	49,  // 217: sa.StorageAuthority.PauseIdentifiers:output_type -> sa.PauseIdentifiersResponse
	9,   // 218: sa.StorageAuthority.UnpauseAccount:output_type -> sa.Count
	133, // [133:219] is the sub-list for method output_type
	47,  // [47:133] is the sub-list for method input_type
