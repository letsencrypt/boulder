...
var file_sa_proto_rawDesc = []byte{
	...
	0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x22, 0xb7, 0x01, 0x0a, 0x0f,
	...
	0x32, 0x41, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x69, 0x7a, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x4a,
	...
	0x74, 0x65, 0x32, 0xb6, 0x0f, 0x0a, 0x18, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x41, 0x75,
	...
	0x74, 0x53, 0x65, 0x72, 0x69, 0x61, 0x6c, 0x22, 0x00, 0x30, 0x01, 0x32, 0xad, 0x19, 0x0a, 0x10,
...
var file_sa_proto_depIdxs = []int32{
	...
	39,  // 71: sa.StorageAuthorityReadOnly.SerialsForIncident:input_type -> sa.SerialsForIncidentRequest
	11,  // 72: sa.StorageAuthority.CountCertificatesByNames:input_type -> sa.CountCertificatesByNamesRequest
	16,  // 73: sa.StorageAuthority.CountFQDNSets:input_type -> sa.CountFQDNSetsRequest
	14,  // 74: sa.StorageAuthority.CountInvalidAuthorizations2:input_type -> sa.CountInvalidAuthorizationsRequest
	15,  // 75: sa.StorageAuthority.CountOrders:input_type -> sa.CountOrdersRequest
	0,   // 76: sa.StorageAuthority.CountPendingAuthorizations2:input_type -> sa.RegistrationID
	13,  // 77: sa.StorageAuthority.CountRegistrationsByIP:input_type -> sa.CountRegistrationsByIPRequest
	13,  // 78: sa.StorageAuthority.CountRegistrationsByIPRange:input_type -> sa.CountRegistrationsByIPRequest
	17,  // 79: sa.StorageAuthority.FQDNSetExists:input_type -> sa.FQDNSetExistsRequest
	16,  // 80: sa.StorageAuthority.FQDNSetTimestampsForWindow:input_type -> sa.CountFQDNSetsRequest
	32,  // 81: sa.StorageAuthority.GetAuthorization2:input_type -> sa.AuthorizationID2
	29,  // 82: sa.StorageAuthority.GetAuthorizations2:input_type -> sa.GetAuthorizationsRequest
	6,   // 83: sa.StorageAuthority.GetCertificate:input_type -> sa.Serial
	6,   // 84: sa.StorageAuthority.GetLintPrecertificate:input_type -> sa.Serial
	6,   // 85: sa.StorageAuthority.GetCertificateStatus:input_type -> sa.Serial
	54,  // 86: sa.StorageAuthority.GetMaxExpiration:input_type -> google.protobuf.Empty
	22,  // 87: sa.StorageAuthority.GetOrder:input_type -> sa.OrderRequest
	27,  // 88: sa.StorageAuthority.GetOrderForNames:input_type -> sa.GetOrderForNamesRequest
	3,   // 89: sa.StorageAuthority.GetPendingAuthorization2:input_type -> sa.GetPendingAuthorizationRequest
	0,   // 90: sa.StorageAuthority.GetRegistration:input_type -> sa.RegistrationID
	1,   // 91: sa.StorageAuthority.GetRegistrationByKey:input_type -> sa.JSONWebKey
	6,   // 92: sa.StorageAuthority.GetRevocationStatus:input_type -> sa.Serial
	41,  // 93: sa.StorageAuthority.GetRevokedCerts:input_type -> sa.GetRevokedCertsRequest
	6,   // 94: sa.StorageAuthority.GetSerialMetadata:input_type -> sa.Serial
	4,   // 95: sa.StorageAuthority.GetValidAuthorizations2:input_type -> sa.GetValidAuthorizationsRequest
	26,  // 96: sa.StorageAuthority.GetValidOrderAuthorizations2:input_type -> sa.GetValidOrderAuthorizationsRequest
	6,   // 97: sa.StorageAuthority.IncidentsForSerial:input_type -> sa.Serial
	36,  // 98: sa.StorageAuthority.KeyBlocked:input_type -> sa.KeyBlockedRequest
	18,  // 99: sa.StorageAuthority.PreviousCertificateExists:input_type -> sa.PreviousCertificateExistsRequest
	39,  // 100: sa.StorageAuthority.SerialsForIncident:input_type -> sa.SerialsForIncidentRequest
	35,  // 101: sa.StorageAuthority.AddBlockedKey:input_type -> sa.AddBlockedKeyRequest
	21,  // 102: sa.StorageAuthority.AddCertificate:input_type -> sa.AddCertificateRequest
	21,  // 103: sa.StorageAuthority.AddPrecertificate:input_type -> sa.AddCertificateRequest
	6,   // 104: sa.StorageAuthority.SetCertificateStatusReady:input_type -> sa.Serial
	20,  // 105: sa.StorageAuthority.AddSerial:input_type -> sa.AddSerialRequest
	32,  // 106: sa.StorageAuthority.DeactivateAuthorization2:input_type -> sa.AuthorizationID2
	0,   // 107: sa.StorageAuthority.DeactivateRegistration:input_type -> sa.RegistrationID
	34,  // 108: sa.StorageAuthority.FinalizeAuthorization2:input_type -> sa.FinalizeAuthorizationRequest
	28,  // 109: sa.StorageAuthority.FinalizeOrder:input_type -> sa.FinalizeOrderRequest
	24,  // 110: sa.StorageAuthority.NewOrderAndAuthzs:input_type -> sa.NewOrderAndAuthzsRequest
	55,  // 111: sa.StorageAuthority.NewRegistration:input_type -> core.Registration
	33,  // 112: sa.StorageAuthority.RevokeCertificate:input_type -> sa.RevokeCertificateRequest
	25,  // 113: sa.StorageAuthority.SetOrderError:input_type -> sa.SetOrderErrorRequest
	22,  // 114: sa.StorageAuthority.SetOrderProcessing:input_type -> sa.OrderRequest
	55,  // 115: sa.StorageAuthority.UpdateRegistration:input_type -> core.Registration
	33,  // 116: sa.StorageAuthority.UpdateRevokedCertificate:input_type -> sa.RevokeCertificateRequest
	43,  // 117: sa.StorageAuthority.LeaseCRLShard:input_type -> sa.LeaseCRLShardRequest
	45,  // 118: sa.StorageAuthority.UpdateCRLShard:input_type -> sa.UpdateCRLShardRequest
	12,  // 119: sa.StorageAuthorityReadOnly.CountCertificatesByNames:output_type -> sa.CountByNames
	9,   // 120: sa.StorageAuthorityReadOnly.CountFQDNSets:output_type -> sa.Count
	9,   // 121: sa.StorageAuthorityReadOnly.CountInvalidAuthorizations2:output_type -> sa.Count
	9,   // 122: sa.StorageAuthorityReadOnly.CountOrders:output_type -> sa.Count
	9,   // 123: sa.StorageAuthorityReadOnly.CountPendingAuthorizations2:output_type -> sa.Count
	9,   // 124: sa.StorageAuthorityReadOnly.CountRegistrationsByIP:output_type -> sa.Count
	9,   // 125: sa.StorageAuthorityReadOnly.CountRegistrationsByIPRange:output_type -> sa.Count
	19,  // 126: sa.StorageAuthorityReadOnly.FQDNSetExists:output_type -> sa.Exists
	10,  // 127: sa.StorageAuthorityReadOnly.FQDNSetTimestampsForWindow:output_type -> sa.Timestamps
	51,  // 128: sa.StorageAuthorityReadOnly.GetAuthorization2:output_type -> core.Authorization
	30,  // 129: sa.StorageAuthorityReadOnly.GetAuthorizations2:output_type -> sa.Authorizations
	56,  // 130: sa.StorageAuthorityReadOnly.GetCertificate:output_type -> core.Certificate
	56,  // 131: sa.StorageAuthorityReadOnly.GetLintPrecertificate:output_type -> core.Certificate
	57,  // 132: sa.StorageAuthorityReadOnly.GetCertificateStatus:output_type -> core.CertificateStatus
	49,  // 133: sa.StorageAuthorityReadOnly.GetMaxExpiration:output_type -> google.protobuf.Timestamp
	58,  // 134: sa.StorageAuthorityReadOnly.GetOrder:output_type -> core.Order
	58,  // 135: sa.StorageAuthorityReadOnly.GetOrderForNames:output_type -> core.Order
	51,  // 136: sa.StorageAuthorityReadOnly.GetPendingAuthorization2:output_type -> core.Authorization
	55,  // 137: sa.StorageAuthorityReadOnly.GetRegistration:output_type -> core.Registration
	55,  // 138: sa.StorageAuthorityReadOnly.GetRegistrationByKey:output_type -> core.Registration
	42,  // 139: sa.StorageAuthorityReadOnly.GetRevocationStatus:output_type -> sa.RevocationStatus
	59,  // 140: sa.StorageAuthorityReadOnly.GetRevokedCerts:output_type -> core.CRLEntry
	7,   // 141: sa.StorageAuthorityReadOnly.GetSerialMetadata:output_type -> sa.SerialMetadata
	30,  // 142: sa.StorageAuthorityReadOnly.GetValidAuthorizations2:output_type -> sa.Authorizations
	30,  // 143: sa.StorageAuthorityReadOnly.GetValidOrderAuthorizations2:output_type -> sa.Authorizations
	38,  // 144: sa.StorageAuthorityReadOnly.IncidentsForSerial:output_type -> sa.Incidents
	19,  // 145: sa.StorageAuthorityReadOnly.KeyBlocked:output_type -> sa.Exists
	19,  // 146: sa.StorageAuthorityReadOnly.PreviousCertificateExists:output_type -> sa.Exists
	40,  // 147: sa.StorageAuthorityReadOnly.SerialsForIncident:output_type -> sa.IncidentSerial
	12,  // 148: sa.StorageAuthority.CountCertificatesByNames:output_type -> sa.CountByNames
	9,   // 149: sa.StorageAuthority.CountFQDNSets:output_type -> sa.Count
	9,   // 150: sa.StorageAuthority.CountInvalidAuthorizations2:output_type -> sa.Count
	9,   // 151: sa.StorageAuthority.CountOrders:output_type -> sa.Count
	9,   // 152: sa.StorageAuthority.CountPendingAuthorizations2:output_type -> sa.Count
	9,   // 153: sa.StorageAuthority.CountRegistrationsByIP:output_type -> sa.Count
	9,   // 154: sa.StorageAuthority.CountRegistrationsByIPRange:output_type -> sa.Count
	19,  // 155: sa.StorageAuthority.FQDNSetExists:output_type -> sa.Exists
	10,  // 156: sa.StorageAuthority.FQDNSetTimestampsForWindow:output_type -> sa.Timestamps
	51,  // 157: sa.StorageAuthority.GetAuthorization2:output_type -> core.Authorization
	30,  // 158: sa.StorageAuthority.GetAuthorizations2:output_type -> sa.Authorizations
	56,  // 159: sa.StorageAuthority.GetCertificate:output_type -> core.Certificate
	56,  // 160: sa.StorageAuthority.GetLintPrecertificate:output_type -> core.Certificate
	57,  // 161: sa.StorageAuthority.GetCertificateStatus:output_type -> core.CertificateStatus
	49,  // 162: sa.StorageAuthority.GetMaxExpiration:output_type -> google.protobuf.Timestamp
	58,  // 163: sa.StorageAuthority.GetOrder:output_type -> core.Order
	58,  // 164: sa.StorageAuthority.GetOrderForNames:output_type -> core.Order
	51,  // 165: sa.StorageAuthority.GetPendingAuthorization2:output_type -> core.Authorization
	55,  // 166: sa.StorageAuthority.GetRegistration:output_type -> core.Registration
	55,  // 167: sa.StorageAuthority.GetRegistrationByKey:output_type -> core.Registration
	42,  // 168: sa.StorageAuthority.GetRevocationStatus:output_type -> sa.RevocationStatus
	59,  // 169: sa.StorageAuthority.GetRevokedCerts:output_type -> core.CRLEntry
	7,   // 170: sa.StorageAuthority.GetSerialMetadata:output_type -> sa.SerialMetadata
	30,  // 171: sa.StorageAuthority.GetValidAuthorizations2:output_type -> sa.Authorizations
	30,  // 172: sa.StorageAuthority.GetValidOrderAuthorizations2:output_type -> sa.Authorizations
	38,  // 173: sa.StorageAuthority.IncidentsForSerial:output_type -> sa.Incidents
	19,  // 174: sa.StorageAuthority.KeyBlocked:output_type -> sa.Exists
	19,  // 175: sa.StorageAuthority.PreviousCertificateExists:output_type -> sa.Exists
	40,  // 176: sa.StorageAuthority.SerialsForIncident:output_type -> sa.IncidentSerial
	54,  // 177: sa.StorageAuthority.AddBlockedKey:output_type -> google.protobuf.Empty
	54,  // 178: sa.StorageAuthority.AddCertificate:output_type -> google.protobuf.Empty
	54,  // 179: sa.StorageAuthority.AddPrecertificate:output_type -> google.protobuf.Empty
	54,  // 180: sa.StorageAuthority.SetCertificateStatusReady:output_type -> google.protobuf.Empty
	54,  // 181: sa.StorageAuthority.AddSerial:output_type -> google.protobuf.Empty
	54,  // 182: sa.StorageAuthority.DeactivateAuthorization2:output_type -> google.protobuf.Empty
	54,  // 183: sa.StorageAuthority.DeactivateRegistration:output_type -> google.protobuf.Empty
	54,  // 184: sa.StorageAuthority.FinalizeAuthorization2:output_type -> google.protobuf.Empty
	54,  // 185: sa.StorageAuthority.FinalizeOrder:output_type -> google.protobuf.Empty
	58,  // 186: sa.StorageAuthority.NewOrderAndAuthzs:output_type -> core.Order
	55,  // 187: sa.StorageAuthority.NewRegistration:output_type -> core.Registration
	54,  // 188: sa.StorageAuthority.RevokeCertificate:output_type -> google.protobuf.Empty
	54,  // 189: sa.StorageAuthority.SetOrderError:output_type -> google.protobuf.Empty
	54,  // 190: sa.StorageAuthority.SetOrderProcessing:output_type -> google.protobuf.Empty
	54,  // 191: sa.StorageAuthority.UpdateRegistration:output_type -> google.protobuf.Empty
	54,  // 192: sa.StorageAuthority.UpdateRevokedCertificate:output_type -> google.protobuf.Empty
	44,  // 193: sa.StorageAuthority.LeaseCRLShard:output_type -> sa.LeaseCRLShardResponse
	54,  // 194: sa.StorageAuthority.UpdateCRLShard:output_type -> google.protobuf.Empty
	119, // [119:195] is the sub-list for method output_type
	43,  // [43:119] is the sub-list for method input_type
