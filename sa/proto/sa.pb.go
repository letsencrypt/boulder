...
var file_sa_proto_rawDesc = string([]byte{
	...
	0x01, 0x28, 0x03, 0x52, 0x05, 0x62, 0x75, 0x72, 0x73, 0x74, 0x22, 0x50, 0x0a, 0x1b, 0x41, 0x64,
	...
	0x64, 0x65, 0x52, 0x08, 0x6f, 0x76, 0x65, 0x72, 0x72, 0x69, 0x64, 0x65, 0x22, 0x54, 0x0a, 0x1c,
	...
	0x65, 0x64, 0x22, 0x5c, 0x0a, 0x1e, 0x45, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x52, 0x61, 0x74, 0x65,
	...
	0x22, 0x5d, 0x0a, 0x1f, 0x44, 0x69, 0x73, 0x61, 0x62, 0x6c, 0x65, 0x52, 0x61, 0x74, 0x65, 0x4c,
	...
	0x59, 0x0a, 0x1b, 0x47, 0x65, 0x74, 0x52, 0x61, 0x74, 0x65, 0x4c, 0x69, 0x6d, 0x69, 0x74, 0x4f,
	...
	0x09, 0x62, 0x75, 0x63, 0x6b, 0x65, 0x74, 0x4b, 0x65, 0x79, 0x22, 0xa2, 0x01, 0x0a, 0x19, 0x52,
	0x61, 0x74, 0x65, 0x4c, 0x69, 0x6d, 0x69, 0x74, 0x4f, 0x76, 0x65, 0x72, 0x72, 0x69, 0x64, 0x65,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x31, 0x0a, 0x08, 0x6f, 0x76, 0x65, 0x72,
	...
	0x65, 0x52, 0x08, 0x6f, 0x76, 0x65, 0x72, 0x72, 0x69, 0x64, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x65,
	0x6e, 0x61, 0x62, 0x6c, 0x65, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x08, 0x52, 0x07, 0x65, 0x6e,
	0x61, 0x62, 0x6c, 0x65, 0x64, 0x12, 0x38, 0x0a, 0x09, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64,
	...
	0xc2, 0x0e, 0x0a, 0x18, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x41, 0x75, 0x74, 0x68, 0x6f,
	...
	0x22, 0x00, 0x30, 0x01, 0x32, 0xcc, 0x1b, 0x0a, 0x10, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65,
...
var file_sa_proto_depIdxs = []int32{
	...
	4,   // 107: sa.StorageAuthority.SetCertificateStatusReady:input_type -> sa.Serial
	...
	24,  // 132: sa.StorageAuthorityReadOnly.GetAuthorizations2:output_type -> sa.Authorizations
	59,  // 133: sa.StorageAuthorityReadOnly.GetCertificate:output_type -> core.Certificate
	59,  // 134: sa.StorageAuthorityReadOnly.GetLintPrecertificate:output_type -> core.Certificate
	60,  // 135: sa.StorageAuthorityReadOnly.GetCertificateStatus:output_type -> core.CertificateStatus
	61,  // 136: sa.StorageAuthorityReadOnly.GetOrder:output_type -> core.Order
	61,  // 137: sa.StorageAuthorityReadOnly.GetOrderForNames:output_type -> core.Order
	58,  // 138: sa.StorageAuthorityReadOnly.GetRegistration:output_type -> core.Registration
	58,  // 139: sa.StorageAuthorityReadOnly.GetRegistrationByKey:output_type -> core.Registration
	36,  // 140: sa.StorageAuthorityReadOnly.GetRevocationStatus:output_type -> sa.RevocationStatus
	62,  // 141: sa.StorageAuthorityReadOnly.GetRevokedCertsByShard:output_type -> core.CRLEntry
	...
	24,  // 160: sa.StorageAuthority.GetAuthorizations2:output_type -> sa.Authorizations
	59,  // 161: sa.StorageAuthority.GetCertificate:output_type -> core.Certificate
	59,  // 162: sa.StorageAuthority.GetLintPrecertificate:output_type -> core.Certificate
	60,  // 163: sa.StorageAuthority.GetCertificateStatus:output_type -> core.CertificateStatus
	61,  // 164: sa.StorageAuthority.GetOrder:output_type -> core.Order
	61,  // 165: sa.StorageAuthority.GetOrderForNames:output_type -> core.Order
	58,  // 166: sa.StorageAuthority.GetRegistration:output_type -> core.Registration
	58,  // 167: sa.StorageAuthority.GetRegistrationByKey:output_type -> core.Registration
	36,  // 168: sa.StorageAuthority.GetRevocationStatus:output_type -> sa.RevocationStatus
	62,  // 169: sa.StorageAuthority.GetRevokedCertsByShard:output_type -> core.CRLEntry
	5,   // 170: sa.StorageAuthority.GetSerialMetadata:output_type -> sa.SerialMetadata
	4,   // 171: sa.StorageAuthority.GetSerialsByAccount:output_type -> sa.Serial
	4,   // 172: sa.StorageAuthority.GetSerialsByKey:output_type -> sa.Serial
	24,  // 173: sa.StorageAuthority.GetValidAuthorizations2:output_type -> sa.Authorizations
	24,  // 174: sa.StorageAuthority.GetValidOrderAuthorizations2:output_type -> sa.Authorizations
	...
	57,  // 186: sa.StorageAuthority.SetCertificateStatusReady:output_type -> google.protobuf.Empty
	57,  // 187: sa.StorageAuthority.AddSerial:output_type -> google.protobuf.Empty
	57,  // 188: sa.StorageAuthority.DeactivateAuthorization2:output_type -> google.protobuf.Empty
	58,  // 189: sa.StorageAuthority.DeactivateRegistration:output_type -> core.Registration
	57,  // 190: sa.StorageAuthority.FinalizeAuthorization2:output_type -> google.protobuf.Empty
	57,  // 191: sa.StorageAuthority.FinalizeOrder:output_type -> google.protobuf.Empty
	61,  // 192: sa.StorageAuthority.NewOrderAndAuthzs:output_type -> core.Order
	58,  // 193: sa.StorageAuthority.NewRegistration:output_type -> core.Registration
	57,  // 194: sa.StorageAuthority.RevokeCertificate:output_type -> google.protobuf.Empty
	57,  // 195: sa.StorageAuthority.SetOrderError:output_type -> google.protobuf.Empty
	57,  // 196: sa.StorageAuthority.SetOrderProcessing:output_type -> google.protobuf.Empty
	58,  // 197: sa.StorageAuthority.UpdateRegistrationKey:output_type -> core.Registration
	57,  // 198: sa.StorageAuthority.UpdateRevokedCertificate:output_type -> google.protobuf.Empty
	38,  // 199: sa.StorageAuthority.LeaseCRLShard:output_type -> sa.LeaseCRLShardResponse
	57,  // 200: sa.StorageAuthority.UpdateCRLShard:output_type -> google.protobuf.Empty
	42,  // 201: sa.StorageAuthority.PauseIdentifiers:output_type -> sa.PauseIdentifiersResponse
	7,   // 202: sa.StorageAuthority.UnpauseAccount:output_type -> sa.Count
	46,  // 203: sa.StorageAuthority.AddRateLimitOverride:output_type -> sa.AddRateLimitOverrideResponse
	57,  // 204: sa.StorageAuthority.DisableRateLimitOverride:output_type -> google.protobuf.Empty
	57,  // 205: sa.StorageAuthority.EnableRateLimitOverride:output_type -> google.protobuf.Empty
	127, // [127:206] is the sub-list for method output_type
	48,  // [48:127] is the sub-list for method input_type
