...
var file_sa_proto_rawDesc = []byte{
	...
	0x72, 0x69, 0x61, 0x6c, 0x22, 0x00, 0x30, 0x01, 0x32, 0xdb, 0x18, 0x0a, 0x10, 0x53, 0x74, 0x6f,
	...
	,
...
var file_sa_proto_depIdxs = []int32{
	...
	31, // 84: sa.StorageAuthority.NewAuthorizations2:input_type -> sa.AddPendingAuthorizationsRequest
	23, // 85: sa.StorageAuthority.NewOrder:input_type -> sa.NewOrderRequest
	24, // 86: sa.StorageAuthority.NewOrderAndAuthzs:input_type -> sa.NewOrderAndAuthzsRequest
	53, // 87: sa.StorageAuthority.NewRegistration:input_type -> core.Registration
	35, // 88: sa.StorageAuthority.RevokeCertificate:input_type -> sa.RevokeCertificateRequest
	25, // 89: sa.StorageAuthority.SetOrderError:input_type -> sa.SetOrderErrorRequest
	22, // 90: sa.StorageAuthority.SetOrderProcessing:input_type -> sa.OrderRequest
	53, // 91: sa.StorageAuthority.UpdateRegistration:input_type -> core.Registration
	35, // 92: sa.StorageAuthority.UpdateRevokedCertificate:input_type -> sa.RevokeCertificateRequest
	...
	49, // 102: sa.StorageAuthorityReadOnly.GetAuthorization2:output_type -> core.Authorization
	30, // 103: sa.StorageAuthorityReadOnly.GetAuthorizations2:output_type -> sa.Authorizations
	54, // 104: sa.StorageAuthorityReadOnly.GetCertificate:output_type -> core.Certificate
	55, // 105: sa.StorageAuthorityReadOnly.GetCertificateStatus:output_type -> core.CertificateStatus
	48, // 106: sa.StorageAuthorityReadOnly.GetMaxExpiration:output_type -> google.protobuf.Timestamp
	56, // 107: sa.StorageAuthorityReadOnly.GetOrder:output_type -> core.Order
	56, // 108: sa.StorageAuthorityReadOnly.GetOrderForNames:output_type -> core.Order
	49, // 109: sa.StorageAuthorityReadOnly.GetPendingAuthorization2:output_type -> core.Authorization
	54, // 110: sa.StorageAuthorityReadOnly.GetPrecertificate:output_type -> core.Certificate
	53, // 111: sa.StorageAuthorityReadOnly.GetRegistration:output_type -> core.Registration
	53, // 112: sa.StorageAuthorityReadOnly.GetRegistrationByKey:output_type -> core.Registration
	44, // 113: sa.StorageAuthorityReadOnly.GetRevocationStatus:output_type -> sa.RevocationStatus
	57, // 114: sa.StorageAuthorityReadOnly.GetRevokedCerts:output_type -> core.CRLEntry
	...
	40, // 118: sa.StorageAuthorityReadOnly.IncidentsForSerial:output_type -> sa.Incidents
	...
	42, // 121: sa.StorageAuthorityReadOnly.SerialsForIncident:output_type -> sa.IncidentSerial
	...
	49, // 131: sa.StorageAuthority.GetAuthorization2:output_type -> core.Authorization
	30, // 132: sa.StorageAuthority.GetAuthorizations2:output_type -> sa.Authorizations
	54, // 133: sa.StorageAuthority.GetCertificate:output_type -> core.Certificate
	55, // 134: sa.StorageAuthority.GetCertificateStatus:output_type -> core.CertificateStatus
	48, // 135: sa.StorageAuthority.GetMaxExpiration:output_type -> google.protobuf.Timestamp
	56, // 136: sa.StorageAuthority.GetOrder:output_type -> core.Order
	56, // 137: sa.StorageAuthority.GetOrderForNames:output_type -> core.Order
	49, // 138: sa.StorageAuthority.GetPendingAuthorization2:output_type -> core.Authorization
	54, // 139: sa.StorageAuthority.GetPrecertificate:output_type -> core.Certificate
	53, // 140: sa.StorageAuthority.GetRegistration:output_type -> core.Registration
	53, // 141: sa.StorageAuthority.GetRegistrationByKey:output_type -> core.Registration
	44, // 142: sa.StorageAuthority.GetRevocationStatus:output_type -> sa.RevocationStatus
	57, // 143: sa.StorageAuthority.GetRevokedCerts:output_type -> core.CRLEntry
	7,  // 144: sa.StorageAuthority.GetSerialMetadata:output_type -> sa.SerialMetadata
	30, // 145: sa.StorageAuthority.GetValidAuthorizations2:output_type -> sa.Authorizations
	30, // 146: sa.StorageAuthority.GetValidOrderAuthorizations2:output_type -> sa.Authorizations
	40, // 147: sa.StorageAuthority.IncidentsForSerial:output_type -> sa.Incidents
	...
	42, // 150: sa.StorageAuthority.SerialsForIncident:output_type -> sa.IncidentSerial
	52, // 151: sa.StorageAuthority.AddBlockedKey:output_type -> google.protobuf.Empty
	52, // 152: sa.StorageAuthority.AddCertificate:output_type -> google.protobuf.Empty
	52, // 153: sa.StorageAuthority.AddPrecertificate:output_type -> google.protobuf.Empty
	52, // 154: sa.StorageAuthority.AddSerial:output_type -> google.protobuf.Empty
	52, // 155: sa.StorageAuthority.DeactivateAuthorization2:output_type -> google.protobuf.Empty
	52, // 156: sa.StorageAuthority.DeactivateRegistration:output_type -> google.protobuf.Empty
	52, // 157: sa.StorageAuthority.FinalizeAuthorization2:output_type -> google.protobuf.Empty
	52, // 158: sa.StorageAuthority.FinalizeOrder:output_type -> google.protobuf.Empty
	34, // 159: sa.StorageAuthority.NewAuthorizations2:output_type -> sa.Authorization2IDs
	56, // 160: sa.StorageAuthority.NewOrder:output_type -> core.Order
	56, // 161: sa.StorageAuthority.NewOrderAndAuthzs:output_type -> core.Order
	53, // 162: sa.StorageAuthority.NewRegistration:output_type -> core.Registration
	52, // 163: sa.StorageAuthority.RevokeCertificate:output_type -> google.protobuf.Empty
	52, // 164: sa.StorageAuthority.SetOrderError:output_type -> google.protobuf.Empty
	52, // 165: sa.StorageAuthority.SetOrderProcessing:output_type -> google.protobuf.Empty
	52, // 166: sa.StorageAuthority.UpdateRegistration:output_type -> google.protobuf.Empty
	52, // 167: sa.StorageAuthority.UpdateRevokedCertificate:output_type -> google.protobuf.Empty
