...
var file_sa_proto_rawDesc = []byte{
	...
	0x52, 0x03, 0x6a, 0x77, 0x6b, 0x32, 0xc9, 0x0d, 0x0a, 0x18, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67,
	0x65, 0x41, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x69, 0x74, 0x79, 0x52, 0x65, 0x61, 0x64, 0x4f, 0x6e,
	0x6c, 0x79, 0x12, 0x51, 0x0a, 0x1b, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x49, 0x6e, 0x76, 0x61, 0x6c,
	...
	0x00, 0x32, 0xe3, 0x19, 0x0a, 0x10, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x41, 0x75, 0x74,
	0x68, 0x6f, 0x72, 0x69, 0x74, 0x79, 0x12, 0x51, 0x0a, 0x1b, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x49,
...
var file_sa_proto_depIdxs = []int32{
	...
	10,  // 40: sa.StorageAuthorityReadOnly.CountInvalidAuthorizations2:input_type -> sa.CountInvalidAuthorizationsRequest
	0,   // 41: sa.StorageAuthorityReadOnly.CountPendingAuthorizations2:input_type -> sa.RegistrationID
	12,  // 42: sa.StorageAuthorityReadOnly.FQDNSetExists:input_type -> sa.FQDNSetExistsRequest
	11,  // 43: sa.StorageAuthorityReadOnly.FQDNSetTimestampsForWindow:input_type -> sa.CountFQDNSetsRequest
	27,  // 44: sa.StorageAuthorityReadOnly.GetAuthorization2:input_type -> sa.AuthorizationID2
	24,  // 45: sa.StorageAuthorityReadOnly.GetAuthorizations2:input_type -> sa.GetAuthorizationsRequest
	...
	53,  // 49: sa.StorageAuthorityReadOnly.GetMaxExpiration:input_type -> google.protobuf.Empty
	16,  // 50: sa.StorageAuthorityReadOnly.GetOrder:input_type -> sa.OrderRequest
	22,  // 51: sa.StorageAuthorityReadOnly.GetOrderForNames:input_type -> sa.GetOrderForNamesRequest
	...
	4,   // 56: sa.StorageAuthorityReadOnly.GetSerialMetadata:input_type -> sa.Serial
	0,   // 57: sa.StorageAuthorityReadOnly.GetSerialsByAccount:input_type -> sa.RegistrationID
	31,  // 58: sa.StorageAuthorityReadOnly.GetSerialsByKey:input_type -> sa.SPKIHash
	3,   // 59: sa.StorageAuthorityReadOnly.GetValidAuthorizations2:input_type -> sa.GetValidAuthorizationsRequest
	21,  // 60: sa.StorageAuthorityReadOnly.GetValidOrderAuthorizations2:input_type -> sa.GetValidOrderAuthorizationsRequest
	4,   // 61: sa.StorageAuthorityReadOnly.IncidentsForSerial:input_type -> sa.Serial
	31,  // 62: sa.StorageAuthorityReadOnly.KeyBlocked:input_type -> sa.SPKIHash
	4,   // 63: sa.StorageAuthorityReadOnly.ReplacementOrderExists:input_type -> sa.Serial
	34,  // 64: sa.StorageAuthorityReadOnly.SerialsForIncident:input_type -> sa.SerialsForIncidentRequest
	42,  // 65: sa.StorageAuthorityReadOnly.CheckIdentifiersPaused:input_type -> sa.PauseRequest
	0,   // 66: sa.StorageAuthorityReadOnly.GetPausedIdentifiers:input_type -> sa.RegistrationID
	10,  // 67: sa.StorageAuthority.CountInvalidAuthorizations2:input_type -> sa.CountInvalidAuthorizationsRequest
	0,   // 68: sa.StorageAuthority.CountPendingAuthorizations2:input_type -> sa.RegistrationID
	12,  // 69: sa.StorageAuthority.FQDNSetExists:input_type -> sa.FQDNSetExistsRequest
	11,  // 70: sa.StorageAuthority.FQDNSetTimestampsForWindow:input_type -> sa.CountFQDNSetsRequest
	27,  // 71: sa.StorageAuthority.GetAuthorization2:input_type -> sa.AuthorizationID2
	24,  // 72: sa.StorageAuthority.GetAuthorizations2:input_type -> sa.GetAuthorizationsRequest
	4,   // 73: sa.StorageAuthority.GetCertificate:input_type -> sa.Serial
	4,   // 74: sa.StorageAuthority.GetLintPrecertificate:input_type -> sa.Serial
	4,   // 75: sa.StorageAuthority.GetCertificateStatus:input_type -> sa.Serial
	53,  // 76: sa.StorageAuthority.GetMaxExpiration:input_type -> google.protobuf.Empty
	16,  // 77: sa.StorageAuthority.GetOrder:input_type -> sa.OrderRequest
	22,  // 78: sa.StorageAuthority.GetOrderForNames:input_type -> sa.GetOrderForNamesRequest
	0,   // 79: sa.StorageAuthority.GetRegistration:input_type -> sa.RegistrationID
	1,   // 80: sa.StorageAuthority.GetRegistrationByKey:input_type -> sa.JSONWebKey
	4,   // 81: sa.StorageAuthority.GetRevocationStatus:input_type -> sa.Serial
	36,  // 82: sa.StorageAuthority.GetRevokedCerts:input_type -> sa.GetRevokedCertsRequest
	4,   // 83: sa.StorageAuthority.GetSerialMetadata:input_type -> sa.Serial
	0,   // 84: sa.StorageAuthority.GetSerialsByAccount:input_type -> sa.RegistrationID
	31,  // 85: sa.StorageAuthority.GetSerialsByKey:input_type -> sa.SPKIHash
	3,   // 86: sa.StorageAuthority.GetValidAuthorizations2:input_type -> sa.GetValidAuthorizationsRequest
	21,  // 87: sa.StorageAuthority.GetValidOrderAuthorizations2:input_type -> sa.GetValidOrderAuthorizationsRequest
	4,   // 88: sa.StorageAuthority.IncidentsForSerial:input_type -> sa.Serial
	31,  // 89: sa.StorageAuthority.KeyBlocked:input_type -> sa.SPKIHash
	4,   // 90: sa.StorageAuthority.ReplacementOrderExists:input_type -> sa.Serial
	34,  // 91: sa.StorageAuthority.SerialsForIncident:input_type -> sa.SerialsForIncidentRequest
	42,  // 92: sa.StorageAuthority.CheckIdentifiersPaused:input_type -> sa.PauseRequest
	0,   // 93: sa.StorageAuthority.GetPausedIdentifiers:input_type -> sa.RegistrationID
	30,  // 94: sa.StorageAuthority.AddBlockedKey:input_type -> sa.AddBlockedKeyRequest
	15,  // 95: sa.StorageAuthority.AddCertificate:input_type -> sa.AddCertificateRequest
	15,  // 96: sa.StorageAuthority.AddPrecertificate:input_type -> sa.AddCertificateRequest
	4,   // 97: sa.StorageAuthority.SetCertificateStatusReady:input_type -> sa.Serial
	14,  // 98: sa.StorageAuthority.AddSerial:input_type -> sa.AddSerialRequest
	27,  // 99: sa.StorageAuthority.DeactivateAuthorization2:input_type -> sa.AuthorizationID2
	0,   // 100: sa.StorageAuthority.DeactivateRegistration:input_type -> sa.RegistrationID
	29,  // 101: sa.StorageAuthority.FinalizeAuthorization2:input_type -> sa.FinalizeAuthorizationRequest
	23,  // 102: sa.StorageAuthority.FinalizeOrder:input_type -> sa.FinalizeOrderRequest
	19,  // 103: sa.StorageAuthority.NewOrderAndAuthzs:input_type -> sa.NewOrderAndAuthzsRequest
	54,  // 104: sa.StorageAuthority.NewRegistration:input_type -> core.Registration
	28,  // 105: sa.StorageAuthority.RevokeCertificate:input_type -> sa.RevokeCertificateRequest
	20,  // 106: sa.StorageAuthority.SetOrderError:input_type -> sa.SetOrderErrorRequest
	16,  // 107: sa.StorageAuthority.SetOrderProcessing:input_type -> sa.OrderRequest
	54,  // 108: sa.StorageAuthority.UpdateRegistration:input_type -> core.Registration
	44,  // 109: sa.StorageAuthority.UpdateRegistrationContact:input_type -> sa.UpdateRegistrationContactRequest
	45,  // 110: sa.StorageAuthority.UpdateRegistrationKey:input_type -> sa.UpdateRegistrationKeyRequest
	28,  // 111: sa.StorageAuthority.UpdateRevokedCertificate:input_type -> sa.RevokeCertificateRequest
	38,  // 112: sa.StorageAuthority.LeaseCRLShard:input_type -> sa.LeaseCRLShardRequest
	40,  // 113: sa.StorageAuthority.UpdateCRLShard:input_type -> sa.UpdateCRLShardRequest
	42,  // 114: sa.StorageAuthority.PauseIdentifiers:input_type -> sa.PauseRequest
	0,   // 115: sa.StorageAuthority.UnpauseAccount:input_type -> sa.RegistrationID
	7,   // 116: sa.StorageAuthorityReadOnly.CountInvalidAuthorizations2:output_type -> sa.Count
	7,   // 117: sa.StorageAuthorityReadOnly.CountPendingAuthorizations2:output_type -> sa.Count
	13,  // 118: sa.StorageAuthorityReadOnly.FQDNSetExists:output_type -> sa.Exists
	8,   // 119: sa.StorageAuthorityReadOnly.FQDNSetTimestampsForWindow:output_type -> sa.Timestamps
	51,  // 120: sa.StorageAuthorityReadOnly.GetAuthorization2:output_type -> core.Authorization
	25,  // 121: sa.StorageAuthorityReadOnly.GetAuthorizations2:output_type -> sa.Authorizations
	55,  // 122: sa.StorageAuthorityReadOnly.GetCertificate:output_type -> core.Certificate
	55,  // 123: sa.StorageAuthorityReadOnly.GetLintPrecertificate:output_type -> core.Certificate
	56,  // 124: sa.StorageAuthorityReadOnly.GetCertificateStatus:output_type -> core.CertificateStatus
	47,  // 125: sa.StorageAuthorityReadOnly.GetMaxExpiration:output_type -> google.protobuf.Timestamp
	57,  // 126: sa.StorageAuthorityReadOnly.GetOrder:output_type -> core.Order
	57,  // 127: sa.StorageAuthorityReadOnly.GetOrderForNames:output_type -> core.Order
	54,  // 128: sa.StorageAuthorityReadOnly.GetRegistration:output_type -> core.Registration
	54,  // 129: sa.StorageAuthorityReadOnly.GetRegistrationByKey:output_type -> core.Registration
	37,  // 130: sa.StorageAuthorityReadOnly.GetRevocationStatus:output_type -> sa.RevocationStatus
	58,  // 131: sa.StorageAuthorityReadOnly.GetRevokedCerts:output_type -> core.CRLEntry
	5,   // 132: sa.StorageAuthorityReadOnly.GetSerialMetadata:output_type -> sa.SerialMetadata
	4,   // 133: sa.StorageAuthorityReadOnly.GetSerialsByAccount:output_type -> sa.Serial
	4,   // 134: sa.StorageAuthorityReadOnly.GetSerialsByKey:output_type -> sa.Serial
	...
	33,  // 137: sa.StorageAuthorityReadOnly.IncidentsForSerial:output_type -> sa.Incidents
	13,  // 138: sa.StorageAuthorityReadOnly.KeyBlocked:output_type -> sa.Exists
	13,  // 139: sa.StorageAuthorityReadOnly.ReplacementOrderExists:output_type -> sa.Exists
	35,  // 140: sa.StorageAuthorityReadOnly.SerialsForIncident:output_type -> sa.IncidentSerial
	41,  // 141: sa.StorageAuthorityReadOnly.CheckIdentifiersPaused:output_type -> sa.Identifiers
	41,  // 142: sa.StorageAuthorityReadOnly.GetPausedIdentifiers:output_type -> sa.Identifiers
	7,   // 143: sa.StorageAuthority.CountInvalidAuthorizations2:output_type -> sa.Count
	7,   // 144: sa.StorageAuthority.CountPendingAuthorizations2:output_type -> sa.Count
	13,  // 145: sa.StorageAuthority.FQDNSetExists:output_type -> sa.Exists
	8,   // 146: sa.StorageAuthority.FQDNSetTimestampsForWindow:output_type -> sa.Timestamps
	51,  // 147: sa.StorageAuthority.GetAuthorization2:output_type -> core.Authorization
	25,  // 148: sa.StorageAuthority.GetAuthorizations2:output_type -> sa.Authorizations
	55,  // 149: sa.StorageAuthority.GetCertificate:output_type -> core.Certificate
	55,  // 150: sa.StorageAuthority.GetLintPrecertificate:output_type -> core.Certificate
	56,  // 151: sa.StorageAuthority.GetCertificateStatus:output_type -> core.CertificateStatus
	47,  // 152: sa.StorageAuthority.GetMaxExpiration:output_type -> google.protobuf.Timestamp
	57,  // 153: sa.StorageAuthority.GetOrder:output_type -> core.Order
	57,  // 154: sa.StorageAuthority.GetOrderForNames:output_type -> core.Order
	54,  // 155: sa.StorageAuthority.GetRegistration:output_type -> core.Registration
	54,  // 156: sa.StorageAuthority.GetRegistrationByKey:output_type -> core.Registration
	37,  // 157: sa.StorageAuthority.GetRevocationStatus:output_type -> sa.RevocationStatus
	58,  // 158: sa.StorageAuthority.GetRevokedCerts:output_type -> core.CRLEntry
	5,   // 159: sa.StorageAuthority.GetSerialMetadata:output_type -> sa.SerialMetadata
	4,   // 160: sa.StorageAuthority.GetSerialsByAccount:output_type -> sa.Serial
	4,   // 161: sa.StorageAuthority.GetSerialsByKey:output_type -> sa.Serial
	25,  // 162: sa.StorageAuthority.GetValidAuthorizations2:output_type -> sa.Authorizations
	25,  // 163: sa.StorageAuthority.GetValidOrderAuthorizations2:output_type -> sa.Authorizations
	33,  // 164: sa.StorageAuthority.IncidentsForSerial:output_type -> sa.Incidents
	13,  // 165: sa.StorageAuthority.KeyBlocked:output_type -> sa.Exists
	13,  // 166: sa.StorageAuthority.ReplacementOrderExists:output_type -> sa.Exists
	35,  // 167: sa.StorageAuthority.SerialsForIncident:output_type -> sa.IncidentSerial
	41,  // 168: sa.StorageAuthority.CheckIdentifiersPaused:output_type -> sa.Identifiers
	41,  // 169: sa.StorageAuthority.GetPausedIdentifiers:output_type -> sa.Identifiers
	53,  // 170: sa.StorageAuthority.AddBlockedKey:output_type -> google.protobuf.Empty
	53,  // 171: sa.StorageAuthority.AddCertificate:output_type -> google.protobuf.Empty
	53,  // 172: sa.StorageAuthority.AddPrecertificate:output_type -> google.protobuf.Empty
	53,  // 173: sa.StorageAuthority.SetCertificateStatusReady:output_type -> google.protobuf.Empty
	53,  // 174: sa.StorageAuthority.AddSerial:output_type -> google.protobuf.Empty
	53,  // 175: sa.StorageAuthority.DeactivateAuthorization2:output_type -> google.protobuf.Empty
	53,  // 176: sa.StorageAuthority.DeactivateRegistration:output_type -> google.protobuf.Empty
	53,  // 177: sa.StorageAuthority.FinalizeAuthorization2:output_type -> google.protobuf.Empty
	53,  // 178: sa.StorageAuthority.FinalizeOrder:output_type -> google.protobuf.Empty
	57,  // 179: sa.StorageAuthority.NewOrderAndAuthzs:output_type -> core.Order
	54,  // 180: sa.StorageAuthority.NewRegistration:output_type -> core.Registration
	53,  // 181: sa.StorageAuthority.RevokeCertificate:output_type -> google.protobuf.Empty
	53,  // 182: sa.StorageAuthority.SetOrderError:output_type -> google.protobuf.Empty
	53,  // 183: sa.StorageAuthority.SetOrderProcessing:output_type -> google.protobuf.Empty
	53,  // 184: sa.StorageAuthority.UpdateRegistration:output_type -> google.protobuf.Empty
	54,  // 185: sa.StorageAuthority.UpdateRegistrationContact:output_type -> core.Registration
	54,  // 186: sa.StorageAuthority.UpdateRegistrationKey:output_type -> core.Registration
	53,  // 187: sa.StorageAuthority.UpdateRevokedCertificate:output_type -> google.protobuf.Empty
	39,  // 188: sa.StorageAuthority.LeaseCRLShard:output_type -> sa.LeaseCRLShardResponse
	53,  // 189: sa.StorageAuthority.UpdateCRLShard:output_type -> google.protobuf.Empty
	43,  // 190: sa.StorageAuthority.PauseIdentifiers:output_type -> sa.PauseIdentifiersResponse
	7,   // 191: sa.StorageAuthority.UnpauseAccount:output_type -> sa.Count
	116, // [116:192] is the sub-list for method output_type
	40,  // [40:116] is the sub-list for method input_type
