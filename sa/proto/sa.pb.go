...
func (x *AddSerialsToIncidentRequest) GetSerialTable() string {
	if x != nil {
		return x.SerialTable
	}
	return ""
...
func (x *AddSerialsToIncidentRequest) GetSerial() []string {
	if x != nil {
		return x.Serial
	}
	return nil
...
var file_sa_proto_rawDesc = string([]byte{
	...
	0x42, 0x0a, 0x0a, 0x08, 0x5f, 0x65, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x64, 0x22, 0x57, 0x0a, 0x1b,
	0x41, 0x64, 0x64, 0x53, 0x65, 0x72, 0x69, 0x61, 0x6c, 0x73, 0x54, 0x6f, 0x49, 0x6e, 0x63, 0x69,
	0x64, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x20, 0x0a, 0x0b, 0x73,
	0x65, 0x72, 0x69, 0x61, 0x6c, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x0b, 0x73, 0x65, 0x72, 0x69, 0x61, 0x6c, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x12, 0x16, 0x0a,
	0x06, 0x73, 0x65, 0x72, 0x69, 0x61, 0x6c, 0x18, 0x02, 0x20, 0x03, 0x28, 0x09, 0x52, 0x06, 0x73,
	0x65, 0x72, 0x69, 0x61, 0x6c, 0x22, 0xb4, 0x01, 0x0a, 0x0e, 0x49, 0x6e, 0x63, 0x69, 0x64, 0x65,
	...
	0x16, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75,
	0x66, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x22, 0x00, 0x32, 0xf0, 0x01, 0x0a, 0x15, 0x53, 0x74,
	...
	0x12, 0x45, 0x0a, 0x0e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x49, 0x6e, 0x63, 0x69, 0x64, 0x65,
	...
	0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e,
	0x45, 0x6d, 0x70, 0x74, 0x79, 0x22, 0x00, 0x12, 0x53, 0x0a, 0x14, 0x41, 0x64, 0x64, 0x53, 0x65,
	0x72, 0x69, 0x61, 0x6c, 0x73, 0x54, 0x6f, 0x49, 0x6e, 0x63, 0x69, 0x64, 0x65, 0x6e, 0x74, 0x12,
	0x1f, 0x2e, 0x73, 0x61, 0x2e, 0x41, 0x64, 0x64, 0x53, 0x65, 0x72, 0x69, 0x61, 0x6c, 0x73, 0x54,
	0x6f, 0x49, 0x6e, 0x63, 0x69, 0x64, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
...
var file_sa_proto_depIdxs = []int32{
	...
	55,  // 37: sa.IncidentSerial.lastNoticeSent:type_name -> google.protobuf.Timestamp
	55,  // 38: sa.GetRevokedCertsByShardRequest.revokedBefore:type_name -> google.protobuf.Timestamp
	55,  // 39: sa.GetRevokedCertsByShardRequest.expiresAfter:type_name -> google.protobuf.Timestamp
	55,  // 40: sa.RevocationStatus.revokedDate:type_name -> google.protobuf.Timestamp
	...
	47,  // 47: sa.AddRateLimitOverrideRequest.override:type_name -> sa.RateLimitOverride
	47,  // 48: sa.AddRateLimitOverrideResponse.existing:type_name -> sa.RateLimitOverride
	47,  // 49: sa.RateLimitOverrideResponse.override:type_name -> sa.RateLimitOverride
	55,  // 50: sa.RateLimitOverrideResponse.updatedAt:type_name -> google.protobuf.Timestamp
	11,  // 51: sa.StorageAuthorityReadOnly.FQDNSetExists:input_type -> sa.FQDNSetExistsRequest
	10,  // 52: sa.StorageAuthorityReadOnly.FQDNSetTimestampsForWindow:input_type -> sa.CountFQDNSetsRequest
	26,  // 53: sa.StorageAuthorityReadOnly.GetAuthorization2:input_type -> sa.AuthorizationID2
	...
	4,   // 63: sa.StorageAuthorityReadOnly.GetSerialMetadata:input_type -> sa.Serial
	0,   // 64: sa.StorageAuthorityReadOnly.GetSerialsByAccount:input_type -> sa.RegistrationID
	30,  // 65: sa.StorageAuthorityReadOnly.GetSerialsByKey:input_type -> sa.SPKIHash
	3,   // 66: sa.StorageAuthorityReadOnly.GetValidAuthorizations2:input_type -> sa.GetValidAuthorizationsRequest
	20,  // 67: sa.StorageAuthorityReadOnly.GetValidOrderAuthorizations2:input_type -> sa.GetOrderAuthorizationsRequest
	20,  // 68: sa.StorageAuthorityReadOnly.GetOrderAuthorizations:input_type -> sa.GetOrderAuthorizationsRequest
	...
	60,  // 71: sa.StorageAuthorityReadOnly.ListIncidents:input_type -> google.protobuf.Empty
	4,   // 72: sa.StorageAuthorityReadOnly.ReplacementOrderExists:input_type -> sa.Serial
	33,  // 73: sa.StorageAuthorityReadOnly.SerialsForIncident:input_type -> sa.SerialsForIncidentRequest
	44,  // 74: sa.StorageAuthorityReadOnly.CheckIdentifiersPaused:input_type -> sa.PauseRequest
	0,   // 75: sa.StorageAuthorityReadOnly.GetPausedIdentifiers:input_type -> sa.RegistrationID
	52,  // 76: sa.StorageAuthorityReadOnly.GetRateLimitOverride:input_type -> sa.GetRateLimitOverrideRequest
	60,  // 77: sa.StorageAuthorityReadOnly.GetEnabledRateLimitOverrides:input_type -> google.protobuf.Empty
	11,  // 78: sa.StorageAuthority.FQDNSetExists:input_type -> sa.FQDNSetExistsRequest
	10,  // 79: sa.StorageAuthority.FQDNSetTimestampsForWindow:input_type -> sa.CountFQDNSetsRequest
	26,  // 80: sa.StorageAuthority.GetAuthorization2:input_type -> sa.AuthorizationID2
	...
	15,  // 84: sa.StorageAuthority.GetOrder:input_type -> sa.OrderRequest
	21,  // 85: sa.StorageAuthority.GetOrderForNames:input_type -> sa.GetOrderForNamesRequest
	...
	4,   // 88: sa.StorageAuthority.GetRevocationStatus:input_type -> sa.Serial
	38,  // 89: sa.StorageAuthority.GetRevokedCertsByShard:input_type -> sa.GetRevokedCertsByShardRequest
	4,   // 90: sa.StorageAuthority.GetSerialMetadata:input_type -> sa.Serial
	0,   // 91: sa.StorageAuthority.GetSerialsByAccount:input_type -> sa.RegistrationID
	30,  // 92: sa.StorageAuthority.GetSerialsByKey:input_type -> sa.SPKIHash
	3,   // 93: sa.StorageAuthority.GetValidAuthorizations2:input_type -> sa.GetValidAuthorizationsRequest
	20,  // 94: sa.StorageAuthority.GetValidOrderAuthorizations2:input_type -> sa.GetOrderAuthorizationsRequest
	20,  // 95: sa.StorageAuthority.GetOrderAuthorizations:input_type -> sa.GetOrderAuthorizationsRequest
	4,   // 96: sa.StorageAuthority.IncidentsForSerial:input_type -> sa.Serial
	30,  // 97: sa.StorageAuthority.KeyBlocked:input_type -> sa.SPKIHash
	60,  // 98: sa.StorageAuthority.ListIncidents:input_type -> google.protobuf.Empty
	...
	44,  // 101: sa.StorageAuthority.CheckIdentifiersPaused:input_type -> sa.PauseRequest
	0,   // 102: sa.StorageAuthority.GetPausedIdentifiers:input_type -> sa.RegistrationID
	52,  // 103: sa.StorageAuthority.GetRateLimitOverride:input_type -> sa.GetRateLimitOverrideRequest
	60,  // 104: sa.StorageAuthority.GetEnabledRateLimitOverrides:input_type -> google.protobuf.Empty
	29,  // 105: sa.StorageAuthority.AddBlockedKey:input_type -> sa.AddBlockedKeyRequest
	14,  // 106: sa.StorageAuthority.AddCertificate:input_type -> sa.AddCertificateRequest
	14,  // 107: sa.StorageAuthority.AddPrecertificate:input_type -> sa.AddCertificateRequest
	13,  // 108: sa.StorageAuthority.AddSerial:input_type -> sa.AddSerialRequest
	26,  // 109: sa.StorageAuthority.DeactivateAuthorization2:input_type -> sa.AuthorizationID2
	0,   // 110: sa.StorageAuthority.DeactivateRegistration:input_type -> sa.RegistrationID
	28,  // 111: sa.StorageAuthority.FinalizeAuthorization2:input_type -> sa.FinalizeAuthorizationRequest
	22,  // 112: sa.StorageAuthority.FinalizeOrder:input_type -> sa.FinalizeOrderRequest
	18,  // 113: sa.StorageAuthority.NewOrderAndAuthzs:input_type -> sa.NewOrderAndAuthzsRequest
	61,  // 114: sa.StorageAuthority.NewRegistration:input_type -> core.Registration
	27,  // 115: sa.StorageAuthority.RevokeCertificate:input_type -> sa.RevokeCertificateRequest
	19,  // 116: sa.StorageAuthority.SetOrderError:input_type -> sa.SetOrderErrorRequest
	15,  // 117: sa.StorageAuthority.SetOrderProcessing:input_type -> sa.OrderRequest
	46,  // 118: sa.StorageAuthority.UpdateRegistrationKey:input_type -> sa.UpdateRegistrationKeyRequest
	...
	48,  // 124: sa.StorageAuthority.AddRateLimitOverride:input_type -> sa.AddRateLimitOverrideRequest
	51,  // 125: sa.StorageAuthority.DisableRateLimitOverride:input_type -> sa.DisableRateLimitOverrideRequest
	50,  // 126: sa.StorageAuthority.EnableRateLimitOverride:input_type -> sa.EnableRateLimitOverrideRequest
	34,  // 127: sa.StorageAuthorityAdmin.CreateIncident:input_type -> sa.CreateIncidentRequest
	35,  // 128: sa.StorageAuthorityAdmin.UpdateIncident:input_type -> sa.UpdateIncidentRequest
	36,  // 129: sa.StorageAuthorityAdmin.AddSerialsToIncident:input_type -> sa.AddSerialsToIncidentRequest
	12,  // 130: sa.StorageAuthorityReadOnly.FQDNSetExists:output_type -> sa.Exists
	8,   // 131: sa.StorageAuthorityReadOnly.FQDNSetTimestampsForWindow:output_type -> sa.Timestamps
	58,  // 132: sa.StorageAuthorityReadOnly.GetAuthorization2:output_type -> core.Authorization
	62,  // 133: sa.StorageAuthorityReadOnly.GetCertificate:output_type -> core.Certificate
	62,  // 134: sa.StorageAuthorityReadOnly.GetLintPrecertificate:output_type -> core.Certificate
	63,  // 135: sa.StorageAuthorityReadOnly.GetCertificateStatus:output_type -> core.CertificateStatus
	64,  // 136: sa.StorageAuthorityReadOnly.GetOrder:output_type -> core.Order
	64,  // 137: sa.StorageAuthorityReadOnly.GetOrderForNames:output_type -> core.Order
	61,  // 138: sa.StorageAuthorityReadOnly.GetRegistration:output_type -> core.Registration
	61,  // 139: sa.StorageAuthorityReadOnly.GetRegistrationByKey:output_type -> core.Registration
	39,  // 140: sa.StorageAuthorityReadOnly.GetRevocationStatus:output_type -> sa.RevocationStatus
	65,  // 141: sa.StorageAuthorityReadOnly.GetRevokedCertsByShard:output_type -> core.CRLEntry
	5,   // 142: sa.StorageAuthorityReadOnly.GetSerialMetadata:output_type -> sa.SerialMetadata
	4,   // 143: sa.StorageAuthorityReadOnly.GetSerialsByAccount:output_type -> sa.Serial
	4,   // 144: sa.StorageAuthorityReadOnly.GetSerialsByKey:output_type -> sa.Serial
	24,  // 145: sa.StorageAuthorityReadOnly.GetValidAuthorizations2:output_type -> sa.Authorizations
	24,  // 146: sa.StorageAuthorityReadOnly.GetValidOrderAuthorizations2:output_type -> sa.Authorizations
	24,  // 147: sa.StorageAuthorityReadOnly.GetOrderAuthorizations:output_type -> sa.Authorizations
	32,  // 148: sa.StorageAuthorityReadOnly.IncidentsForSerial:output_type -> sa.Incidents
	12,  // 149: sa.StorageAuthorityReadOnly.KeyBlocked:output_type -> sa.Exists
	32,  // 150: sa.StorageAuthorityReadOnly.ListIncidents:output_type -> sa.Incidents
	12,  // 151: sa.StorageAuthorityReadOnly.ReplacementOrderExists:output_type -> sa.Exists
	37,  // 152: sa.StorageAuthorityReadOnly.SerialsForIncident:output_type -> sa.IncidentSerial
	43,  // 153: sa.StorageAuthorityReadOnly.CheckIdentifiersPaused:output_type -> sa.Identifiers
	43,  // 154: sa.StorageAuthorityReadOnly.GetPausedIdentifiers:output_type -> sa.Identifiers
	53,  // 155: sa.StorageAuthorityReadOnly.GetRateLimitOverride:output_type -> sa.RateLimitOverrideResponse
	53,  // 156: sa.StorageAuthorityReadOnly.GetEnabledRateLimitOverrides:output_type -> sa.RateLimitOverrideResponse
	12,  // 157: sa.StorageAuthority.FQDNSetExists:output_type -> sa.Exists
	8,   // 158: sa.StorageAuthority.FQDNSetTimestampsForWindow:output_type -> sa.Timestamps
	58,  // 159: sa.StorageAuthority.GetAuthorization2:output_type -> core.Authorization
	62,  // 160: sa.StorageAuthority.GetCertificate:output_type -> core.Certificate
	62,  // 161: sa.StorageAuthority.GetLintPrecertificate:output_type -> core.Certificate
	63,  // 162: sa.StorageAuthority.GetCertificateStatus:output_type -> core.CertificateStatus
	64,  // 163: sa.StorageAuthority.GetOrder:output_type -> core.Order
	64,  // 164: sa.StorageAuthority.GetOrderForNames:output_type -> core.Order
	61,  // 165: sa.StorageAuthority.GetRegistration:output_type -> core.Registration
	61,  // 166: sa.StorageAuthority.GetRegistrationByKey:output_type -> core.Registration
	39,  // 167: sa.StorageAuthority.GetRevocationStatus:output_type -> sa.RevocationStatus
	65,  // 168: sa.StorageAuthority.GetRevokedCertsByShard:output_type -> core.CRLEntry
	...
	32,  // 175: sa.StorageAuthority.IncidentsForSerial:output_type -> sa.Incidents
	12,  // 176: sa.StorageAuthority.KeyBlocked:output_type -> sa.Exists
	32,  // 177: sa.StorageAuthority.ListIncidents:output_type -> sa.Incidents
	12,  // 178: sa.StorageAuthority.ReplacementOrderExists:output_type -> sa.Exists
	37,  // 179: sa.StorageAuthority.SerialsForIncident:output_type -> sa.IncidentSerial
	43,  // 180: sa.StorageAuthority.CheckIdentifiersPaused:output_type -> sa.Identifiers
	43,  // 181: sa.StorageAuthority.GetPausedIdentifiers:output_type -> sa.Identifiers
	53,  // 182: sa.StorageAuthority.GetRateLimitOverride:output_type -> sa.RateLimitOverrideResponse
	53,  // 183: sa.StorageAuthority.GetEnabledRateLimitOverrides:output_type -> sa.RateLimitOverrideResponse
	60,  // 184: sa.StorageAuthority.AddBlockedKey:output_type -> google.protobuf.Empty
	...
	61,  // 189: sa.StorageAuthority.DeactivateRegistration:output_type -> core.Registration
	60,  // 190: sa.StorageAuthority.FinalizeAuthorization2:output_type -> google.protobuf.Empty
	60,  // 191: sa.StorageAuthority.FinalizeOrder:output_type -> google.protobuf.Empty
	64,  // 192: sa.StorageAuthority.NewOrderAndAuthzs:output_type -> core.Order
	61,  // 193: sa.StorageAuthority.NewRegistration:output_type -> core.Registration
	60,  // 194: sa.StorageAuthority.RevokeCertificate:output_type -> google.protobuf.Empty
	60,  // 195: sa.StorageAuthority.SetOrderError:output_type -> google.protobuf.Empty
	60,  // 196: sa.StorageAuthority.SetOrderProcessing:output_type -> google.protobuf.Empty
	61,  // 197: sa.StorageAuthority.UpdateRegistrationKey:output_type -> core.Registration
	60,  // 198: sa.StorageAuthority.UpdateRevokedCertificate:output_type -> google.protobuf.Empty
	41,  // 199: sa.StorageAuthority.LeaseCRLShard:output_type -> sa.LeaseCRLShardResponse
	60,  // 200: sa.StorageAuthority.UpdateCRLShard:output_type -> google.protobuf.Empty
	45,  // 201: sa.StorageAuthority.PauseIdentifiers:output_type -> sa.PauseIdentifiersResponse
	7,   // 202: sa.StorageAuthority.UnpauseAccount:output_type -> sa.Count
	49,  // 203: sa.StorageAuthority.AddRateLimitOverride:output_type -> sa.AddRateLimitOverrideResponse
	60,  // 204: sa.StorageAuthority.DisableRateLimitOverride:output_type -> google.protobuf.Empty
	60,  // 205: sa.StorageAuthority.EnableRateLimitOverride:output_type -> google.protobuf.Empty
	31,  // 206: sa.StorageAuthorityAdmin.CreateIncident:output_type -> sa.Incident
	60,  // 207: sa.StorageAuthorityAdmin.UpdateIncident:output_type -> google.protobuf.Empty
	60,  // 208: sa.StorageAuthorityAdmin.AddSerialsToIncident:output_type -> google.protobuf.Empty
	130, // [130:209] is the sub-list for method output_type
	51,  // [51:130] is the sub-list for method input_type
