...
var file_sa_proto_rawDesc = string([]byte{
	...
	0x65, 0x22, 0x00, 0x30, 0x01, 0x32, 0x8d, 0x1b, 0x0a, 0x10, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67,
	...
	0x73, 0x65, 0x22, 0x00, 0x30, 0x01, 0x12, 0x43, 0x0a, 0x0d, 0x41, 0x64, 0x64, 0x42, 0x6c, 0x6f,
	...
	0x62, 0x75, 0x66, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x22, 0x00, 0x12, 0x45, 0x0a, 0x0e, 0x41,
	...
	0x22, 0x00, 0x12, 0x48, 0x0a, 0x11, 0x41, 0x64, 0x64, 0x50, 0x72, 0x65, 0x63, 0x65, 0x72, 0x74,
	...
	0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e,
	0x45, 0x6d, 0x70, 0x74, 0x79, 0x22, 0x00, 0x12, 0x4f, 0x0a, 0x15, 0x55, 0x70, 0x64, 0x61, 0x74,
	...
	0x6e, 0x74, 0x22, 0x00, 0x12, 0x5b, 0x0a, 0x14, 0x41, 0x64, 0x64, 0x52, 0x61, 0x74, 0x65, 0x4c,
	...
	0x65, 0x72, 0x72, 0x69, 0x64, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x20, 0x2e,
	...
	0x00, 0x12, 0x59, 0x0a, 0x18, 0x44, 0x69, 0x73, 0x61, 0x62, 0x6c, 0x65, 0x52, 0x61, 0x74, 0x65,
	0x4c, 0x69, 0x6d, 0x69, 0x74, 0x4f, 0x76, 0x65, 0x72, 0x72, 0x69, 0x64, 0x65, 0x12, 0x23, 0x2e,
	0x73, 0x61, 0x2e, 0x44, 0x69, 0x73, 0x61, 0x62, 0x6c, 0x65, 0x52, 0x61, 0x74, 0x65, 0x4c, 0x69,
	...
	0x76, 0x65, 0x72, 0x72, 0x69, 0x64, 0x65, 0x12, 0x22, 0x2e, 0x73, 0x61, 0x2e, 0x45, 0x6e, 0x61,
...
var file_sa_proto_depIdxs = []int32{
	...
	59,  // 131: sa.StorageAuthorityReadOnly.GetCertificate:output_type -> core.Certificate
	59,  // 132: sa.StorageAuthorityReadOnly.GetLintPrecertificate:output_type -> core.Certificate
	60,  // 133: sa.StorageAuthorityReadOnly.GetCertificateStatus:output_type -> core.CertificateStatus
	61,  // 134: sa.StorageAuthorityReadOnly.GetOrder:output_type -> core.Order
	61,  // 135: sa.StorageAuthorityReadOnly.GetOrderForNames:output_type -> core.Order
	58,  // 136: sa.StorageAuthorityReadOnly.GetRegistration:output_type -> core.Registration
	58,  // 137: sa.StorageAuthorityReadOnly.GetRegistrationByKey:output_type -> core.Registration
	36,  // 138: sa.StorageAuthorityReadOnly.GetRevocationStatus:output_type -> sa.RevocationStatus
	62,  // 139: sa.StorageAuthorityReadOnly.GetRevokedCertsByShard:output_type -> core.CRLEntry
	...
	24,  // 143: sa.StorageAuthorityReadOnly.GetValidAuthorizations2:output_type -> sa.Authorizations
	24,  // 144: sa.StorageAuthorityReadOnly.GetValidOrderAuthorizations2:output_type -> sa.Authorizations
	24,  // 145: sa.StorageAuthorityReadOnly.GetOrderAuthorizations:output_type -> sa.Authorizations
	...
	59,  // 159: sa.StorageAuthority.GetCertificate:output_type -> core.Certificate
	59,  // 160: sa.StorageAuthority.GetLintPrecertificate:output_type -> core.Certificate
	60,  // 161: sa.StorageAuthority.GetCertificateStatus:output_type -> core.CertificateStatus
	61,  // 162: sa.StorageAuthority.GetOrder:output_type -> core.Order
	61,  // 163: sa.StorageAuthority.GetOrderForNames:output_type -> core.Order
	58,  // 164: sa.StorageAuthority.GetRegistration:output_type -> core.Registration
	58,  // 165: sa.StorageAuthority.GetRegistrationByKey:output_type -> core.Registration
	36,  // 166: sa.StorageAuthority.GetRevocationStatus:output_type -> sa.RevocationStatus
	62,  // 167: sa.StorageAuthority.GetRevokedCertsByShard:output_type -> core.CRLEntry
	5,   // 168: sa.StorageAuthority.GetSerialMetadata:output_type -> sa.SerialMetadata
	4,   // 169: sa.StorageAuthority.GetSerialsByAccount:output_type -> sa.Serial
	4,   // 170: sa.StorageAuthority.GetSerialsByKey:output_type -> sa.Serial
	24,  // 171: sa.StorageAuthority.GetValidAuthorizations2:output_type -> sa.Authorizations
	24,  // 172: sa.StorageAuthority.GetValidOrderAuthorizations2:output_type -> sa.Authorizations
	24,  // 173: sa.StorageAuthority.GetOrderAuthorizations:output_type -> sa.Authorizations
