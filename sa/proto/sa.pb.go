...
var file_sa_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61,
	0x6d, 0x70, 0x52, 0x0a, 0x6e, 0x65, 0x78, 0x74, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x32, 0xb0,
	...
	0x01, 0x32, 0xa7, 0x19, 0x0a, 0x10, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x41, 0x75, 0x74,
...
var file_sa_proto_depIdxs = []int32{
	...
	6,   // 70: sa.StorageAuthorityReadOnly.ReplacementOrderExists:input_type -> sa.Serial
	...
	6,   // 84: sa.StorageAuthority.GetCertificateStatus:input_type -> sa.Serial
	54,  // 85: sa.StorageAuthority.GetMaxExpiration:input_type -> google.protobuf.Empty
	22,  // 86: sa.StorageAuthority.GetOrder:input_type -> sa.OrderRequest
	27,  // 87: sa.StorageAuthority.GetOrderForNames:input_type -> sa.GetOrderForNamesRequest
	3,   // 88: sa.StorageAuthority.GetPendingAuthorization2:input_type -> sa.GetPendingAuthorizationRequest
	...
	6,   // 91: sa.StorageAuthority.GetRevocationStatus:input_type -> sa.Serial
	41,  // 92: sa.StorageAuthority.GetRevokedCerts:input_type -> sa.GetRevokedCertsRequest
	6,   // 93: sa.StorageAuthority.GetSerialMetadata:input_type -> sa.Serial
	4,   // 94: sa.StorageAuthority.GetValidAuthorizations2:input_type -> sa.GetValidAuthorizationsRequest
	26,  // 95: sa.StorageAuthority.GetValidOrderAuthorizations2:input_type -> sa.GetValidOrderAuthorizationsRequest
	6,   // 96: sa.StorageAuthority.IncidentsForSerial:input_type -> sa.Serial
	36,  // 97: sa.StorageAuthority.KeyBlocked:input_type -> sa.KeyBlockedRequest
	18,  // 98: sa.StorageAuthority.PreviousCertificateExists:input_type -> sa.PreviousCertificateExistsRequest
	6,   // 99: sa.StorageAuthority.ReplacementOrderExists:input_type -> sa.Serial
	...
	51,  // 135: sa.StorageAuthorityReadOnly.GetPendingAuthorization2:output_type -> core.Authorization
	55,  // 136: sa.StorageAuthorityReadOnly.GetRegistration:output_type -> core.Registration
	55,  // 137: sa.StorageAuthorityReadOnly.GetRegistrationByKey:output_type -> core.Registration
	42,  // 138: sa.StorageAuthorityReadOnly.GetRevocationStatus:output_type -> sa.RevocationStatus
	59,  // 139: sa.StorageAuthorityReadOnly.GetRevokedCerts:output_type -> core.CRLEntry
	7,   // 140: sa.StorageAuthorityReadOnly.GetSerialMetadata:output_type -> sa.SerialMetadata
	30,  // 141: sa.StorageAuthorityReadOnly.GetValidAuthorizations2:output_type -> sa.Authorizations
	30,  // 142: sa.StorageAuthorityReadOnly.GetValidOrderAuthorizations2:output_type -> sa.Authorizations
	38,  // 143: sa.StorageAuthorityReadOnly.IncidentsForSerial:output_type -> sa.Incidents
	19,  // 144: sa.StorageAuthorityReadOnly.KeyBlocked:output_type -> sa.Exists
	19,  // 145: sa.StorageAuthorityReadOnly.PreviousCertificateExists:output_type -> sa.Exists
	19,  // 146: sa.StorageAuthorityReadOnly.ReplacementOrderExists:output_type -> sa.Exists
	...
	51,  // 164: sa.StorageAuthority.GetPendingAuthorization2:output_type -> core.Authorization
	55,  // 165: sa.StorageAuthority.GetRegistration:output_type -> core.Registration
	55,  // 166: sa.StorageAuthority.GetRegistrationByKey:output_type -> core.Registration
	42,  // 167: sa.StorageAuthority.GetRevocationStatus:output_type -> sa.RevocationStatus
	59,  // 168: sa.StorageAuthority.GetRevokedCerts:output_type -> core.CRLEntry
	7,   // 169: sa.StorageAuthority.GetSerialMetadata:output_type -> sa.SerialMetadata
	30,  // 170: sa.StorageAuthority.GetValidAuthorizations2:output_type -> sa.Authorizations
	30,  // 171: sa.StorageAuthority.GetValidOrderAuthorizations2:output_type -> sa.Authorizations
	38,  // 172: sa.StorageAuthority.IncidentsForSerial:output_type -> sa.Incidents
	19,  // 173: sa.StorageAuthority.KeyBlocked:output_type -> sa.Exists
	19,  // 174: sa.StorageAuthority.PreviousCertificateExists:output_type -> sa.Exists
	19,  // 175: sa.StorageAuthority.ReplacementOrderExists:output_type -> sa.Exists
