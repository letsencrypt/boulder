...
type StorageAuthorityClient interface {
	...
	SetOrderProcessing(ctx context.Context, in *core.Order, opts ...grpc.CallOption) (*core.Order, error)
...
func (c *storageAuthorityClient) SetOrderProcessing(ctx context.Context, in *core.Order, opts ...grpc.CallOption) (*core.Order, error) {
	out := new(core.Order)
...
type StorageAuthorityServer interface {
	...
	SetOrderProcessing(context.Context, *core.Order) (*core.Order, error)
...
var fileDescriptor0 = []byte{
	...
	,
}
