...
type CertificateStatus struct {
	...
	RevokedDate   int64 `protobuf:"varint,3,opt,name=revokedDate,proto3" json:"revokedDate,omitempty"` // Unix timestamp (nanoseconds)
}
...
func (x *CertificateStatus) GetStatus() int64 {
	if x != nil {
		return x.Status
	}
	return 0
...
var file_sa_proto_rawDesc = []byte{
	...
	0x65, 0x22, 0x73, 0x0a, 0x11, 0x43, 0x65, 0x72, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x65,
	...
	0x61, 0x73, 0x6f, 0x6e, 0x12, 0x20, 0x0a, 0x0b, 0x72, 0x65, 0x76, 0x6f, 0x6b, 0x65, 0x64, 0x44,
	0x61, 0x74, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0b, 0x72, 0x65, 0x76, 0x6f, 0x6b,
	0x65, 0x64, 0x44, 0x61, 0x74, 0x65, 0x32, 0xe5, 0x17, 0x0a, 0x10, 0x53, 0x74, 0x6f, 0x72, 0x61,
	0x67, 0x65, 0x41, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x69, 0x74, 0x79, 0x12, 0x3b, 0x0a, 0x0f, 0x47,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x22, 0x00, 0x12, 0x35, 0x0a, 0x11, 0x47, 0x65, 0x74, 0x53, 0x65, 0x72,
	...
	0x69, 0x61, 0x6c, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x22, 0x00, 0x12, 0x31, 0x0a,
	...
	0x12, 0x34, 0x0a, 0x11, 0x47, 0x65, 0x74, 0x50, 0x72, 0x65, 0x63, 0x65, 0x72, 0x74, 0x69, 0x66,
	...
	0x74, 0x75, 0x73, 0x22, 0x00, 0x12, 0x3c, 0x0a, 0x15, 0x47, 0x65, 0x74, 0x43, 0x65, 0x72, 0x74,
	0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x65, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x32, 0x12, 0x0a,
	0x2e, 0x73, 0x61, 0x2e, 0x53, 0x65, 0x72, 0x69, 0x61, 0x6c, 0x1a, 0x15, 0x2e, 0x73, 0x61, 0x2e,
	...
	0x74, 0x61, 0x6d, 0x70, 0x73, 0x22, 0x00, 0x12, 0x37, 0x0a, 0x0d, 0x46, 0x51, 0x44, 0x4e, 0x53,
	...
	0x65, 0x72, 0x69, 0x61, 0x6c, 0x22, 0x00, 0x30, 0x01, 0x12, 0x41, 0x0a, 0x0f, 0x47, 0x65, 0x74,
	...
	0x43, 0x52, 0x4c, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x22, 0x00, 0x30, 0x01, 0x12, 0x3b, 0x0a, 0x0f,
	...
	0x45, 0x6d, 0x70, 0x74, 0x79, 0x22, 0x00, 0x12, 0x2e, 0x0a, 0x08, 0x4e, 0x65, 0x77, 0x4f, 0x72,
	0x64, 0x65, 0x72, 0x12, 0x13, 0x2e, 0x73, 0x61, 0x2e, 0x4e, 0x65, 0x77, 0x4f, 0x72, 0x64, 0x65,
	0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x0b, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x2e,
	0x4f, 0x72, 0x64, 0x65, 0x72, 0x22, 0x00, 0x12, 0x40, 0x0a, 0x11, 0x4e, 0x65, 0x77, 0x4f, 0x72,
...
var file_sa_proto_goTypes = []interface{}{
	...
	(*CertificateStatus)(nil),                  // 44: sa.CertificateStatus
	...
	(*proto.CRLEntry)(nil),                     // 54: core.CRLEntry
...
var file_sa_proto_depIdxs = []int32{
	...
	48, // 13: sa.ValidAuthorizations.MapElement.authz:type_name -> core.Authorization
	48, // 14: sa.Authorizations.MapElement.authz:type_name -> core.Authorization
	...
	6,  // 21: sa.StorageAuthority.GetCertificateStatus2:input_type -> sa.Serial
	11, // 22: sa.StorageAuthority.CountCertificatesByNames:input_type -> sa.CountCertificatesByNamesRequest
	13, // 23: sa.StorageAuthority.CountRegistrationsByIP:input_type -> sa.CountRegistrationsByIPRequest
	13, // 24: sa.StorageAuthority.CountRegistrationsByIPRange:input_type -> sa.CountRegistrationsByIPRequest
	15, // 25: sa.StorageAuthority.CountOrders:input_type -> sa.CountOrdersRequest
	16, // 26: sa.StorageAuthority.CountFQDNSets:input_type -> sa.CountFQDNSetsRequest
	16, // 27: sa.StorageAuthority.FQDNSetTimestampsForWindow:input_type -> sa.CountFQDNSetsRequest
	17, // 28: sa.StorageAuthority.FQDNSetExists:input_type -> sa.FQDNSetExistsRequest
	18, // 29: sa.StorageAuthority.PreviousCertificateExists:input_type -> sa.PreviousCertificateExistsRequest
	34, // 30: sa.StorageAuthority.GetAuthorization2:input_type -> sa.AuthorizationID2
	30, // 31: sa.StorageAuthority.GetAuthorizations2:input_type -> sa.GetAuthorizationsRequest
	3,  // 32: sa.StorageAuthority.GetPendingAuthorization2:input_type -> sa.GetPendingAuthorizationRequest
	0,  // 33: sa.StorageAuthority.CountPendingAuthorizations2:input_type -> sa.RegistrationID
	27, // 34: sa.StorageAuthority.GetValidOrderAuthorizations2:input_type -> sa.GetValidOrderAuthorizationsRequest
	14, // 35: sa.StorageAuthority.CountInvalidAuthorizations2:input_type -> sa.CountInvalidAuthorizationsRequest
	4,  // 36: sa.StorageAuthority.GetValidAuthorizations2:input_type -> sa.GetValidAuthorizationsRequest
	39, // 37: sa.StorageAuthority.KeyBlocked:input_type -> sa.KeyBlockedRequest
	41, // 38: sa.StorageAuthority.SerialsForIncident:input_type -> sa.SerialsForIncidentRequest
	43, // 39: sa.StorageAuthority.GetRevokedCerts:input_type -> sa.GetRevokedCertsRequest
	51, // 40: sa.StorageAuthority.NewRegistration:input_type -> core.Registration
	51, // 41: sa.StorageAuthority.UpdateRegistration:input_type -> core.Registration
	21, // 42: sa.StorageAuthority.AddCertificate:input_type -> sa.AddCertificateRequest
	21, // 43: sa.StorageAuthority.AddPrecertificate:input_type -> sa.AddCertificateRequest
	20, // 44: sa.StorageAuthority.AddSerial:input_type -> sa.AddSerialRequest
	0,  // 45: sa.StorageAuthority.DeactivateRegistration:input_type -> sa.RegistrationID
	24, // 46: sa.StorageAuthority.NewOrder:input_type -> sa.NewOrderRequest
	25, // 47: sa.StorageAuthority.NewOrderAndAuthzs:input_type -> sa.NewOrderAndAuthzsRequest
	23, // 48: sa.StorageAuthority.SetOrderProcessing:input_type -> sa.OrderRequest
	26, // 49: sa.StorageAuthority.SetOrderError:input_type -> sa.SetOrderErrorRequest
	29, // 50: sa.StorageAuthority.FinalizeOrder:input_type -> sa.FinalizeOrderRequest
	23, // 51: sa.StorageAuthority.GetOrder:input_type -> sa.OrderRequest
	28, // 52: sa.StorageAuthority.GetOrderForNames:input_type -> sa.GetOrderForNamesRequest
	36, // 53: sa.StorageAuthority.RevokeCertificate:input_type -> sa.RevokeCertificateRequest
	36, // 54: sa.StorageAuthority.UpdateRevokedCertificate:input_type -> sa.RevokeCertificateRequest
	32, // 55: sa.StorageAuthority.NewAuthorizations2:input_type -> sa.AddPendingAuthorizationsRequest
	37, // 56: sa.StorageAuthority.FinalizeAuthorization2:input_type -> sa.FinalizeAuthorizationRequest
	34, // 57: sa.StorageAuthority.DeactivateAuthorization2:input_type -> sa.AuthorizationID2
	38, // 58: sa.StorageAuthority.AddBlockedKey:input_type -> sa.AddBlockedKeyRequest
	51, // 59: sa.StorageAuthority.GetRegistration:output_type -> core.Registration
	51, // 60: sa.StorageAuthority.GetRegistrationByKey:output_type -> core.Registration
	7,  // 61: sa.StorageAuthority.GetSerialMetadata:output_type -> sa.SerialMetadata
	52, // 62: sa.StorageAuthority.GetCertificate:output_type -> core.Certificate
	52, // 63: sa.StorageAuthority.GetPrecertificate:output_type -> core.Certificate
	53, // 64: sa.StorageAuthority.GetCertificateStatus:output_type -> core.CertificateStatus
	44, // 65: sa.StorageAuthority.GetCertificateStatus2:output_type -> sa.CertificateStatus
	12, // 66: sa.StorageAuthority.CountCertificatesByNames:output_type -> sa.CountByNames
	9,  // 67: sa.StorageAuthority.CountRegistrationsByIP:output_type -> sa.Count
	9,  // 68: sa.StorageAuthority.CountRegistrationsByIPRange:output_type -> sa.Count
	9,  // 69: sa.StorageAuthority.CountOrders:output_type -> sa.Count
	9,  // 70: sa.StorageAuthority.CountFQDNSets:output_type -> sa.Count
	10, // 71: sa.StorageAuthority.FQDNSetTimestampsForWindow:output_type -> sa.Timestamps
	19, // 72: sa.StorageAuthority.FQDNSetExists:output_type -> sa.Exists
	19, // 73: sa.StorageAuthority.PreviousCertificateExists:output_type -> sa.Exists
	48, // 74: sa.StorageAuthority.GetAuthorization2:output_type -> core.Authorization
	31, // 75: sa.StorageAuthority.GetAuthorizations2:output_type -> sa.Authorizations
	48, // 76: sa.StorageAuthority.GetPendingAuthorization2:output_type -> core.Authorization
	9,  // 77: sa.StorageAuthority.CountPendingAuthorizations2:output_type -> sa.Count
	31, // 78: sa.StorageAuthority.GetValidOrderAuthorizations2:output_type -> sa.Authorizations
	9,  // 79: sa.StorageAuthority.CountInvalidAuthorizations2:output_type -> sa.Count
	31, // 80: sa.StorageAuthority.GetValidAuthorizations2:output_type -> sa.Authorizations
	19, // 81: sa.StorageAuthority.KeyBlocked:output_type -> sa.Exists
	42, // 82: sa.StorageAuthority.SerialsForIncident:output_type -> sa.IncidentSerial
	54, // 83: sa.StorageAuthority.GetRevokedCerts:output_type -> core.CRLEntry
	51, // 84: sa.StorageAuthority.NewRegistration:output_type -> core.Registration
	55, // 85: sa.StorageAuthority.UpdateRegistration:output_type -> google.protobuf.Empty
	22, // 86: sa.StorageAuthority.AddCertificate:output_type -> sa.AddCertificateResponse
	55, // 87: sa.StorageAuthority.AddPrecertificate:output_type -> google.protobuf.Empty
	55, // 88: sa.StorageAuthority.AddSerial:output_type -> google.protobuf.Empty
	55, // 89: sa.StorageAuthority.DeactivateRegistration:output_type -> google.protobuf.Empty
	56, // 90: sa.StorageAuthority.NewOrder:output_type -> core.Order
	56, // 91: sa.StorageAuthority.NewOrderAndAuthzs:output_type -> core.Order
	55, // 92: sa.StorageAuthority.SetOrderProcessing:output_type -> google.protobuf.Empty
	55, // 93: sa.StorageAuthority.SetOrderError:output_type -> google.protobuf.Empty
	55, // 94: sa.StorageAuthority.FinalizeOrder:output_type -> google.protobuf.Empty
	56, // 95: sa.StorageAuthority.GetOrder:output_type -> core.Order
	56, // 96: sa.StorageAuthority.GetOrderForNames:output_type -> core.Order
	55, // 97: sa.StorageAuthority.RevokeCertificate:output_type -> google.protobuf.Empty
	55, // 98: sa.StorageAuthority.UpdateRevokedCertificate:output_type -> google.protobuf.Empty
	35, // 99: sa.StorageAuthority.NewAuthorizations2:output_type -> sa.Authorization2IDs
	55, // 100: sa.StorageAuthority.FinalizeAuthorization2:output_type -> google.protobuf.Empty
	55, // 101: sa.StorageAuthority.DeactivateAuthorization2:output_type -> google.protobuf.Empty
	55, // 102: sa.StorageAuthority.AddBlockedKey:output_type -> google.protobuf.Empty
