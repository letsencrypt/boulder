...
func (*GetOrderAuthorizationsRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{25} }
...
func (m *OrderID) String() string            { return proto1.CompactTextString(m) }
func (*OrderID) ProtoMessage()               {}
func (*OrderID) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{27} }
...
func init() {
	...
	proto1.RegisterType((*OrderID)(nil), "sa.OrderID")
...
type StorageAuthorityClient interface {
	...
	GetOrderForNames(ctx context.Context, in *GetOrderForNamesRequest, opts ...grpc.CallOption) (*OrderID, error)
...
func (c *storageAuthorityClient) GetOrderForNames(ctx context.Context, in *GetOrderForNamesRequest, opts ...grpc.CallOption) (*OrderID, error) {
	out := new(OrderID)
...
type StorageAuthorityServer interface {
	...
	GetOrderForNames(context.Context, *GetOrderForNamesRequest) (*OrderID, error)
...
var fileDescriptor0 = []byte{
	...
	,
}
