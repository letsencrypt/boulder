...
var file_sa_proto_rawDesc = []byte{
	...
	0x2e, 0x49, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x66, 0x69, 0x65, 0x72, 0x73, 0x22, 0x00, 0x32, 0xe3,
...
var file_sa_proto_depIdxs = []int32{
	...
	52,  // 106: sa.StorageAuthority.UpdateRegistration:input_type -> core.Registration
	43,  // 107: sa.StorageAuthority.UpdateRegistrationContact:input_type -> sa.UpdateRegistrationContactRequest
	44,  // 108: sa.StorageAuthority.UpdateRegistrationKey:input_type -> sa.UpdateRegistrationKeyRequest
	27,  // 109: sa.StorageAuthority.UpdateRevokedCertificate:input_type -> sa.RevokeCertificateRequest
	37,  // 110: sa.StorageAuthority.LeaseCRLShard:input_type -> sa.LeaseCRLShardRequest
	39,  // 111: sa.StorageAuthority.UpdateCRLShard:input_type -> sa.UpdateCRLShardRequest
	41,  // 112: sa.StorageAuthority.PauseIdentifiers:input_type -> sa.PauseRequest
	0,   // 113: sa.StorageAuthority.UnpauseAccount:input_type -> sa.RegistrationID
	7,   // 114: sa.StorageAuthorityReadOnly.CountInvalidAuthorizations2:output_type -> sa.Count
	7,   // 115: sa.StorageAuthorityReadOnly.CountPendingAuthorizations2:output_type -> sa.Count
	12,  // 116: sa.StorageAuthorityReadOnly.FQDNSetExists:output_type -> sa.Exists
	8,   // 117: sa.StorageAuthorityReadOnly.FQDNSetTimestampsForWindow:output_type -> sa.Timestamps
	49,  // 118: sa.StorageAuthorityReadOnly.GetAuthorization2:output_type -> core.Authorization
	24,  // 119: sa.StorageAuthorityReadOnly.GetAuthorizations2:output_type -> sa.Authorizations
	53,  // 120: sa.StorageAuthorityReadOnly.GetCertificate:output_type -> core.Certificate
	53,  // 121: sa.StorageAuthorityReadOnly.GetLintPrecertificate:output_type -> core.Certificate
	54,  // 122: sa.StorageAuthorityReadOnly.GetCertificateStatus:output_type -> core.CertificateStatus
	45,  // 123: sa.StorageAuthorityReadOnly.GetMaxExpiration:output_type -> google.protobuf.Timestamp
	55,  // 124: sa.StorageAuthorityReadOnly.GetOrder:output_type -> core.Order
	55,  // 125: sa.StorageAuthorityReadOnly.GetOrderForNames:output_type -> core.Order
	52,  // 126: sa.StorageAuthorityReadOnly.GetRegistration:output_type -> core.Registration
	52,  // 127: sa.StorageAuthorityReadOnly.GetRegistrationByKey:output_type -> core.Registration
	36,  // 128: sa.StorageAuthorityReadOnly.GetRevocationStatus:output_type -> sa.RevocationStatus
	56,  // 129: sa.StorageAuthorityReadOnly.GetRevokedCerts:output_type -> core.CRLEntry
	5,   // 130: sa.StorageAuthorityReadOnly.GetSerialMetadata:output_type -> sa.SerialMetadata
	4,   // 131: sa.StorageAuthorityReadOnly.GetSerialsByAccount:output_type -> sa.Serial
	4,   // 132: sa.StorageAuthorityReadOnly.GetSerialsByKey:output_type -> sa.Serial
	24,  // 133: sa.StorageAuthorityReadOnly.GetValidAuthorizations2:output_type -> sa.Authorizations
	24,  // 134: sa.StorageAuthorityReadOnly.GetValidOrderAuthorizations2:output_type -> sa.Authorizations
	32,  // 135: sa.StorageAuthorityReadOnly.IncidentsForSerial:output_type -> sa.Incidents
	12,  // 136: sa.StorageAuthorityReadOnly.KeyBlocked:output_type -> sa.Exists
	12,  // 137: sa.StorageAuthorityReadOnly.ReplacementOrderExists:output_type -> sa.Exists
	34,  // 138: sa.StorageAuthorityReadOnly.SerialsForIncident:output_type -> sa.IncidentSerial
	40,  // 139: sa.StorageAuthorityReadOnly.CheckIdentifiersPaused:output_type -> sa.Identifiers
	40,  // 140: sa.StorageAuthorityReadOnly.GetPausedIdentifiers:output_type -> sa.Identifiers
	7,   // 141: sa.StorageAuthority.CountInvalidAuthorizations2:output_type -> sa.Count
	7,   // 142: sa.StorageAuthority.CountPendingAuthorizations2:output_type -> sa.Count
	12,  // 143: sa.StorageAuthority.FQDNSetExists:output_type -> sa.Exists
	8,   // 144: sa.StorageAuthority.FQDNSetTimestampsForWindow:output_type -> sa.Timestamps
	49,  // 145: sa.StorageAuthority.GetAuthorization2:output_type -> core.Authorization
	24,  // 146: sa.StorageAuthority.GetAuthorizations2:output_type -> sa.Authorizations
	53,  // 147: sa.StorageAuthority.GetCertificate:output_type -> core.Certificate
	53,  // 148: sa.StorageAuthority.GetLintPrecertificate:output_type -> core.Certificate
	54,  // 149: sa.StorageAuthority.GetCertificateStatus:output_type -> core.CertificateStatus
	45,  // 150: sa.StorageAuthority.GetMaxExpiration:output_type -> google.protobuf.Timestamp
	55,  // 151: sa.StorageAuthority.GetOrder:output_type -> core.Order
	55,  // 152: sa.StorageAuthority.GetOrderForNames:output_type -> core.Order
	52,  // 153: sa.StorageAuthority.GetRegistration:output_type -> core.Registration
	52,  // 154: sa.StorageAuthority.GetRegistrationByKey:output_type -> core.Registration
	36,  // 155: sa.StorageAuthority.GetRevocationStatus:output_type -> sa.RevocationStatus
	56,  // 156: sa.StorageAuthority.GetRevokedCerts:output_type -> core.CRLEntry
	5,   // 157: sa.StorageAuthority.GetSerialMetadata:output_type -> sa.SerialMetadata
	4,   // 158: sa.StorageAuthority.GetSerialsByAccount:output_type -> sa.Serial
	4,   // 159: sa.StorageAuthority.GetSerialsByKey:output_type -> sa.Serial
	24,  // 160: sa.StorageAuthority.GetValidAuthorizations2:output_type -> sa.Authorizations
	24,  // 161: sa.StorageAuthority.GetValidOrderAuthorizations2:output_type -> sa.Authorizations
	32,  // 162: sa.StorageAuthority.IncidentsForSerial:output_type -> sa.Incidents
	12,  // 163: sa.StorageAuthority.KeyBlocked:output_type -> sa.Exists
	12,  // 164: sa.StorageAuthority.ReplacementOrderExists:output_type -> sa.Exists
	34,  // 165: sa.StorageAuthority.SerialsForIncident:output_type -> sa.IncidentSerial
	40,  // 166: sa.StorageAuthority.CheckIdentifiersPaused:output_type -> sa.Identifiers
	40,  // 167: sa.StorageAuthority.GetPausedIdentifiers:output_type -> sa.Identifiers
	51,  // 168: sa.StorageAuthority.AddBlockedKey:output_type -> google.protobuf.Empty
	51,  // 169: sa.StorageAuthority.AddCertificate:output_type -> google.protobuf.Empty
	51,  // 170: sa.StorageAuthority.AddPrecertificate:output_type -> google.protobuf.Empty
	51,  // 171: sa.StorageAuthority.SetCertificateStatusReady:output_type -> google.protobuf.Empty
	51,  // 172: sa.StorageAuthority.AddSerial:output_type -> google.protobuf.Empty
	51,  // 173: sa.StorageAuthority.DeactivateAuthorization2:output_type -> google.protobuf.Empty
	51,  // 174: sa.StorageAuthority.DeactivateRegistration:output_type -> google.protobuf.Empty
	51,  // 175: sa.StorageAuthority.FinalizeAuthorization2:output_type -> google.protobuf.Empty
	51,  // 176: sa.StorageAuthority.FinalizeOrder:output_type -> google.protobuf.Empty
	55,  // 177: sa.StorageAuthority.NewOrderAndAuthzs:output_type -> core.Order
	52,  // 178: sa.StorageAuthority.NewRegistration:output_type -> core.Registration
	51,  // 179: sa.StorageAuthority.RevokeCertificate:output_type -> google.protobuf.Empty
	51,  // 180: sa.StorageAuthority.SetOrderError:output_type -> google.protobuf.Empty
	51,  // 181: sa.StorageAuthority.SetOrderProcessing:output_type -> google.protobuf.Empty
	51,  // 182: sa.StorageAuthority.UpdateRegistration:output_type -> google.protobuf.Empty
	52,  // 183: sa.StorageAuthority.UpdateRegistrationContact:output_type -> core.Registration
	52,  // 184: sa.StorageAuthority.UpdateRegistrationKey:output_type -> core.Registration
	51,  // 185: sa.StorageAuthority.UpdateRevokedCertificate:output_type -> google.protobuf.Empty
	38,  // 186: sa.StorageAuthority.LeaseCRLShard:output_type -> sa.LeaseCRLShardResponse
	51,  // 187: sa.StorageAuthority.UpdateCRLShard:output_type -> google.protobuf.Empty
	42,  // 188: sa.StorageAuthority.PauseIdentifiers:output_type -> sa.PauseIdentifiersResponse
	7,   // 189: sa.StorageAuthority.UnpauseAccount:output_type -> sa.Count
	114, // [114:190] is the sub-list for method output_type
	38,  // [38:114] is the sub-list for method input_type
