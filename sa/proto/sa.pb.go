...
var file_sa_proto_rawDesc = []byte{
	...
	0x65, 0x78, 0x74, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x32, 0xcd, 0x10, 0x0a, 0x18, 0x53, 0x74,
	0x6f, 0x72, 0x61, 0x67, 0x65, 0x41, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x69, 0x74, 0x79, 0x52, 0x65,
	0x61, 0x64, 0x4f, 0x6e, 0x6c, 0x79, 0x12, 0x53, 0x0a, 0x18, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x43,
	...
	0x78, 0x69, 0x73, 0x74, 0x73, 0x22, 0x00, 0x12, 0x4f, 0x0a, 0x19, 0x50, 0x72, 0x65, 0x76, 0x69,
	0x6f, 0x75, 0x73, 0x43, 0x65, 0x72, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x65, 0x45, 0x78,
	0x69, 0x73, 0x74, 0x73, 0x12, 0x24, 0x2e, 0x73, 0x61, 0x2e, 0x50, 0x72, 0x65, 0x76, 0x69, 0x6f,
	...
	0x65, 0x72, 0x69, 0x61, 0x6c, 0x22, 0x00, 0x30, 0x01, 0x32, 0xc4, 0x1a, 0x0a, 0x10, 0x53, 0x74,
	...
	0x4f, 0x0a, 0x19, 0x50, 0x72, 0x65, 0x76, 0x69, 0x6f, 0x75, 0x73, 0x43, 0x65, 0x72, 0x74, 0x69,
	0x66, 0x69, 0x63, 0x61, 0x74, 0x65, 0x45, 0x78, 0x69, 0x73, 0x74, 0x73, 0x12, 0x24, 0x2e, 0x73,
	0x61, 0x2e, 0x50, 0x72, 0x65, 0x76, 0x69, 0x6f, 0x75, 0x73, 0x43, 0x65, 0x72, 0x74, 0x69, 0x66,
	...
	0x66, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x22, 0x00, 0x12, 0x42, 0x0a, 0x12, 0x55, 0x70, 0x64,
...
var file_sa_proto_depIdxs = []int32{
	...
	36,  // 67: sa.StorageAuthorityReadOnly.GetSerialsByKey:input_type -> sa.SPKIHash
	4,   // 68: sa.StorageAuthorityReadOnly.GetValidAuthorizations2:input_type -> sa.GetValidAuthorizationsRequest
	26,  // 69: sa.StorageAuthorityReadOnly.GetValidOrderAuthorizations2:input_type -> sa.GetValidOrderAuthorizationsRequest
	6,   // 70: sa.StorageAuthorityReadOnly.IncidentsForSerial:input_type -> sa.Serial
	36,  // 71: sa.StorageAuthorityReadOnly.KeyBlocked:input_type -> sa.SPKIHash
	18,  // 72: sa.StorageAuthorityReadOnly.PreviousCertificateExists:input_type -> sa.PreviousCertificateExistsRequest
	6,   // 73: sa.StorageAuthorityReadOnly.ReplacementOrderExists:input_type -> sa.Serial
	39,  // 74: sa.StorageAuthorityReadOnly.SerialsForIncident:input_type -> sa.SerialsForIncidentRequest
	11,  // 75: sa.StorageAuthority.CountCertificatesByNames:input_type -> sa.CountCertificatesByNamesRequest
	16,  // 76: sa.StorageAuthority.CountFQDNSets:input_type -> sa.CountFQDNSetsRequest
	14,  // 77: sa.StorageAuthority.CountInvalidAuthorizations2:input_type -> sa.CountInvalidAuthorizationsRequest
	15,  // 78: sa.StorageAuthority.CountOrders:input_type -> sa.CountOrdersRequest
	0,   // 79: sa.StorageAuthority.CountPendingAuthorizations2:input_type -> sa.RegistrationID
	13,  // 80: sa.StorageAuthority.CountRegistrationsByIP:input_type -> sa.CountRegistrationsByIPRequest
	13,  // 81: sa.StorageAuthority.CountRegistrationsByIPRange:input_type -> sa.CountRegistrationsByIPRequest
	17,  // 82: sa.StorageAuthority.FQDNSetExists:input_type -> sa.FQDNSetExistsRequest
	16,  // 83: sa.StorageAuthority.FQDNSetTimestampsForWindow:input_type -> sa.CountFQDNSetsRequest
	32,  // 84: sa.StorageAuthority.GetAuthorization2:input_type -> sa.AuthorizationID2
	29,  // 85: sa.StorageAuthority.GetAuthorizations2:input_type -> sa.GetAuthorizationsRequest
	6,   // 86: sa.StorageAuthority.GetCertificate:input_type -> sa.Serial
	6,   // 87: sa.StorageAuthority.GetLintPrecertificate:input_type -> sa.Serial
	6,   // 88: sa.StorageAuthority.GetCertificateStatus:input_type -> sa.Serial
	54,  // 89: sa.StorageAuthority.GetMaxExpiration:input_type -> google.protobuf.Empty
	22,  // 90: sa.StorageAuthority.GetOrder:input_type -> sa.OrderRequest
	27,  // 91: sa.StorageAuthority.GetOrderForNames:input_type -> sa.GetOrderForNamesRequest
	3,   // 92: sa.StorageAuthority.GetPendingAuthorization2:input_type -> sa.GetPendingAuthorizationRequest
	...
	6,   // 95: sa.StorageAuthority.GetRevocationStatus:input_type -> sa.Serial
	41,  // 96: sa.StorageAuthority.GetRevokedCerts:input_type -> sa.GetRevokedCertsRequest
	6,   // 97: sa.StorageAuthority.GetSerialMetadata:input_type -> sa.Serial
	0,   // 98: sa.StorageAuthority.GetSerialsByAccount:input_type -> sa.RegistrationID
	36,  // 99: sa.StorageAuthority.GetSerialsByKey:input_type -> sa.SPKIHash
	4,   // 100: sa.StorageAuthority.GetValidAuthorizations2:input_type -> sa.GetValidAuthorizationsRequest
	26,  // 101: sa.StorageAuthority.GetValidOrderAuthorizations2:input_type -> sa.GetValidOrderAuthorizationsRequest
	6,   // 102: sa.StorageAuthority.IncidentsForSerial:input_type -> sa.Serial
	36,  // 103: sa.StorageAuthority.KeyBlocked:input_type -> sa.SPKIHash
	18,  // 104: sa.StorageAuthority.PreviousCertificateExists:input_type -> sa.PreviousCertificateExistsRequest
	6,   // 105: sa.StorageAuthority.ReplacementOrderExists:input_type -> sa.Serial
	39,  // 106: sa.StorageAuthority.SerialsForIncident:input_type -> sa.SerialsForIncidentRequest
	35,  // 107: sa.StorageAuthority.AddBlockedKey:input_type -> sa.AddBlockedKeyRequest
	21,  // 108: sa.StorageAuthority.AddCertificate:input_type -> sa.AddCertificateRequest
	21,  // 109: sa.StorageAuthority.AddPrecertificate:input_type -> sa.AddCertificateRequest
	6,   // 110: sa.StorageAuthority.SetCertificateStatusReady:input_type -> sa.Serial
	20,  // 111: sa.StorageAuthority.AddSerial:input_type -> sa.AddSerialRequest
	32,  // 112: sa.StorageAuthority.DeactivateAuthorization2:input_type -> sa.AuthorizationID2
	0,   // 113: sa.StorageAuthority.DeactivateRegistration:input_type -> sa.RegistrationID
	34,  // 114: sa.StorageAuthority.FinalizeAuthorization2:input_type -> sa.FinalizeAuthorizationRequest
	28,  // 115: sa.StorageAuthority.FinalizeOrder:input_type -> sa.FinalizeOrderRequest
	24,  // 116: sa.StorageAuthority.NewOrderAndAuthzs:input_type -> sa.NewOrderAndAuthzsRequest
	55,  // 117: sa.StorageAuthority.NewRegistration:input_type -> core.Registration
	33,  // 118: sa.StorageAuthority.RevokeCertificate:input_type -> sa.RevokeCertificateRequest
	25,  // 119: sa.StorageAuthority.SetOrderError:input_type -> sa.SetOrderErrorRequest
	22,  // 120: sa.StorageAuthority.SetOrderProcessing:input_type -> sa.OrderRequest
	55,  // 121: sa.StorageAuthority.UpdateRegistration:input_type -> core.Registration
	33,  // 122: sa.StorageAuthority.UpdateRevokedCertificate:input_type -> sa.RevokeCertificateRequest
	43,  // 123: sa.StorageAuthority.LeaseCRLShard:input_type -> sa.LeaseCRLShardRequest
	45,  // 124: sa.StorageAuthority.UpdateCRLShard:input_type -> sa.UpdateCRLShardRequest
	12,  // 125: sa.StorageAuthorityReadOnly.CountCertificatesByNames:output_type -> sa.CountByNames
	9,   // 126: sa.StorageAuthorityReadOnly.CountFQDNSets:output_type -> sa.Count
	9,   // 127: sa.StorageAuthorityReadOnly.CountInvalidAuthorizations2:output_type -> sa.Count
	9,   // 128: sa.StorageAuthorityReadOnly.CountOrders:output_type -> sa.Count
	9,   // 129: sa.StorageAuthorityReadOnly.CountPendingAuthorizations2:output_type -> sa.Count
	9,   // 130: sa.StorageAuthorityReadOnly.CountRegistrationsByIP:output_type -> sa.Count
	9,   // 131: sa.StorageAuthorityReadOnly.CountRegistrationsByIPRange:output_type -> sa.Count
	19,  // 132: sa.StorageAuthorityReadOnly.FQDNSetExists:output_type -> sa.Exists
	10,  // 133: sa.StorageAuthorityReadOnly.FQDNSetTimestampsForWindow:output_type -> sa.Timestamps
	51,  // 134: sa.StorageAuthorityReadOnly.GetAuthorization2:output_type -> core.Authorization
	30,  // 135: sa.StorageAuthorityReadOnly.GetAuthorizations2:output_type -> sa.Authorizations
	56,  // 136: sa.StorageAuthorityReadOnly.GetCertificate:output_type -> core.Certificate
	56,  // 137: sa.StorageAuthorityReadOnly.GetLintPrecertificate:output_type -> core.Certificate
	57,  // 138: sa.StorageAuthorityReadOnly.GetCertificateStatus:output_type -> core.CertificateStatus
	49,  // 139: sa.StorageAuthorityReadOnly.GetMaxExpiration:output_type -> google.protobuf.Timestamp
	58,  // 140: sa.StorageAuthorityReadOnly.GetOrder:output_type -> core.Order
	58,  // 141: sa.StorageAuthorityReadOnly.GetOrderForNames:output_type -> core.Order
	51,  // 142: sa.StorageAuthorityReadOnly.GetPendingAuthorization2:output_type -> core.Authorization
	55,  // 143: sa.StorageAuthorityReadOnly.GetRegistration:output_type -> core.Registration
	55,  // 144: sa.StorageAuthorityReadOnly.GetRegistrationByKey:output_type -> core.Registration
	42,  // 145: sa.StorageAuthorityReadOnly.GetRevocationStatus:output_type -> sa.RevocationStatus
	59,  // 146: sa.StorageAuthorityReadOnly.GetRevokedCerts:output_type -> core.CRLEntry
	7,   // 147: sa.StorageAuthorityReadOnly.GetSerialMetadata:output_type -> sa.SerialMetadata
	6,   // 148: sa.StorageAuthorityReadOnly.GetSerialsByAccount:output_type -> sa.Serial
	6,   // 149: sa.StorageAuthorityReadOnly.GetSerialsByKey:output_type -> sa.Serial
	30,  // 150: sa.StorageAuthorityReadOnly.GetValidAuthorizations2:output_type -> sa.Authorizations
	30,  // 151: sa.StorageAuthorityReadOnly.GetValidOrderAuthorizations2:output_type -> sa.Authorizations
	38,  // 152: sa.StorageAuthorityReadOnly.IncidentsForSerial:output_type -> sa.Incidents
	19,  // 153: sa.StorageAuthorityReadOnly.KeyBlocked:output_type -> sa.Exists
	19,  // 154: sa.StorageAuthorityReadOnly.PreviousCertificateExists:output_type -> sa.Exists
	19,  // 155: sa.StorageAuthorityReadOnly.ReplacementOrderExists:output_type -> sa.Exists
	40,  // 156: sa.StorageAuthorityReadOnly.SerialsForIncident:output_type -> sa.IncidentSerial
	12,  // 157: sa.StorageAuthority.CountCertificatesByNames:output_type -> sa.CountByNames
	9,   // 158: sa.StorageAuthority.CountFQDNSets:output_type -> sa.Count
	9,   // 159: sa.StorageAuthority.CountInvalidAuthorizations2:output_type -> sa.Count
	9,   // 160: sa.StorageAuthority.CountOrders:output_type -> sa.Count
	9,   // 161: sa.StorageAuthority.CountPendingAuthorizations2:output_type -> sa.Count
	9,   // 162: sa.StorageAuthority.CountRegistrationsByIP:output_type -> sa.Count
	9,   // 163: sa.StorageAuthority.CountRegistrationsByIPRange:output_type -> sa.Count
	19,  // 164: sa.StorageAuthority.FQDNSetExists:output_type -> sa.Exists
	10,  // 165: sa.StorageAuthority.FQDNSetTimestampsForWindow:output_type -> sa.Timestamps
	51,  // 166: sa.StorageAuthority.GetAuthorization2:output_type -> core.Authorization
	30,  // 167: sa.StorageAuthority.GetAuthorizations2:output_type -> sa.Authorizations
	56,  // 168: sa.StorageAuthority.GetCertificate:output_type -> core.Certificate
	56,  // 169: sa.StorageAuthority.GetLintPrecertificate:output_type -> core.Certificate
	57,  // 170: sa.StorageAuthority.GetCertificateStatus:output_type -> core.CertificateStatus
	49,  // 171: sa.StorageAuthority.GetMaxExpiration:output_type -> google.protobuf.Timestamp
	58,  // 172: sa.StorageAuthority.GetOrder:output_type -> core.Order
	58,  // 173: sa.StorageAuthority.GetOrderForNames:output_type -> core.Order
	51,  // 174: sa.StorageAuthority.GetPendingAuthorization2:output_type -> core.Authorization
	55,  // 175: sa.StorageAuthority.GetRegistration:output_type -> core.Registration
	55,  // 176: sa.StorageAuthority.GetRegistrationByKey:output_type -> core.Registration
	42,  // 177: sa.StorageAuthority.GetRevocationStatus:output_type -> sa.RevocationStatus
	59,  // 178: sa.StorageAuthority.GetRevokedCerts:output_type -> core.CRLEntry
	7,   // 179: sa.StorageAuthority.GetSerialMetadata:output_type -> sa.SerialMetadata
	6,   // 180: sa.StorageAuthority.GetSerialsByAccount:output_type -> sa.Serial
	6,   // 181: sa.StorageAuthority.GetSerialsByKey:output_type -> sa.Serial
	30,  // 182: sa.StorageAuthority.GetValidAuthorizations2:output_type -> sa.Authorizations
	30,  // 183: sa.StorageAuthority.GetValidOrderAuthorizations2:output_type -> sa.Authorizations
	38,  // 184: sa.StorageAuthority.IncidentsForSerial:output_type -> sa.Incidents
	19,  // 185: sa.StorageAuthority.KeyBlocked:output_type -> sa.Exists
	19,  // 186: sa.StorageAuthority.PreviousCertificateExists:output_type -> sa.Exists
	19,  // 187: sa.StorageAuthority.ReplacementOrderExists:output_type -> sa.Exists
	40,  // 188: sa.StorageAuthority.SerialsForIncident:output_type -> sa.IncidentSerial
	54,  // 189: sa.StorageAuthority.AddBlockedKey:output_type -> google.protobuf.Empty
	54,  // 190: sa.StorageAuthority.AddCertificate:output_type -> google.protobuf.Empty
	54,  // 191: sa.StorageAuthority.AddPrecertificate:output_type -> google.protobuf.Empty
	54,  // 192: sa.StorageAuthority.SetCertificateStatusReady:output_type -> google.protobuf.Empty
	54,  // 193: sa.StorageAuthority.AddSerial:output_type -> google.protobuf.Empty
	54,  // 194: sa.StorageAuthority.DeactivateAuthorization2:output_type -> google.protobuf.Empty
	54,  // 195: sa.StorageAuthority.DeactivateRegistration:output_type -> google.protobuf.Empty
	54,  // 196: sa.StorageAuthority.FinalizeAuthorization2:output_type -> google.protobuf.Empty
	54,  // 197: sa.StorageAuthority.FinalizeOrder:output_type -> google.protobuf.Empty
	58,  // 198: sa.StorageAuthority.NewOrderAndAuthzs:output_type -> core.Order
	55,  // 199: sa.StorageAuthority.NewRegistration:output_type -> core.Registration
	54,  // 200: sa.StorageAuthority.RevokeCertificate:output_type -> google.protobuf.Empty
	54,  // 201: sa.StorageAuthority.SetOrderError:output_type -> google.protobuf.Empty
	54,  // 202: sa.StorageAuthority.SetOrderProcessing:output_type -> google.protobuf.Empty
	54,  // 203: sa.StorageAuthority.UpdateRegistration:output_type -> google.protobuf.Empty
	54,  // 204: sa.StorageAuthority.UpdateRevokedCertificate:output_type -> google.protobuf.Empty
	44,  // 205: sa.StorageAuthority.LeaseCRLShard:output_type -> sa.LeaseCRLShardResponse
	54,  // 206: sa.StorageAuthority.UpdateCRLShard:output_type -> google.protobuf.Empty
	125, // [125:207] is the sub-list for method output_type
	43,  // [43:125] is the sub-list for method input_type
