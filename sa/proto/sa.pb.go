...
var file_sa_proto_rawDesc = []byte{
	...
	0x61, 0x6d, 0x65, 0x73, 0x22, 0x7f, 0x0a, 0x0c, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x42, 0x79, 0x4e,
	0x61, 0x6d, 0x65, 0x73, 0x12, 0x34, 0x0a, 0x06, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x73, 0x18, 0x01,
	0x20, 0x03, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x73, 0x61, 0x2e, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x42,
	0x79, 0x4e, 0x61, 0x6d, 0x65, 0x73, 0x2e, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x73, 0x45, 0x6e, 0x74,
	...
	0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x50, 0x0a, 0x1d, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x52, 0x65,
	...
	0x28, 0x0c, 0x52, 0x02, 0x69, 0x70, 0x12, 0x1f, 0x0a, 0x05, 0x72, 0x61, 0x6e, 0x67, 0x65, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x09, 0x2e, 0x73, 0x61, 0x2e, 0x52, 0x61, 0x6e, 0x67, 0x65,
	0x52, 0x05, 0x72, 0x61, 0x6e, 0x67, 0x65, 0x22, 0x88, 0x01, 0x0a, 0x21, 0x43, 0x6f, 0x75, 0x6e,
	...
	0x69, 0x6f, 0x6e, 0x49, 0x44, 0x12, 0x1a, 0x0a, 0x08, 0x68, 0x6f, 0x73, 0x74, 0x6e, 0x61, 0x6d,
	...
	0x09, 0x52, 0x06, 0x64, 0x69, 0x67, 0x65, 0x73, 0x74, 0x22, 0x1e, 0x0a, 0x0c, 0x4f, 0x72, 0x64,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x52, 0x05, 0x61, 0x75, 0x74, 0x68, 0x7a, 0x22, 0x4c, 0x0a, 0x1f, 0x41,
	0x64, 0x64, 0x50, 0x65, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x41, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x69,
	0x7a, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x29,
	0x0a, 0x05, 0x61, 0x75, 0x74, 0x68, 0x7a, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x13, 0x2e,
	...
	0x02, 0x69, 0x64, 0x22, 0x25, 0x0a, 0x11, 0x41, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x69, 0x7a, 0x61,
	0x74, 0x69, 0x6f, 0x6e, 0x32, 0x49, 0x44, 0x73, 0x12, 0x10, 0x0a, 0x03, 0x69, 0x64, 0x73, 0x18,
	0x01, 0x20, 0x03, 0x28, 0x03, 0x52, 0x03, 0x69, 0x64, 0x73, 0x22, 0x96, 0x01, 0x0a, 0x18, 0x52,
	...
	0x48, 0x61, 0x73, 0x68, 0x32, 0x96, 0x15, 0x0a, 0x10, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65,
...
var file_sa_proto_depIdxs = []int32{
	...
	34, // 49: sa.StorageAuthority.UpdateRevokedCertificate:input_type -> sa.RevokeCertificateRequest
	30, // 50: sa.StorageAuthority.NewAuthorizations2:input_type -> sa.AddPendingAuthorizationsRequest
	35, // 51: sa.StorageAuthority.FinalizeAuthorization2:input_type -> sa.FinalizeAuthorizationRequest
	32, // 52: sa.StorageAuthority.DeactivateAuthorization2:input_type -> sa.AuthorizationID2
	36, // 53: sa.StorageAuthority.AddBlockedKey:input_type -> sa.AddBlockedKeyRequest
	44, // 54: sa.StorageAuthority.GetRegistration:output_type -> core.Registration
	44, // 55: sa.StorageAuthority.GetRegistrationByKey:output_type -> core.Registration
	45, // 56: sa.StorageAuthority.GetCertificate:output_type -> core.Certificate
	45, // 57: sa.StorageAuthority.GetPrecertificate:output_type -> core.Certificate
	46, // 58: sa.StorageAuthority.GetCertificateStatus:output_type -> core.CertificateStatus
	10, // 59: sa.StorageAuthority.CountCertificatesByNames:output_type -> sa.CountByNames
	8,  // 60: sa.StorageAuthority.CountRegistrationsByIP:output_type -> sa.Count
	8,  // 61: sa.StorageAuthority.CountRegistrationsByIPRange:output_type -> sa.Count
	8,  // 62: sa.StorageAuthority.CountOrders:output_type -> sa.Count
	8,  // 63: sa.StorageAuthority.CountFQDNSets:output_type -> sa.Count
	17, // 64: sa.StorageAuthority.FQDNSetExists:output_type -> sa.Exists
	17, // 65: sa.StorageAuthority.PreviousCertificateExists:output_type -> sa.Exists
	41, // 66: sa.StorageAuthority.GetAuthorization2:output_type -> core.Authorization
	29, // 67: sa.StorageAuthority.GetAuthorizations2:output_type -> sa.Authorizations
	41, // 68: sa.StorageAuthority.GetPendingAuthorization2:output_type -> core.Authorization
	8,  // 69: sa.StorageAuthority.CountPendingAuthorizations2:output_type -> sa.Count
	29, // 70: sa.StorageAuthority.GetValidOrderAuthorizations2:output_type -> sa.Authorizations
	8,  // 71: sa.StorageAuthority.CountInvalidAuthorizations2:output_type -> sa.Count
	29, // 72: sa.StorageAuthority.GetValidAuthorizations2:output_type -> sa.Authorizations
	17, // 73: sa.StorageAuthority.KeyBlocked:output_type -> sa.Exists
	44, // 74: sa.StorageAuthority.NewRegistration:output_type -> core.Registration
	47, // 75: sa.StorageAuthority.UpdateRegistration:output_type -> google.protobuf.Empty
	20, // 76: sa.StorageAuthority.AddCertificate:output_type -> sa.AddCertificateResponse
	47, // 77: sa.StorageAuthority.AddPrecertificate:output_type -> google.protobuf.Empty
	47, // 78: sa.StorageAuthority.AddSerial:output_type -> google.protobuf.Empty
	47, // 79: sa.StorageAuthority.DeactivateRegistration:output_type -> google.protobuf.Empty
	48, // 80: sa.StorageAuthority.NewOrder:output_type -> core.Order
	48, // 81: sa.StorageAuthority.NewOrderAndAuthzs:output_type -> core.Order
	47, // 82: sa.StorageAuthority.SetOrderProcessing:output_type -> google.protobuf.Empty
	47, // 83: sa.StorageAuthority.SetOrderError:output_type -> google.protobuf.Empty
	47, // 84: sa.StorageAuthority.FinalizeOrder:output_type -> google.protobuf.Empty
	48, // 85: sa.StorageAuthority.GetOrder:output_type -> core.Order
	48, // 86: sa.StorageAuthority.GetOrderForNames:output_type -> core.Order
	47, // 87: sa.StorageAuthority.RevokeCertificate:output_type -> google.protobuf.Empty
	47, // 88: sa.StorageAuthority.UpdateRevokedCertificate:output_type -> google.protobuf.Empty
	33, // 89: sa.StorageAuthority.NewAuthorizations2:output_type -> sa.Authorization2IDs
	47, // 90: sa.StorageAuthority.FinalizeAuthorization2:output_type -> google.protobuf.Empty
	47, // 91: sa.StorageAuthority.DeactivateAuthorization2:output_type -> google.protobuf.Empty
	47, // 92: sa.StorageAuthority.AddBlockedKey:output_type -> google.protobuf.Empty
