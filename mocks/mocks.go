...
func (sa *StorageAuthority) GetValidOrderAuthorizations(_ context.Context, req *sapb.GetValidOrderAuthorizationsRequest) (map[string]*core.Authorization, error) {
	return nil, nil
}
