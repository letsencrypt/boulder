...
Current draft: [`draft-ietf-acme-acme-06`](https://tools.ietf.org/html/draft-ietf-acme-acme-06).

## [Section 6](https://tools.ietf.org/html/draft-ietf-acme-acme-06#section-6)
...
## [Section 6.2](https://tools.ietf.org/html/draft-ietf-acme-acme-06#section-6.2)

Boulder enforces the presence of the `jwk` field in JWS objects, and does not support the `kid` field.

## [Section 6.3.1](https://tools.ietf.org/html/draft-ietf-acme-acme-06#section-6.3.1)
...
## [Section 6.5](https://tools.ietf.org/html/draft-ietf-acme-acme-06#section-6.5)
...
## [Section 6.6](https://tools.ietf.org/html/draft-ietf-acme-acme-06#section-6.6)
...
## [Section 7.1](https://tools.ietf.org/html/draft-ietf-acme-acme-06#section-7.1)
...
## [Section 7.1.1](https://tools.ietf.org/html/draft-ietf-acme-acme-06#section-7.1.1)

Boulder does not implement the `meta` field returned by the `directory` endpoint.

## [Section 7.1.2](https://tools.ietf.org/html/draft-ietf-acme-acme-06#section-7.1.2)
...
## [Section 7.1.3](https://tools.ietf.org/html/draft-ietf-acme-acme-06#section-7.1.3)
...
## [Section 7.1.4](https://tools.ietf.org/html/draft-ietf-acme-acme-06#section-7.1.4)

Boulder does not implement the `scope` field in authorization objects.

## [Section 7.2](https://tools.ietf.org/html/draft-ietf-acme-acme-06#section-7.2)
...
## [Section 7.3](https://tools.ietf.org/html/draft-ietf-acme-acme-06#section-7.3)
...
## [Section 7.3.3](https://tools.ietf.org/html/draft-ietf-acme-acme-06#section-7.3.3)
...
## [Section 7.4](https://tools.ietf.org/html/draft-ietf-acme-acme-06#section-7.4)
...
## [Section 7.4.2](https://tools.ietf.org/html/draft-ietf-acme-acme-06#section-7.4.2)
...
## [Section 7.5](https://tools.ietf.org/html/draft-ietf-acme-acme-06#section-7.5)

Boulder returns an `uri` instead of an `url` field in challenge objects.

Boulder uses an HTTP status code 202 (Accepted) response for correct challenge responses instead of 200 (OK) as defined in [Section 7.1](https://tools.ietf.org/html/draft-ietf-acme-acme-06#section-7.1).

## [Section 8.3](https://tools.ietf.org/html/draft-ietf-acme-acme-06#section-8.3)
...
## [Section 8.5](https://tools.ietf.org/html/draft-ietf-acme-acme-06#section-8.5)

Boulder does not implement the `oob-01` validation method.

## [Section 9.5](https://tools.ietf.org/html/draft-ietf-acme-acme-06#section-9.6)
