...
func NewClient(baseURL, token, tokenEmail string, nameToFieldID map[string]int64) (*Client, error) {
...
// CreateTicket uses the provided Ticket to create a new Zendesk ticket. It
// returns the ID of the created ticket or an error if the request fails.
